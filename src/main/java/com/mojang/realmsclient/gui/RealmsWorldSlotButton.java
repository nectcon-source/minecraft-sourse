...
public class RealmsWorldSlotButton extends Button implements TickableWidget {
   ...
   public void tick() {
      ...
      if (var1 != null) {
         ...
         boolean var8;
         if (var9) {
            var2 = var1.worldType == WorldType.MINIGAME;
            var3 = "Minigame";
            var5 = (long)var1.minigameId;
            var7 = var1.minigameImage;
            var8 = var1.minigameId == -1;
         } else {
            var2 = var1.activeSlot == this.slotIndex && var1.worldType != WorldType.MINIGAME;
         ...
         Pair<Component, Component> var11 = this.getTooltipAndNarration(var1, var3, var8, var9, var10);
   ...
   private static Action getAction(RealmsServer var0, boolean var1, boolean var2) {
      if (var1) {
         if (!var0.expired && var0.state != com.mojang.realmsclient.dto.RealmsServer.State.UNINITIALIZED) {
   ...
   private Pair<Component, Component> getTooltipAndNarration(RealmsServer var1, String var2, boolean var3, boolean var4, Action var5) {
      if (var5 == RealmsWorldSlotButton.Action.NOTHING) {
         return Pair.of(null, new TextComponent(var2));
      } else {
         Component var6;
         if (var4) {
            if (var3) {
         ...
         Component var8 = var7.copy().append(var6);
