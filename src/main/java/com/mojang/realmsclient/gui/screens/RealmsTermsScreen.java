...
public class RealmsTermsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.width / 4, row(12), var1, 20, new TranslatableComponent("mco.terms.buttons.agree"), (var1x) -> this.agreedToTos()));
      this.addButton(new Button(this.width / 2 + 4, row(12), var1, 20, new TranslatableComponent("mco.terms.buttons.disagree"), (var1x) -> this.minecraft.setScreen(this.lastScreen)));
   }
