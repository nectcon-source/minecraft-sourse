...
public class RealmsSelectFileToUploadScreen extends RealmsScreen {
   ...
   private void loadLevelList() throws Exception {
      this.levelList = this.minecraft.getLevelSource().getLevelList().stream().sorted((var0, var1) -> {
      ...
      for(LevelSummary var2 : this.levelList) {
   ...
   public void init() {
      ...
      try {
         ...
         LOGGER.error("Couldn't load level list", var1_1);
         this.minecraft.setScreen(new RealmsGenericErrorScreen(new TextComponent("Unable to load worlds"), Component.nullToEmpty(var1_1.getMessage()), this.lastScreen));
         return;
      }

      this.addWidget(this.worldSelectionList);
      this.uploadButton = (Button)this.addButton(new Button(this.width / 2 - 154, this.height - 32, 153, 20, new TranslatableComponent("mco.upload.button.name"), (var1) -> this.upload()));
      this.uploadButton.active = this.selectedWorld >= 0 && this.selectedWorld < this.levelList.size();
      this.addButton(new Button(this.width / 2 + 6, this.height - 32, 153, 20, CommonComponents.GUI_BACK, (var1) -> this.minecraft.setScreen(this.lastScreen)));
   ...
   class WorldSelectionList extends RealmsObjectSelectionList<Entry> {
      ...
      public void selectItem(int var1) {
         ...
         if (var1 != -1) {
            ...
            String var3 = I18n.get("narrator.select.list.position", new Object[]{var1 + 1, RealmsSelectFileToUploadScreen.this.levelList.size()});
            ...
            NarrationHelper.now(I18n.get("narrator.select", new Object[]{var4}));
         }
   ...
   class Entry extends ObjectSelectionList.Entry<Entry> {
      ...
      public Entry(LevelSummary var2) {
         ...
         if (var2.isRequiresConversion()) {
            ...
            if (var2.hasCheats()) {
               var3 = var3.copy().append(", ").append(RealmsSelectFileToUploadScreen.CHEATS_TEXT);
            }
