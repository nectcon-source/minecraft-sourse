...
public class RealmsConfigureWorldScreen extends RealmsScreenWithCallback {
   ...
   public void init() {
      ...
      this.switchMinigameButton = this.addButton(
         new Button(this.leftButton(0), row(13) - 5, 100, 20, new TranslatableComponent("mco.configure.world.buttons.switchminigame"), var1x -> {
      ...
      this.addButton(new Button(this.rightX - 80 + 8, row(13) - 5, 70, 20, CommonComponents.GUI_BACK, var1x -> this.backButtonClicked()));
   ...
   private void addSlotButton(int var1) {
      ...
      int var3x = row(5) + 5;
      RealmsWorldSlotButton var4xx = new RealmsWorldSlotButton(var2, var3x, 80, 80, () -> this.serverData, var1x -> this.toolTip = var1x, var1, var2x -> {
   ...
   public void render(PoseStack var1, int var2, int var3, float var4)  {
      ...
      if (this.serverData == null) {
         ...
         int var8 = this.font.width(WORLD_TITLE);
         ...
         if (this.isMinigame()) {
            this.font.draw(var1, MINIGAME_PREFIX.copy().append(this.serverData.getMinigameName()), (float)(this.leftX + 80 + 20 + 10), (float)row(13), 16777215);
         }
   ...
   private void fetchServerData(long var1) {
      (new Thread(() -> {
         ...
         } catch (RealmsServiceException var4_1) {
            LOGGER.error("Couldn't get own world");
            this.minecraft.execute(() -> this.minecraft.setScreen(new RealmsGenericErrorScreen(Component.nullToEmpty(var4_1.getMessage()), this.lastScreen)));
         }
   ...
   private void switchToMinigame() {
      ...
      var1.setWarning(new Component[]{new TranslatableComponent("mco.minigame.world.info.line1"), new TranslatableComponent("mco.minigame.world.info.line2")});
      this.minecraft.setScreen(var1);
   }

   private void switchToFullSlot(int var1, RealmsServer var2) {
      Component var3 = new TranslatableComponent("mco.configure.world.slot.switch.question.line1");
      Component var4x = new TranslatableComponent("mco.configure.world.slot.switch.question.line2");
      this.minecraft
         .setScreen(
            new RealmsLongConfirmationScreen(
               var3x -> {
                  if (var3x) {
                     this.minecraft
                        .setScreen(
                           new RealmsLongRunningMcoTaskScreen(this.lastScreen, new SwitchSlotTask(var2.id, var1, () -> this.minecraft.setScreen(this.getNewScreen())))
                        );
                  } else {
   ...
   private void switchToEmptySlot(int var1, RealmsServer var2) {
      Component var3 = new TranslatableComponent("mco.configure.world.slot.switch.question.line1");
      Component var4 = new TranslatableComponent("mco.configure.world.slot.switch.question.line2");
      this.minecraft.setScreen(new RealmsLongConfirmationScreen((var3x) -> {
         if (var3x) {
            RealmsResetWorldScreen var4x = new RealmsResetWorldScreen(this, var2, new TranslatableComponent("mco.configure.world.switch.slot"), new TranslatableComponent("mco.configure.world.switch.slot.subtitle"), 10526880, CommonComponents.GUI_CANCEL, () -> this.minecraft.setScreen(this.getNewScreen()), () -> this.minecraft.setScreen(this.getNewScreen()));
            var4x.setSlot(var1);
            var4x.setResetTitle(new TranslatableComponent("mco.create.world.reset.title"));
   ...
   public void saveSlotSettings(RealmsWorldOptions var1) {
      ...
      try {
         ...
         this.minecraft.setScreen(new RealmsGenericErrorScreen(var4_1, this));
         return;
      }
   ...
   public void saveSettings(String var1, String var2) {
      ...
      } catch (RealmsServiceException var5_1) {
         LOGGER.error("Couldn't save settings");
         this.minecraft.setScreen(new RealmsGenericErrorScreen(var5_1, this));
         return;
      }
