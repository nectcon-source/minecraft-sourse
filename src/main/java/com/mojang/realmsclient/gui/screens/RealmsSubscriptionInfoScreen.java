...
public class RealmsSubscriptionInfoScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      NarrationHelper.now(new String[]{SUBSCRIPTION_TITLE.getString(), SUBSCRIPTION_START_LABEL.getString(), this.startDate, TIME_LEFT_LABEL.getString(), this.daysLeft.getString()});
      ...
      this.addButton(new Button(this.width / 2 - 100, row(12), 200, 20, CommonComponents.GUI_BACK, (var1) -> this.minecraft.setScreen(this.lastScreen)));
      if (this.serverData.expired) {
         this.addButton(new Button(this.width / 2 - 100, row(10), 200, 20, new TranslatableComponent("mco.configure.world.delete.button"), (var1) -> {
            Component var2 = new TranslatableComponent("mco.configure.world.delete.question.line1");
            Component var3 = new TranslatableComponent("mco.configure.world.delete.question.line2");
            this.minecraft.setScreen(new RealmsLongConfirmationScreen(this::deleteRealm, Type.Warning, var2, var3, true));
         }));
      }
         ...
         (new Thread("Realms-delete-realm") {
            public void run() {
               try {
                  ...
                  RealmsSubscriptionInfoScreen.LOGGER.error(var1_1);
               }
   ...
   private void getSubscription(long var1) {
      ...
      try {
         ...
         this.minecraft.setScreen(new RealmsGenericErrorScreen(var4_1, this.lastScreen));
      }

   }

   private static String localPresentation(long var0) {
      Calendar var2 = new GregorianCalendar(TimeZone.getDefault());
