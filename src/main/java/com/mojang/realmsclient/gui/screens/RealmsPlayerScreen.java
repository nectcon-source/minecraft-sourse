...
public class RealmsPlayerScreen extends RealmsScreen {
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      var7.vertex((double)0.0F, (double)this.height, (double)0.0F).uv(0.0F, (float)(this.height - var5) / 32.0F + 0.0F).color(64, 64, 64, 255).endVertex();
      var7.vertex((double)this.width, (double)this.height, (double)0.0F).uv((float)this.width / 32.0F, (float)(this.height - var5) / 32.0F + 0.0F).color(64, 64, 64, 255).endVertex();
      var7.vertex((double)this.width, (double)var5, (double)0.0F).uv((float)this.width / 32.0F, 0.0F).color(64, 64, 64, 255).endVertex();
      var7.vertex((double)0.0F, (double)var5, (double)0.0F).uv(0.0F, 0.0F).color(64, 64, 64, 255).endVertex();
      var6.end();
      this.titleLabel.render(this, var1);
      if (this.serverData != null && this.serverData.players != null) {
         this.font.draw(var1, (new TextComponent("")).append(INVITED_LABEL).append(" (").append(Integer.toString(this.serverData.players.size())).append(")"), (float)this.column1X, (float)row(0), 10526880);
      } else {
   ...
   class InvitedObjectSelectionList extends RealmsObjectSelectionList<RealmsPlayerScreen.Entry> {
      ...
      public void selectItem(int var1) {
         ...
         if (var1 != -1) {
            NarrationHelper.now(I18n.get("narrator.select", RealmsPlayerScreen.this.serverData.players.get(var1).getName()));
         }
