...
public class RealmsDownloadLatestWorldScreen extends RealmsScreen {
   ...
   private void checkDownloadSize() {
      if (!this.finished) {
         if (!this.checked && this.getContentLength(this.worldDownload.downloadLink) >= 5368709120L) {
            Component var1 = new TranslatableComponent("mco.download.confirmation.line1", new Object[]{Unit.humanReadable(5368709120L)});
            Component var2 = new TranslatableComponent("mco.download.confirmation.line2");
            this.minecraft.setScreen(new RealmsLongConfirmationScreen((var1x) -> {
               this.checked = true;
               this.minecraft.setScreen(this);
               this.downloadSave();
            }, Type.Warning, var1, var2, false));
         } else {
            this.downloadSave();
         }
   ...
   private void drawProgressBar(PoseStack var1) {
      double var2 = Math.min((double)this.downloadStatus.bytesWritten / (double)this.downloadStatus.totalBytes, (double)1.0F);
      ...
      double var8 = (double)0.5F;
      var5.vertex(var6 - (double)0.5F, (double)95.5F, (double)0.0F).color(217, 210, 210, 255).endVertex();
      var5.vertex(var6 + (double)200.0F * var2 + (double)0.5F, (double)95.5F, (double)0.0F).color(217, 210, 210, 255).endVertex();
      var5.vertex(var6 + (double)200.0F * var2 + (double)0.5F, (double)79.5F, (double)0.0F).color(217, 210, 210, 255).endVertex();
      var5.vertex(var6 - (double)0.5F, (double)79.5F, (double)0.0F).color(217, 210, 210, 255).endVertex();
      var5.vertex(var6, (double)95.0F, (double)0.0F).color(128, 128, 128, 255).endVertex();
      var5.vertex(var6 + (double)200.0F * var2, (double)95.0F, (double)0.0F).color(128, 128, 128, 255).endVertex();
      var5.vertex(var6 + (double)200.0F * var2, (double)80.0F, (double)0.0F).color(128, 128, 128, 255).endVertex();
      var5.vertex(var6, (double)80.0F, (double)0.0F).color(128, 128, 128, 255).endVertex();
      var4.end();
