...
public class RealmsConfirmScreen extends RealmsScreen {
   ...
   public void init() {
      this.addButton(new Button(this.width / 2 - 105, row(9), 100, 20, CommonComponents.GUI_YES, (var1) -> this.callback.accept(true)));
      this.addButton(new Button(this.width / 2 + 5, row(9), 100, 20, CommonComponents.GUI_NO, (var1) -> this.callback.accept(false)));
   }
