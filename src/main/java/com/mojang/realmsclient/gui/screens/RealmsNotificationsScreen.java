...
public class RealmsNotificationsScreen extends RealmsScreen {
   ...
   public void tick() {
      if ((!this.getRealmsNotificationsEnabled() || !this.inTitleScreen() || !validClient) && !REALMS_DATA_FETCHER.isStopped()) {
         ...
         if (REALMS_DATA_FETCHER.isFetchedSinceLastTry(Task.TRIAL_AVAILABLE)) {
         ...
         (new Thread("Realms Notification Availability checker #1") {
            public void run() {
               ...
               try {
                  ...
                  if (var2 != CompatibleVersionResponse.COMPATIBLE) {
                     return;
                  }
   ...
   private void drawIcons(PoseStack var1, int var2, int var3) {
      ...
      if (hasUnreadNews) {
         ...
         GuiComponent.blit(var1, (int)((double)(var7 + 2 - var9) * (double)2.5F), (int)((double)var8 * (double)2.5F), 0.0F, 0.0F, 40, 40, 40, 40);
