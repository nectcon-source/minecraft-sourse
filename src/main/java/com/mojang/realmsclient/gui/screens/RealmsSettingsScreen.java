...
public class RealmsSettingsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.doneButton = this.addButton(new Button(var1 - 2, row(12), 106, 20, new TranslatableComponent("mco.configure.world.buttons.done"), var1x -> this.save()));
      this.addButton(
      ...
      String var2x = this.serverData.state == RealmsServer.State.OPEN ? "mco.configure.world.buttons.close" : "mco.configure.world.buttons.open";
      Button var3xx = new Button(this.width / 2 - 53, row(0), 106, 20, new TranslatableComponent(var2x), var1x -> {
         if (this.serverData.state == RealmsServer.State.OPEN) {
            Component var2 = new TranslatableComponent("mco.configure.world.close.question.line1");
            Component var3 = new TranslatableComponent("mco.configure.world.close.question.line2");
      ...
      this.addButton(var3xx);
      this.nameEdit = new EditBox(this.minecraft.font, var1, row(4), 212, 20, null, new TranslatableComponent("mco.configure.world.name"));
      this.nameEdit.setMaxLength(32);
      this.nameEdit.setValue(this.serverData.getName());
      this.addWidget(this.nameEdit);
      this.magicalSpecialHackyFocus(this.nameEdit);
      this.descEdit = new EditBox(this.minecraft.font, var1, row(8), 212, 20, null, new TranslatableComponent("mco.configure.world.description"));
