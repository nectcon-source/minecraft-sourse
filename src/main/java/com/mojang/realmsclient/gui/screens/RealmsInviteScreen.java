...
public class RealmsInviteScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.width / 2 - 100, row(10), 200, 20, new TranslatableComponent("mco.configure.world.buttons.invite"), (var1) -> this.onInvite()));
      this.addButton(new Button(this.width / 2 - 100, row(12), 200, 20, CommonComponents.GUI_CANCEL, (var1) -> this.minecraft.setScreen(this.lastScreen)));
   }
