...
public class RealmsSlotOptionsScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.spawnProtectionButton = (SettingsSlider)this.addButton(new SettingsSlider(this.column1X, row(7), this.columnWidth, this.spawnProtection, 0.0F, 16.0F));
      ...
      this.addButton(new Button(this.column1X, row(13), this.columnWidth, 20, new TranslatableComponent("mco.configure.world.buttons.done"), (var1x) -> this.saveSettings()));
      this.addButton(new Button(this.column2X, row(13), this.columnWidth, 20, CommonComponents.GUI_CANCEL, (var1x) -> this.minecraft.setScreen(this.parent)));
   ...
   private Component spawnMonstersTitle() {
      return this.difficulty == 0 ? (new TranslatableComponent("mco.configure.world.spawnMonsters")).append(": ").append(new TranslatableComponent("mco.configure.world.off")) : (new TranslatableComponent("mco.configure.world.spawnMonsters")).append(": ").append(getOnOff(this.spawnMonsters));
   }
   ...
   class SettingsSlider extends AbstractSliderButton {
      ...
      public SettingsSlider(int var2, int var3, int var4, int var5, float var6, float var7) {
         super(var2, var3, var4, 20, TextComponent.EMPTY, (double)0.0F);
