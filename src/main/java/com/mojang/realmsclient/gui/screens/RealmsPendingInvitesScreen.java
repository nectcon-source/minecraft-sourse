...
public class RealmsPendingInvitesScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      (new Thread("Realms-pending-invitations-fetcher") {
         public void run() {
            ...
            try {
               ...
               List<Entry> var3 = var2.stream().map((var1x) -> RealmsPendingInvitesScreen.this.new Entry(var1x)).collect(Collectors.toList());
      ...
      this.addButton(new Button(this.width / 2 - 50, this.height - 32, 100, 20, CommonComponents.GUI_DONE, (var1) -> this.minecraft.setScreen(new RealmsMainScreen(this.lastScreen))));
   ...
   class PendingInvitationSelectionList extends RealmsObjectSelectionList<Entry> {
      ...
      public void selectItem(int var1) {
         ...
         if (var1 != -1) {
            List<RealmsPendingInvitesScreen.Entry> var2 = RealmsPendingInvitesScreen.this.pendingInvitationSelectionList.children();
            PendingInvite var3 = ((RealmsPendingInvitesScreen.Entry)var2.get(var1)).pendingInvite;
            String var4 = I18n.get("narrator.select.list.position", new Object[]{var1 + 1, var2.size()});
            ...
            NarrationHelper.now(I18n.get("narrator.select", new Object[]{var5}));
         }
