...
public class RealmsBrokenWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.rightX - 80 + 8, row(13) - 5, 70, 20, CommonComponents.GUI_BACK, (var1) -> this.backButtonClicked()));
   ...
   private void addButtons() {
      for(Map.Entry<Integer, RealmsWorldOptions> var2 : this.serverData.slots.entrySet()) {
         int var3 = (Integer)var2.getKey();
         boolean var4 = var3 != this.serverData.activeSlot || this.serverData.worldType == WorldType.MINIGAME;
         Button var5;
         if (var4) {
            ...
            var5 = new Button(this.getFramePositionX(var3), row(8), 80, 20, new TranslatableComponent("mco.brokenworld.download"), (var2x) -> {
               Component var3x = new TranslatableComponent("mco.configure.world.restore.download.question.line1");
               Component var4_ = new TranslatableComponent("mco.configure.world.restore.download.question.line2");
               this.minecraft.setScreen(new RealmsLongConfirmationScreen((var2_) -> {
                  if (var2_) {
         ...
         this.addButton(new Button(this.getFramePositionX(var3), row(10), 80, 20, new TranslatableComponent("mco.brokenworld.reset"), (var2x) -> {
            ...
            if (var3 != this.serverData.activeSlot || this.serverData.worldType == WorldType.MINIGAME) {
               var3x.setSlot(var3);
            }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (this.serverData != null) {
         for(Map.Entry<Integer, RealmsWorldOptions> var6 : this.serverData.slots.entrySet()) {
            if (((RealmsWorldOptions)var6.getValue()).templateImage != null && ((RealmsWorldOptions)var6.getValue()).templateId != -1L) {
               this.drawSlotFrame(var1, this.getFramePositionX((Integer)var6.getKey()), row(1) + 5, var2, var3, this.serverData.activeSlot == (Integer)var6.getKey() && !this.isMinigame(), ((RealmsWorldOptions)var6.getValue()).getSlotName(var6.getKey()), var6.getKey(), (var6.getValue()).templateId, (var6.getValue()).templateImage, ((RealmsWorldOptions)var6.getValue()).empty);
            } else {
               this.drawSlotFrame(var1, this.getFramePositionX((Integer)var6.getKey()), row(1) + 5, var2, var3, this.serverData.activeSlot == (Integer)var6.getKey() && !this.isMinigame(), ((RealmsWorldOptions)var6.getValue()).getSlotName(var6.getKey()), var6.getKey(), -1L, null, (var6.getValue()).empty);
            }
         }
   ...
   private void fetchServerData(long var1) {
      (new Thread(() -> {
         ...
         try {
            ...
            this.minecraft.setScreen(new RealmsGenericErrorScreen(Component.nullToEmpty(var4_1.getMessage()), this.lastScreen));
         }
   ...
   private void downloadWorld(int var1) {
      ...
      try {
         ...
         this.minecraft.setScreen(new RealmsGenericErrorScreen(var3_1, this));
      }
