...
public class RealmsCreateRealmScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.createButton = (Button)this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 17, 97, 20, new TranslatableComponent("mco.create.world"), (var1) -> this.createWorld()));
      this.addButton(new Button(this.width / 2 + 5, this.height / 4 + 120 + 17, 95, 20, CommonComponents.GUI_CANCEL, (var1) -> this.minecraft.setScreen(this.lastScreen)));
   ...
   private void createWorld() {
      if (this.valid()) {
         RealmsResetWorldScreen var1 = new RealmsResetWorldScreen(this.lastScreen, this.server, new TranslatableComponent("mco.selectServer.create"), new TranslatableComponent("mco.create.world.subtitle"), 10526880, new TranslatableComponent("mco.create.world.skip"), () -> this.minecraft.setScreen(this.lastScreen.newScreen()), () -> this.minecraft.setScreen(this.lastScreen.newScreen()));
