...
public class RealmsResetWorldScreen extends RealmsScreenWithCallback {
   ...
   public void init() {
      this.addButton(new Button(this.width / 2 - 40, row(14) - 10, 80, 20, this.buttonTitle, (var1) -> this.minecraft.setScreen(this.lastScreen)));
      (new Thread("Realms-reset-world-fetcher") {
         public void run() {
            RealmsClient var1 = RealmsClient.create();

            try {
               WorldTemplatePaginatedList var2 = var1.fetchWorldTemplates(1, 10, WorldType.NORMAL);
               WorldTemplatePaginatedList var3 = var1.fetchWorldTemplates(1, 10, WorldType.ADVENTUREMAP);
               WorldTemplatePaginatedList var4 = var1.fetchWorldTemplates(1, 10, WorldType.EXPERIENCE);
               WorldTemplatePaginatedList var5 = var1.fetchWorldTemplates(1, 10, WorldType.INSPIRATION);
               ...
               RealmsResetWorldScreen.LOGGER.error("Couldn't fetch templates in reset world", var2_1);
            }
      ...
      this.addButton(new FrameButton(this.frame(1), row(0) + 10, new TranslatableComponent("mco.reset.world.generate"), NEW_WORLD_LOCATION, (var1) -> this.minecraft.setScreen(new RealmsResetNormalWorldScreen(this, this.title))));
      this.addButton(new FrameButton(this.frame(2), row(0) + 10, new TranslatableComponent("mco.reset.world.upload"), UPLOAD_LOCATION, (var1) -> {
         Screen var2 = new RealmsSelectFileToUploadScreen(this.serverData.id, this.slot != -1 ? this.slot : this.serverData.activeSlot, this, this.callback);
         this.minecraft.setScreen(var2);
      }));
      this.addButton(new FrameButton(this.frame(3), row(0) + 10, new TranslatableComponent("mco.reset.world.template"), SURVIVAL_SPAWN_LOCATION, (var1) -> {
         RealmsSelectWorldTemplateScreen var2 = new RealmsSelectWorldTemplateScreen(this, WorldType.NORMAL, this.templates);
         var2.setTitle(new TranslatableComponent("mco.reset.world.template"));
         this.minecraft.setScreen(var2);
      }));
      this.addButton(new FrameButton(this.frame(1), row(6) + 20, new TranslatableComponent("mco.reset.world.adventure"), ADVENTURE_MAP_LOCATION, (var1) -> {
         RealmsSelectWorldTemplateScreen var2 = new RealmsSelectWorldTemplateScreen(this, WorldType.ADVENTUREMAP, this.adventuremaps);
         var2.setTitle(new TranslatableComponent("mco.reset.world.adventure"));
         this.minecraft.setScreen(var2);
      }));
      this.addButton(new FrameButton(this.frame(2), row(6) + 20, new TranslatableComponent("mco.reset.world.experience"), EXPERIENCE_LOCATION, (var1) -> {
         RealmsSelectWorldTemplateScreen var2 = new RealmsSelectWorldTemplateScreen(this, WorldType.EXPERIENCE, this.experiences);
         var2.setTitle(new TranslatableComponent("mco.reset.world.experience"));
         this.minecraft.setScreen(var2);
      }));
      this.addButton(new FrameButton(this.frame(3), row(6) + 20, new TranslatableComponent("mco.reset.world.inspiration"), INSPIRATION_LOCATION, (var1) -> {
         RealmsSelectWorldTemplateScreen var2 = new RealmsSelectWorldTemplateScreen(this, WorldType.INSPIRATION, this.inspirations);
   ...
   private void triggerResetWorld(ResetWorldInfo var1) {
   ...
   public void resetWorld(ResetWorldInfo var1) {
      if (this.slot == -1) {
