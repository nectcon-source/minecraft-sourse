...
public class RealmsResetNormalWorldScreen extends RealmsScreen {
   ...
   public void init() {
      ...
      this.addButton(new Button(this.width / 2 - 102, row(12), 97, 20, this.buttonTitle, (var1) -> this.lastScreen.resetWorld(new RealmsResetWorldScreen.ResetWorldInfo(this.seedEdit.getValue(), this.levelTypeIndex, this.generateStructures))));
      this.addButton(new Button(this.width / 2 + 8, row(12), 97, 20, CommonComponents.GUI_BACK, (var1) -> this.minecraft.setScreen(this.lastScreen)));
      this.narrateLabels();
   }
