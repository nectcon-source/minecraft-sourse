...
public class RealmsMainScreen extends RealmsScreen {
   ...
   public void addButtons() {
      this.leaveButton = (Button)this.addButton(new Button(this.width / 2 - 202, this.height - 32, 90, 20, new TranslatableComponent("mco.selectServer.leave"), (var1x) -> this.leaveClicked(this.findServer(this.selectedServerId))));
      this.configureButton = (Button)this.addButton(new Button(this.width / 2 - 190, this.height - 32, 90, 20, new TranslatableComponent("mco.selectServer.configure"), (var1x) -> this.configureClicked(this.findServer(this.selectedServerId))));
      ...
      this.renewButton = (Button)this.addButton(new Button(this.width / 2 + 100, this.height - 32, 90, 20, new TranslatableComponent("mco.selectServer.expiredRenew"), (var1x) -> this.onRenew()));
      this.pendingInvitesButton = (Button)this.addButton(new PendingInvitesButton());
      this.newsButton = (Button)this.addButton(new NewsButton());
      this.showPopupButton = (Button)this.addButton(new ShowPopupButton());
      this.closeButton = (Button)this.addButton(new CloseButton());
      ...
      this.buyARealmButton = (Button)this.addButton(new Button(this.width / 2 + 52, this.popupY0() + 160 - 20, 98, 20, new TranslatableComponent("mco.selectServer.buy"), (var0) -> Util.getPlatform().openUri("https://aka.ms/BuyJavaRealms")));
   ...
   private boolean shouldPlayButtonBeActive(@Nullable RealmsServer var1) {
      return var1 != null && !var1.expired && var1.state == State.OPEN;
   }
   ...
   public void tick() {
      ...
      if (hasParentalConsent()) {
         ...
         if (REALMS_DATA_FETCHER.isFetchedSinceLastTry(Task.SERVER_LIST)) {
            List<RealmsServer> var1 = REALMS_DATA_FETCHER.getServers();
            ...
            if (var1 != null) {
               ...
               for(RealmsServer var12 : this.realmsServers) {
                  this.realmSelectionList.addEntry(new ServerEntry(var12));
               }
         ...
         if (REALMS_DATA_FETCHER.isFetchedSinceLastTry(Task.PENDING_INVITE)) {
            ...
            if (this.numberOfPendingInvites > 0 && this.inviteNarrationLimiter.tryAcquire(1)) {
               NarrationHelper.now(I18n.get("mco.configure.world.invite.narration", new Object[]{this.numberOfPendingInvites}));
            }
         }

         if (REALMS_DATA_FETCHER.isFetchedSinceLastTry(Task.TRIAL_AVAILABLE) && !this.createdTrial) {
         ...
         if (REALMS_DATA_FETCHER.isFetchedSinceLastTry(Task.LIVE_STATS)) {
            RealmsServerPlayerLists var7 = REALMS_DATA_FETCHER.getLivestats();

            for(RealmsServerPlayerList var9 : var7.servers) {
               for(RealmsServer var13 : this.realmsServers) {
                  if (var13.id == var9.serverId) {
                     var13.updateServerPing(var9);
                     break;
                  }
               }
            }
         ...
         if (REALMS_DATA_FETCHER.isFetchedSinceLastTry(Task.UNREAD_NEWS)) {
   ...
   private void pingRegions() {
      (new Thread(() -> {
         ...
         try {
            ...
            LOGGER.warn("Could not send ping result to Realms: ", var4_1);
         }
   ...
   private List<Long> getOwnedNonExpiredWorldIds() {
      List<Long> var1 = Lists.newArrayList();
         ...
         (new Thread("MCO Compatability Checker #1") {
            public void run() {
               ...
               try {
                  ...
                  if (var2 == CompatibleVersionResponse.OUTDATED) {
                  ...
                  if (var2 == CompatibleVersionResponse.OTHER) {
               ...
               } catch (RealmsServiceException var2_1) {
                  RealmsMainScreen.checkedClientCompatability = false;
                  RealmsMainScreen.LOGGER.error("Couldn't connect to realms", var2_1);
                  if (var2_1.httpResultCode == 401) {
                     ...
                     RealmsMainScreen.this.minecraft.execute(() -> RealmsMainScreen.this.minecraft.setScreen(new RealmsGenericErrorScreen(var2_1, RealmsMainScreen.this.lastScreen)));
                  }
               }
   ...
   private void leaveClicked(@Nullable RealmsServer var1) {
      if (var1 != null && !this.minecraft.getUser().getUuid().equals(var1.ownerUUID)) {
         this.saveListScrollPosition();
         Component var2 = new TranslatableComponent("mco.configure.world.leave.question.line1");
         Component var3 = new TranslatableComponent("mco.configure.world.leave.question.line2");
         this.minecraft.setScreen(new RealmsLongConfirmationScreen(this::leaveServer, Type.Info, var2, var3, true));
      }
            ...
            public void run() {
               try {
                  ...
                  if (var1 != null) {
                     ...
                     RealmsMainScreen.this.minecraft.execute(() -> RealmsMainScreen.this.removeServer(var1));
                  }
               } catch (RealmsServiceException var1_1) {
                  RealmsMainScreen.LOGGER.error("Couldn't configure world");
                  RealmsMainScreen.this.minecraft.execute(() -> RealmsMainScreen.this.minecraft.setScreen(new RealmsGenericErrorScreen(var1_1, RealmsMainScreen.this)));
               }
   ...
   private void removeServer(RealmsServer var1) {
      ...
      this.realmSelectionList.children().removeIf((var1x) -> var1x instanceof ServerEntry && ((ServerEntry)var1x).serverData.id == this.selectedServerId);
   ...
   private void drawPopup(PoseStack var1, int var2, int var3) {
      ...
      if (!this.showingPopup) {
         ...
         this.updateButtonStates(null);
         if (this.children.contains(this.realmSelectionList)) {
            GuiEventListener var6 = this.realmSelectionList;
   ...
   public static void updateTeaserImages(ResourceManager var0) {
      Collection<ResourceLocation> var1 = var0.listResources("textures/gui/images", (var0x) -> var0x.endsWith(".png"));
      teaserImages = var1.stream().filter((var0x) -> var0x.getNamespace().equals("realms")).collect(ImmutableList.toImmutableList());
   }
   ...
   class RealmSelectionList extends RealmsObjectSelectionList<Entry> {
      ...
      public boolean keyPressed(int var1, int var2, int var3) {
         if (var1 != 257 && var1 != 32 && var1 != 335) {
            ...
            return var4 == null ? super.keyPressed(var1, var2, var3) : var4.mouseClicked((double)0.0F, (double)0.0F, 0);
         }
      }
      ...
      public void selectItem(int var1) {
         ...
         if (var1 != -1) {
            ...
            if (var2 == null) {
               RealmsMainScreen.this.selectedServerId = -1L;
            } else if (var2.state == State.UNINITIALIZED) {
               RealmsMainScreen.this.selectedServerId = -1L;
            } else {
      ...
      public void setSelected(@Nullable RealmsMainScreen.Entry var1) {
         ...
         if (this.showingMessage && var2 == 0) {
            NarrationHelper.now(new String[]{I18n.get("mco.trial.message.line1", new Object[0]), I18n.get("mco.trial.message.line2", new Object[0])});
      ...
      public void itemClicked(int var1, int var2, double var3, double var5, int var7) {
         ...
         if (var2 < RealmsMainScreen.this.realmsServers.size()) {
            ...
            if (var8 != null) {
               if (var8.state == State.UNINITIALIZED) {
                  RealmsMainScreen.this.selectedServerId = -1L;
   ...
   class ServerEntry extends Entry {
      ...
      private void renderLegacy(RealmsServer var1, PoseStack var2, int var3, int var4, int var5, int var6) {
         if (var1.state == State.UNINITIALIZED) {
            ...
            } else if (var1.state == State.CLOSED) {
            ...
            if (RealmsMainScreen.this.isSelfOwnedServer(var1) && var1.expired) {
               ...
               if (var1.worldType == WorldType.MINIGAME) {
                  int var21 = 13413468;
   ...
   class PendingInvitesButton extends Button implements TickableWidget {
      public PendingInvitesButton() {
         super(RealmsMainScreen.this.width / 2 + 47, 6, 22, 22, TextComponent.EMPTY, (var1x) -> RealmsMainScreen.this.pendingButtonPress(var1x));
      }
   ...
   class ShowPopupButton extends Button {
      public ShowPopupButton() {
         super(RealmsMainScreen.this.width - 37, 6, 20, 20, new TranslatableComponent("mco.selectServer.info"), (var1x) -> RealmsMainScreen.this.popupOpenedByUser = !RealmsMainScreen.this.popupOpenedByUser);
      }
   ...
   class CloseButton extends Button {
      public CloseButton() {
         super(RealmsMainScreen.this.popupX0() + 4, RealmsMainScreen.this.popupY0() + 4, 12, 12, new TranslatableComponent("mco.selectServer.close"), (var1x) -> RealmsMainScreen.this.onClosePopup());
      }
