...
public class RealmsWorldOptions extends ValueObject {
   ...
   public String getSlotName(int var1) {
      if (this.slotName != null && !this.slotName.isEmpty()) {
         ...
         return this.empty ? I18n.get("mco.configure.world.slot.empty", new Object[0]) : this.getDefaultSlotName(var1);
      }
   }

   public String getDefaultSlotName(int var1) {
      return I18n.get("mco.configure.world.slot", new Object[]{var1});
   }
