...
public class RealmsTextureManager {
   ...
   private static void bindFace(final String var0) {
      ...
      if (TEXTURES.containsKey(var0)) {
         RenderSystem.bindTexture(((RealmsTexture)TEXTURES.get(var0)).textureId);
         ...
         Thread var2 = new Thread("Realms Texture Downloader") {
            public void run() {
               Map<MinecraftProfileTexture.Type, MinecraftProfileTexture> var1 = RealmsUtil.getTextures(var0);
               if (var1.containsKey(Type.SKIN)) {
                  ...
                  try {
                     ...
                     RealmsTextureManager.LOGGER.error("Couldn't download http texture", var5_1);
                     RealmsTextureManager.SKIN_FETCH_STATUS.remove(var0);
                     return;
                  } finally {
                     if (var4 != null) {
   ...
   private static int getTextureId(String var0, String var1) {
      int var2;
      if (TEXTURES.containsKey(var0)) {
         RealmsTexture var3 = (RealmsTexture)TEXTURES.get(var0);
      ...
      TEXTURES.put(var0, new RealmsTexture(var1, var2));
      return var2;
   }
