...
public class RealmsClient {
   public static Environment currentEnvironment = RealmsClient.Environment.PRODUCTION;
   ...
   private String execute(Request<?> var1) throws RealmsServiceException {
      ...
      } catch (RealmsHttpException var2_1) {
         throw new RealmsServiceException(500, "Could not connect to Realms: " + var2_1.getMessage(), -1, "");
      }
   }
