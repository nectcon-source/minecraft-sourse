...
public abstract class Request<T extends Request<T>> {
   ...
   public Request(String var1, int var2, int var3) {
      try {
         ...
         throw new RealmsHttpException(var4_4.getMessage(), var4_4);
      } catch (IOException var4_1) {
         throw new RealmsHttpException(var4_1.getMessage(), var4_1);
      }
   }
   ...
   public int responseCode() {
      try {
         ...
         throw new RealmsHttpException(var1_1.getMessage(), var1_1);
      }
   }
