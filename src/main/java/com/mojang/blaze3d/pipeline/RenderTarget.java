...
public class RenderTarget {
   ...
   private void _blitToScreen(int var1, int var2, boolean var3) {
      ...
      GlStateManager._ortho((double)0.0F, (double)var1, (double)var2, (double)0.0F, (double)1000.0F, (double)3000.0F);
      ...
      var9.vertex((double)0.0F, (double)var5, (double)0.0F).uv(0.0F, 0.0F).color(255, 255, 255, 255).endVertex();
      var9.vertex((double)var4, (double)var5, (double)0.0F).uv(var6, 0.0F).color(255, 255, 255, 255).endVertex();
      var9.vertex((double)var4, (double)0.0F, (double)0.0F).uv(var6, var7).color(255, 255, 255, 255).endVertex();
      var9.vertex((double)0.0F, (double)0.0F, (double)0.0F).uv(0.0F, var7).color(255, 255, 255, 255).endVertex();
      var8.end();
      this.unbindRead();
