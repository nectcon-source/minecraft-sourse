...
public interface VertexConsumer {
   ...
   default void putBulkData(PoseStack.Pose var1, BakedQuad var2, float[] var3, float var4, float var5, float var6, int[] var7, int var8, boolean var9) {
      ...
      try (MemoryStack var16 = MemoryStack.stackPush()) {
         ...
         for(int var20 = 0; var20 < var15; ++var20) {
            ...
            if (var9) {
               ...
               float var28 = (float)(var18.get(13) & 255) / 255.0F;
               float var29 = (float)(var18.get(14) & 255) / 255.0F;
            ...
            float var41 = var18.getFloat(16);
            float var42 = var18.getFloat(20);
            Vector4f var30 = new Vector4f(var21, var22, var23, 1.0F);
            var30.transform(var13);
            this.vertex(var30.x(), var30.y(), var30.z(), var24, var25, var26, 1.0F, var41, var42, var8, var40, var12.x(), var12.y(), var12.z());
         }
      }
