...
public class Program {
   ...
   private Program(Type var1, int var2, String var3) {
      this.type = var1;
      this.id = var2;
      this.name = var3;
   }
   ...
   public static Program compileShader(Type var0, String var1, InputStream var2, String var3) throws IOException {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
