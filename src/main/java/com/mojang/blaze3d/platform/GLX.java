...
public class GLX {
   ...
   public static LongSupplier _initGlfw() {
      ...
      if (!GLFW.glfwInit()) {
         ...
         LongSupplier var2 = () -> (long)(GLFW.glfwGetTime() * (double)1.0E9F);
   ...
   public static void _renderCrosshair(int var0, boolean var1, boolean var2, boolean var3) {
      ...
      if (var1) {
         var5.vertex((double)0.0F, (double)0.0F, (double)0.0F).color(0, 0, 0, 255).endVertex();
         var5.vertex((double)var0, (double)0.0F, (double)0.0F).color(0, 0, 0, 255).endVertex();
      }

      if (var2) {
         var5.vertex((double)0.0F, (double)0.0F, (double)0.0F).color(0, 0, 0, 255).endVertex();
         var5.vertex((double)0.0F, (double)var0, (double)0.0F).color(0, 0, 0, 255).endVertex();
      }

      if (var3) {
         var5.vertex((double)0.0F, (double)0.0F, (double)0.0F).color(0, 0, 0, 255).endVertex();
         var5.vertex((double)0.0F, (double)0.0F, (double)var0).color(0, 0, 0, 255).endVertex();
      }
      ...
      var5.begin(1, DefaultVertexFormat.POSITION_COLOR);
      if (var1) {
         var5.vertex((double)0.0F, (double)0.0F, (double)0.0F).color(255, 0, 0, 255).endVertex();
         var5.vertex((double)var0, (double)0.0F, (double)0.0F).color(255, 0, 0, 255).endVertex();
      }

      if (var2) {
         var5.vertex((double)0.0F, (double)0.0F, (double)0.0F).color(0, 255, 0, 255).endVertex();
         var5.vertex((double)0.0F, (double)var0, (double)0.0F).color(0, 255, 0, 255).endVertex();
      }

      if (var3) {
         var5.vertex((double)0.0F, (double)0.0F, (double)0.0F).color(127, 127, 255, 255).endVertex();
         var5.vertex((double)0.0F, (double)0.0F, (double)var0).color(127, 127, 255, 255).endVertex();
      }
