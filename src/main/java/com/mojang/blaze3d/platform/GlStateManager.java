...
public class GlStateManager {
   private static final FloatBuffer MATRIX_BUFFER = GLX.make(MemoryUtil.memAllocFloat(16), var0 -> DebugMemoryUntracker.untrack(MemoryUtil.memAddress(var0)));
   ...
   @Deprecated
   public static void _enableTexGen(TexGen var0) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      getTexGen(var0).enable.enable();
   }

   @Deprecated
   public static void _disableTexGen(TexGen var0) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      getTexGen(var0).enable.disable();
   }

   @Deprecated
   public static void _texGenMode(TexGen var0, int var1) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      TexGenCoord var2 = getTexGen(var0);
      if (var1 != var2.mode) {
         var2.mode = var1;
   ...
   @Deprecated
   public static void _texGenParam(TexGen var0, int var1, FloatBuffer var2) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      GL11.glTexGenfv(getTexGen(var0).coord, var1, var2);
   }

   @Deprecated
   private static TexGenCoord getTexGen(TexGen var0) {
      RenderSystem.assertThread(RenderSystem::isOnRenderThread);
      switch (var0) {
         case S:
            return TEX_GEN.s;
   ...
   static class StencilFunc {
      ...
      private StencilFunc(Object object) {
         this.func = 519;
         this.mask = -1;
      }
   }
   ...
   static class TexGenCoord {
      ...
      public TexGenCoord(int var1, int var2) {
         this.coord = var1;
         this.enable = new BooleanState(var2);
      }
   }
