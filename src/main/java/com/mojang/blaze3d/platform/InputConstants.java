...
public class InputConstants {
   ...
   static {
      ...
      MethodType var1x = MethodType.methodType(Boolean.TYPE);
      MethodHandle var2xx = null;
      int var3xxx = 0;

      try {
         var2xx = var0.findStatic(GLFW.class, "glfwRawMouseMotionSupported", var1x);
         MethodHandle var4xxxx = var0.findStaticGetter(GLFW.class, "GLFW_RAW_MOUSE_MOTION", Integer.TYPE);
         var3xxx = (int)var4xxxx.invokeExact();
      } catch (NoSuchFieldException | NoSuchMethodException var5) {
      } catch (Throwable var6) {
         throw new RuntimeException(var6);
      }

      glfwRawMouseMotionSupported = var2xx;
      GLFW_RAW_MOUSE_MOTION = var3xxx;
   }
   ...
   public static final class Key {
      ...
      private Key(String var1, InputConstants.Type var2, int var3) {
         ...
         this.type = var2;
         this.value = var3;
         this.displayName = new LazyLoadedValue(() -> (Component)var2.displayTextSupplier.apply(var3, var1));
   ...
   public static enum Type {
      ...
      MOUSE("key.mouse", (var0, var1) -> Language.getInstance().has(var1) ? new TranslatableComponent(var1) : new TranslatableComponent("key.mouse", new Object[]{var0 + 1}));
      ...
      public InputConstants.Key getOrCreate(int var1) {
         return this.map.computeIfAbsent(var1, var1x -> {
            int var2 = var1x;
            if (this == MOUSE) {
               var2 = var1x + 1;
            }
