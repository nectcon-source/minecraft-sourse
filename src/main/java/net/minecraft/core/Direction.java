...
public enum Direction implements StringRepresentable {
   ...
   private static final Map<String, Direction> BY_NAME = Arrays.stream(VALUES).collect(Collectors.toMap(Direction::getName, var0 -> var0));
   ...
   public static Direction[] orderedByNearest(Entity var0) {
      float var1 = var0.getViewXRot(1.0F) * ((float)Math.PI / 180F);
      float var2 = -var0.getViewYRot(1.0F) * ((float)Math.PI / 180F);
   ...
   public static Direction byName(@Nullable String var0) {
      return var0 == null ? null : BY_NAME.get(var0.toLowerCase(Locale.ROOT));
   }
   ...
   public boolean isFacingAngle(float var1) {
      float var2 = var1 * ((float)Math.PI / 180F);
   ...
   public static enum Axis implements StringRepresentable, Predicate<Direction> {
      ...
      private static final Map<String, Direction.Axis> BY_NAME = Arrays.stream(VALUES).collect(Collectors.toMap(Direction.Axis::getName, var0 -> var0));
      private final String name;
