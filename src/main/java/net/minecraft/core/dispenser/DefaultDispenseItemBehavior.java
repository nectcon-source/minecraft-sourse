...
public class DefaultDispenseItemBehavior implements DispenseItemBehavior {
   ...
   public static void spawnItem(Level var0, ItemStack var1, int var2, Direction var3, Position var4) {
      ...
      var11.setDeltaMovement(var0.random.nextGaussian() * (double)0.0075F * (double)var2 + (double)var3.getStepX() * var12, var0.random.nextGaussian() * (double)0.0075F * (double)var2 + (double)0.2F, var0.random.nextGaussian() * (double)0.0075F * (double)var2 + (double)var3.getStepZ() * var12);
