...
public class ParticleTypes {
   ...
   public static final ParticleType<DustParticleOptions> DUST = register("dust", DustParticleOptions.DESERIALIZER, var0 -> DustParticleOptions.CODEC);
   ...
   private static <T extends ParticleOptions> ParticleType<T> register(
      String var0, ParticleOptions.Deserializer<T> var1, final Function<ParticleType<T>, Codec<T>> var2
   ) {
      return Registry.register(Registry.PARTICLE_TYPE, var0, new ParticleType<T>(false, var1) {
         @Override
         public Codec<T> codec() {
            return (Codec<T>)var2.apply(this);
         }
      });
   }
}
