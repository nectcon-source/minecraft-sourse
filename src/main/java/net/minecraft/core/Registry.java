...
public abstract class Registry<T> implements Codec<T>, Keyable, IdMap<T> {
   ...
   private static <T> DefaultedRegistry<T> registerDefaulted(ResourceKey<? extends Registry<T>> var0, String var1, Lifecycle var2, Supplier<T> var3) {
      return internalRegister(var0, new DefaultedRegistry(var1, var0, var2), var3, var2);
   }
   ...
   public <U> DataResult<Pair<T, U>> decode(DynamicOps<U> var1, U var2) {
      return var1.compressMaps()
         ? var1.getNumberValue(var2).flatMap(var1x -> {
            T var2x = this.byId(var1x.intValue());
            return var2x == null ? DataResult.error("Unknown registry id: " + var1x) : DataResult.success(var2x, this.lifecycle((T)var2x));
         }).map(var1x -> Pair.of(var1x, var1.empty()))
         : ResourceLocation.CODEC
            .decode(var1, var2)
            .flatMap(
               var1x -> {
                  T var2x = this.get(   var1x.getFirst());
                  return var2x == null
                     ? DataResult.error("Unknown registry key: " + var1x.getFirst())
                     : DataResult.success(Pair.of(var2x, var1x.getSecond()), this.lifecycle((T)var2x));
               }
            );
   }
   ...
   public <U> DataResult<U> encode(T var1, DynamicOps<U> var2, U var3) {
      ...
      if (var4 == null) {
         ...
         return var2.compressMaps() ?
                 var2.mergeToPrimitive(var3, var2.createInt(this.getId(var1))).setLifecycle(this.lifecycle)
                 : var2.mergeToPrimitive(var3, var2.createString(var4.toString())).setLifecycle(this.lifecycle);
      }
   }
   ...
   public static <V, T extends V> T register(Registry<V> var0, ResourceLocation var1, T var2) {
      return (T)((WritableRegistry)var0).register(ResourceKey.create(var0.key, var1), var2, Lifecycle.stable());
   }

   public static <V, T extends V> T registerMapping(Registry<V> var0, int var1, String var2, T var3) {
      return (T) ((WritableRegistry)var0).registerMapping(var1, ResourceKey.create(var0.key, new ResourceLocation(var2)), var3, Lifecycle.stable());
   }
