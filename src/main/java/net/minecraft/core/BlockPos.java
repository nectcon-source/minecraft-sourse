...
public class BlockPos extends Vec3i {
   ...
   public BlockPos offset(double var1, double var3, double var5) {
      return var1 == (double)0.0F && var3 == (double)0.0F && var5 == (double)0.0F ? this : new BlockPos((double)this.getX() + var1, (double)this.getY() + var3, (double)this.getZ() + var5);
   }
   ...
   public BlockPos cross(Vec3i var1) {
      return new BlockPos(
         this.getY() * var1.getZ() - this.getZ() * var1.getY(), this.getZ() * var1.getX() - this.getX() * var1.getZ(), this.getX() * var1.getY() - this.getY() * var1.getX()
      );
   }
      ...
      return () -> new AbstractIterator<BlockPos>() {
         ...
         protected BlockPos computeNext() {
            if (this.counter <= 0) {
               ...
               BlockPos var1x = this.nextPos.set(var2 + var0.nextInt(var8), var3 + var0.nextInt(var9), var4 + var0.nextInt(var10));
               --this.counter;
               return var1x;
            }
         }
