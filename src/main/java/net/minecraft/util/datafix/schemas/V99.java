...
public class V99 extends Schema {
   ...
   private static final Map<String, String> ITEM_TO_BLOCKENTITY = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   protected static final Hook.HookFunction ADD_NAMES = new Hook.HookFunction() {
      public <T> T apply(DynamicOps<T> var1, T var2) {
         return (T)V99.addNames(new Dynamic(var1, var2), V99.ITEM_TO_BLOCKENTITY, "ArmorStand");
      }
   };
   ...
   public Map<String, Supplier<TypeTemplate>> registerEntities(Schema var1) {
      ...
      var1.register(var2, "Villager", (var1x) -> DSL.optionalFields("Inventory", DSL.list(References.ITEM_STACK.in(var1)), "Offers", DSL.optionalFields("Recipes", DSL.list(DSL.optionalFields("buy", References.ITEM_STACK.in(var1), "buyB", References.ITEM_STACK.in(var1), "sell", References.ITEM_STACK.in(var1)))), equipment(var1)));
   ...
   public void registerTypes(Schema var1, Map<String, Supplier<TypeTemplate>> var2, Map<String, Supplier<TypeTemplate>> var3) {
      ...
      var1.registerType(false, References.CHUNK, () -> DSL.fields("Level", DSL.optionalFields("Entities", DSL.list(References.ENTITY_TREE.in(var1)), "TileEntities", DSL.list(References.BLOCK_ENTITY.in(var1)), "TileTicks", DSL.list(DSL.fields("i", References.BLOCK_NAME.in(var1))))));
      ...
      var1.registerType(true, References.ITEM_STACK, () -> DSL.hook(DSL.optionalFields("id", DSL.or(DSL.constType(DSL.intType()), References.ITEM_NAME.in(var1)), "tag", DSL.optionalFields("EntityTag", References.ENTITY_TREE.in(var1), "BlockEntityTag", References.BLOCK_ENTITY.in(var1), "CanDestroy", DSL.list(References.BLOCK_NAME.in(var1)), "CanPlaceOn", DSL.list(References.BLOCK_NAME.in(var1)))), ADD_NAMES, HookFunction.IDENTITY));
   ...
   protected static <T> T addNames(Dynamic<T> var0, Map<String, String> var1, String var2) {
      return (T)var0.update("tag", var3 -> var3.update("BlockEntityTag", var2xx -> {
            ...
            String var4x = var1.get(NamespacedSchema.ensureNamespaced(var3x));
            if (var4x == null) {
               LOGGER.warn("Unable to resolve BlockEntity for ItemStack: {}", var3x);
               return var2xx;
            } else {
               return var2xx.set("id", var0.createString(var4x));
            }
         }).update("EntityTag", var2xx -> {
            String var3x = var0.get("id").asString("");
            return Objects.equals(NamespacedSchema.ensureNamespaced(var3x), "minecraft:armor_stand") ? var2xx.set("id", var0.createString(var2)) : var2xx;
         })).getValue();
   }
}
