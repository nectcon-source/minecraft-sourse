...
public class V2100 extends NamespacedSchema {
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema var1) {
      ...
      var1.register(var2, "minecraft:beehive", () -> DSL.optionalFields("Items", DSL.list(References.ITEM_STACK.in(var1)), "Bees", DSL.list(DSL.optionalFields("EntityData", References.ENTITY_TREE.in(var1)))));
      return var2;
   }
}
