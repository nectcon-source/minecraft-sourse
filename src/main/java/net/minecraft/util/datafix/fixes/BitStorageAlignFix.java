...
public class BitStorageAlignFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      Type<?> var5 = ((com.mojang.datafixers.types.templates.List.ListType)var4.type()).getElement();
      OpticFinder<?> var6 = DSL.typeFinder(var5);
      Type<Pair<String, Dynamic<?>>> var7 = DSL.named(References.BLOCK_STATE.typeName(), DSL.remainderType());
      OpticFinder<List<Pair<String, Dynamic<?>>>> var8 = DSL.fieldFinder("Palette", DSL.list(var7));
      return this.fixTypeEverywhereTyped(
              "BitStorageAlignFix", var1,
              this.getOutputSchema().getType(References.CHUNK),
              (var5x) -> var5x.updateTyped(var3, (var4x) ->
                      this.updateHeightmaps(
                              updateSections(var4, var6, var8, var4x))));
   }
   ...
   private static Dynamic<?> updateBitStorage(Dynamic<?> var0, Dynamic<?> var1, int var2, int var3) {
      ...
      long[] var5x = addPadding(var2, var3, var4);
      return var0.createLongList(LongStream.of(var5x));
   }
