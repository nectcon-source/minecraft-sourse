...
public class WorldGenSettingsFix extends DataFix {
   ...
   private static <T> Dynamic<T> vanillaBiomeSource(Dynamic<T> var0, long var1, boolean var3, boolean var4) {
      Builder<Dynamic<T>, Dynamic<T>> var5 = ImmutableMap.<Dynamic<T>, Dynamic<T>>builder()
   ...
   private static <T> Dynamic<T> fix(Dynamic<T> var0) {
       ...
       Optional<String> var6 = (Optional)var0.get("legacy_custom_options").asString().result().map(Optional::of).orElseGet(() -> var5.equals(Optional.of("customized")) ? var0.get("generatorOptions").asString().result() : Optional.empty());
       boolean var7 = false;
       Dynamic<T> var4;
       if (var5.equals(Optional.of("customized"))) {
           ...
           switch ((String)var5.get()) {
               case "flat":
                   ...
                   Map<Dynamic<T>, Dynamic<T>> var11 = fixFlatStructures(var1, var10);
                   var4 = var0.createMap(ImmutableMap.of(var0.createString("type"), var0.createString("minecraft:flat"), var0.createString("settings"), var0.createMap(ImmutableMap.of(var0.createString("structures"), var0.createMap(var11), var0.createString("layers"), var10.get("layers").result().orElseGet(() -> var0.createList(Stream.of(var0.createMap(ImmutableMap.of(var0.createString("height"), var0.createInt(1), var0.createString("block"), var0.createString("minecraft:bedrock"))), var0.createMap(ImmutableMap.of(var0.createString("height"), var0.createInt(2), var0.createString("block"), var0.createString("minecraft:dirt"))), var0.createMap(ImmutableMap.of(var0.createString("height"), var0.createInt(1), var0.createString("block"), var0.createString("minecraft:grass_block")))))), var0.createString("biome"), var0.createString(var10.get("biome").asString("minecraft:plains"))))));
                   break;
               ...
               case "buffet":
                   ...
                   Dynamic<T> var16 = (Dynamic)var12.get("biome_source").result().orElseGet(() -> var0.createMap(ImmutableMap.of(var0.createString("type"), var0.createString("minecraft:fixed"))));
                   Dynamic<T> var17;
       ...
       ImmutableMap.Builder<T, T> var24 = ImmutableMap.builder();
   ...
   protected static <T> T vanillaLevels(Dynamic<T> var0, long var1, Dynamic<T> var3, boolean var4) {
      ...
      return (T)var5.createMap(
         ImmutableMap.of(
                 ...
                 var5.createMap(
               ImmutableMap.of(var5.createString("type"), var5.createString("minecraft:overworld" + (var4 ? "_caves" : "")), var5.createString("generator"), var3.getValue())
            ),
               ...
               ImmutableMap.of(
                  ...
                  noise(
                          ...
                          var0.createMap(ImmutableMap.of(var0.createString("type"), var0.createString("minecraft:the_end"), var0.createString("seed"), var0.createLong(var1)))
                     )
                     .getValue()
               )
            )
   ...
   private static <T> Map<Dynamic<T>, Dynamic<T>> fixFlatStructures(DynamicOps<T> var0, OptionalDynamic<T> var1) {
      ...
      MutableInt var3x = new MutableInt(3);
      MutableInt var4xx = new MutableInt(128);
      MutableBoolean var5xxx = new MutableBoolean(false);
      Map<String, WorldGenSettingsFix.StructureFeatureConfiguration> var6xxxx = Maps.newHashMap();
      if (!var1.result().isPresent()) {
          var5xxx.setTrue();
         var6xxxx.put("minecraft:village", (WorldGenSettingsFix.StructureFeatureConfiguration)DEFAULTS.get("minecraft:village"));
      }
                        ...
                        .ifPresent(
                           var6xx -> var6xx.forEach(
                                 (var6xxx, var7x) -> {
                                    ...
                                    String var9x = var6xxx.asString("");
                                    String var10xx = var7x.asString("");
                                    if ("stronghold".equals(var8)) {
                                       var5xxx.setTrue();
                                       switch(var9x) {
                                          case "distance":
                                              var2.setValue(getInt(var10xx, var2.getValue(), 1));
                                             return;
                                          case "spread":
                                              var3x.setValue(getInt(var10xx, var3x.getValue(), 1));
                                             return;
                                          case "count":
                                              var4xx.setValue(getInt(var10xx, var4xx.getValue(), 1));
                                             return;
                                       }
                                    } else {
                                       switch(var9x) {
                                          case "distance":
                                             switch(var8) {
                                                case "village":
                                                   setSpacing(var6xxxx, "minecraft:village", var10xx, 9);
                                                   return;
                                                case "biome_1":
                                                   setSpacing(var6xxxx, "minecraft:desert_pyramid", var10xx, 9);
                                                   setSpacing(var6xxxx, "minecraft:igloo", var10xx, 9);
                                                   setSpacing(var6xxxx, "minecraft:jungle_pyramid", var10xx, 9);
                                                   setSpacing(var6xxxx, "minecraft:swamp_hut", var10xx, 9);
                                                   setSpacing(var6xxxx, "minecraft:pillager_outpost", var10xx, 9);
                                                   return;
                                                case "endcity":
                                                   setSpacing(var6xxxx, "minecraft:endcity", var10xx, 1);
                                                   return;
                                                case "mansion":
                                                   setSpacing(var6xxxx, "minecraft:mansion", var10xx, 1);
                                                   return;
                                                default:
                                                   return;
                                             }
                                          case "separation":
                                             if ("oceanmonument".equals(var8)) {
                                                WorldGenSettingsFix.StructureFeatureConfiguration var13 = var6xxxx.getOrDefault(
                                                   "minecraft:monument", (WorldGenSettingsFix.StructureFeatureConfiguration)DEFAULTS.get("minecraft:monument")
                                                );
                                                int var14x = getInt(var10xx, var13.separation, 1);
                                                 var6xxxx.put("minecraft:monument", new WorldGenSettingsFix.StructureFeatureConfiguration(var14x, var13.separation, var13.salt));
                                             }
                  
                                             return;
                                          case "spacing":
                                             if ("oceanmonument".equals(var8)) {
                                                setSpacing(var6xxxx, "minecraft:monument", var10xx, 1);
                                             }
      ...
      Builder<Dynamic<T>, Dynamic<T>> var7 = ImmutableMap.<Dynamic<T>, Dynamic<T>>builder();
       var7.put(
               var1.createString("structures"), var1.createMap(
                       var6xxxx.entrySet()
               .stream()
               .collect(
                  Collectors.toMap(
      ...
      if (var5xxx.isTrue()) {
          var7.put(
                  var1.createString("stronghold"), var1.createMap(
               ImmutableMap.of(
                       var1.createString("distance"),
                       var1.createInt(var2.getValue()),
                       var1.createString("spread"),
                       var1.createInt(var3x.getValue()),
                       var1.createString("count"),
                       var1.createInt(var4xx.getValue())
               )
            )
         );
      }
   ...
   private static void setSpacing(Map<String, WorldGenSettingsFix.StructureFeatureConfiguration> var0, String var1, String var2, int var3) {
      WorldGenSettingsFix.StructureFeatureConfiguration var4 = var0.getOrDefault(var1, (WorldGenSettingsFix.StructureFeatureConfiguration)DEFAULTS.get(var1));
      int var5x = getInt(var2, var4.spacing, var3);
       var0.put(var1, new WorldGenSettingsFix.StructureFeatureConfiguration(var5x, var4.separation, var4.salt));
   }
