...
public class JigsawPropertiesFix extends NamedEntityFix {
   ...
   private static Dynamic<?> fixTag(Dynamic<?> var0) {
      ...
      String var2x = var0.get("target_pool").asString("minecraft:empty");
      return var0.set("name", var0.createString(var1)).set("target", var0.createString(var1)).remove("attachement_type").set("pool", var0.createString(var2x)).remove("target_pool");
   }
