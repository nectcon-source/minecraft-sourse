...
public abstract class EntityRenameFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
       TaggedChoice.TaggedChoiceType<String> var1 = (TaggedChoiceType<String>) this.getInputSchema().findChoiceType(References.ENTITY);
       TaggedChoice.TaggedChoiceType<String> var2 = (TaggedChoiceType<String>) this.getOutputSchema().findChoiceType(References.ENTITY);
       return this.fixTypeEverywhere(this.name, var1, var2, (var3) -> (var4) -> {
           ...
           Pair<String, Typed<?>> var7 = this.fix(var5, this.getEntity(var4.getSecond(), var3, var6));
