...
public class ChunkPalettedStorageFix extends DataFix {
   ...
   private static final Map<String, Dynamic<?>> FLOWER_POT_MAP = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   private static final Map<String, Dynamic<?>> SKULL_MAP = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   private static final Map<String, Dynamic<?>> DOOR_MAP = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   private static final Map<String, Dynamic<?>> NOTE_BLOCK_MAP = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   private static final Map<String, Dynamic<?>> BED_BLOCK_MAP = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   private static final Map<String, Dynamic<?>> BANNER_BLOCK_MAP = DataFixUtils.make(Maps.newHashMap(), var0 -> {
      ObjectIterator var1 = DYE_COLOR_MAP.int2ObjectEntrySet().iterator();
   ...
   private Dynamic<?> fix(Dynamic<?> var1) {
      Optional<? extends Dynamic<?>> var2 = var1.get("Level").result();
      ...
      public int upgrade(int var1) {
         if (!this.hasData) {
            ...
            for(int var5 = 0; var5 < 4096; ++var5) {
               ...
               int var7 = var5 >> 8 & 15;
               int var8 = var5 >> 4 & 15;
               int var9 = var4xx.get(var6, var7, var8) << 12 | (var2.get(var5) & 255) << 4 | var3x.get(var6, var7, var8);
   ...
   static final class UpgradeChunk {
      ...
      public UpgradeChunk(Dynamic<?> var1) {
            ...
            .ifPresent(
               var1x -> var1x.forEach(
                     var1xx -> {
                        ...
                        int var3x = var1xx.get("y").asInt(0);
                        int var4xx = var1xx.get("z").asInt(0) - this.z & 15;
                        int var5xxx = var3x << 8 | var4xx << 4 | var2x;
                        if (this.blockEntities.put(var5xxx, var1xx) != null) {
                           ChunkPalettedStorageFix.LOGGER
                              .warn("In chunk: {}x{} found a duplicate block entity at position: [{}, {}, {}]", this.x, this.z, var2x, var3x, var4xx);
                        }
                     }
                  )
            );
         ...
         for(ChunkPalettedStorageFix.Section var6 : this.sections) {
            if (var6 != null) {
               ...
               while(var7.hasNext()) {
                  java.util.Map.Entry<Integer, IntList> var8x = (java.util.Map.Entry)var7.next();
                  int var9xx = var6.y << 12;
                  switch(var8x.getKey()) {
                     case 2:
                        IntListIterator var30 = ((IntList)var8x.getValue()).iterator();

                        while(var30.hasNext()) {
                           int var50xxx = var30.next();
                           var50xxx |= var9xx;
                           Dynamic<?> var61xxxx = this.getBlock(var50xxx);
                           if ("minecraft:grass_block".equals(ChunkPalettedStorageFix.getName(var61xxxx))) {
                              String var71xxxxx = ChunkPalettedStorageFix.getName(this.getBlock(relative(var50xxx, ChunkPalettedStorageFix.Direction.UP)));
                              if ("minecraft:snow".equals(var71xxxxx) || "minecraft:snow_layer".equals(var71xxxxx)) {
                                 this.setBlock(var50xxx, ChunkPalettedStorageFix.SNOWY_GRASS);
                              }
                           }
                        }
                        break;
                     case 3:
                        IntListIterator var29 = ((IntList)var8x.getValue()).iterator();
                        ...
                        break;
                     case 25:
                        IntListIterator var28 = ((IntList)var8x.getValue()).iterator();
                        ...
                        while(var28.hasNext()) {
                           ...
                           if (var59 != null) {
                              String var69 = Boolean.toString(var59.get("powered").asBoolean(false)) + (byte)Math.min(Math.max(var59.get("note").asInt(0), 0), 24);
                              this.setBlock(var46, (Dynamic)ChunkPalettedStorageFix.NOTE_BLOCK_MAP.getOrDefault(var69, ChunkPalettedStorageFix.NOTE_BLOCK_MAP.get("false0")));
                           }
                        }
                        break;
                     case 26:
                        IntListIterator var27 = ((IntList)var8x.getValue()).iterator();
                        ...
                        while(var27.hasNext()) {
                           ...
                           if (var58 != null) {
                              ...
                              if (var75 != 14 && var75 >= 0 && var75 < 16) {
                                 String var78 = ChunkPalettedStorageFix.getProperty(var68, "facing") + ChunkPalettedStorageFix.getProperty(var68, "occupied") + ChunkPalettedStorageFix.getProperty(var68, "part") + var75;
                     ...
                     case 196:
                     case 197:
                        IntListIterator var26 = ((IntList)var8x.getValue()).iterator();
                        ...
                        break;
                     case 86:
                        IntListIterator var25 = ((IntList)var8x.getValue()).iterator();
                        ...
                        break;
                     case 110:
                        IntListIterator var24 = ((IntList)var8x.getValue()).iterator();
                        ...
                        break;
                     case 140:
                        IntListIterator var23 = ((IntList)var8x.getValue()).iterator();
                        ...
                        while(var23.hasNext()) {
                           ...
                           if (var54 != null) {
                              ...
                              this.setBlock(var36, (Dynamic)ChunkPalettedStorageFix.FLOWER_POT_MAP.getOrDefault(var64, ChunkPalettedStorageFix.FLOWER_POT_MAP.get("minecraft:air0")));
                           }
                        }
                        break;
                     case 144:
                        IntListIterator var22 = ((IntList) var8x.getValue()).iterator();
                        ...
                        while(var22.hasNext()) {
                           ...
                           if (var53 != null) {
                              ...
                              var53.remove("facing");
                              var53.remove("Rot");
                              this.setBlock(var34, (Dynamic)ChunkPalettedStorageFix.SKULL_MAP.getOrDefault(var76, ChunkPalettedStorageFix.SKULL_MAP.get("0north")));
                           }
                        }
                        break;
                     case 175:
                        IntListIterator var21 = ((IntList)var8x.getValue()).iterator();
                     ...
                     case 176:
                     case 177:
                        IntListIterator var10 = ((IntList)var8x.getValue()).iterator();
                        ...
                        while(var10.hasNext()) {
                           ...
                           if (var12 != null) {
                              ...
                              if (var14 != 15 && var14 >= 0 && var14 < 16) {
                                 String var15 = ChunkPalettedStorageFix.getProperty(var13, (Integer)var8x.getKey() == 176 ? "rotation" : "facing") + "_" + var14;
      ...
      public Dynamic<?> write() {
         ...
         List<Dynamic<?>> var3 = Lists.newArrayList();
