...
public class AddNewChoices extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      TaggedChoiceType<?> var2x = this.getOutputSchema().findChoiceType(this.type);
      return this.cap(this.name, (TaggedChoiceType<String>) var1, (TaggedChoiceType<String>) var2x);
   }

   protected final <K> TypeRewriteRule cap(String var1, TaggedChoiceType<K> var2, TaggedChoiceType<K> var3) {
