...
public class BlockStateData {
   ...
   private static void register(int var0, String var1, String... var2) {
      ...
      MAP[var0] = var3;
      int var4x = var0 >> 4;
      if (BLOCK_DEFAULTS[var4x] == null) {
         BLOCK_DEFAULTS[var4x] = var3;
      }

      for(String var8 : var2) {
         Dynamic<?> var9 = parse(var8);
         String var10x = var9.get("Name").asString("");
         ID_BY_OLD_NAME.putIfAbsent(var10x, var0);
   ...
   public static Dynamic<?> upgradeBlockStateTag(Dynamic<?> var0) {
      ...
      if (var1 >= 0 && var1 < MAP.length) {
         Dynamic<?> var2x = MAP[var1];
         return var2x == null ? var0 : var2x;
      } else {
         return var0;
      }
   }
   ...
   public static Dynamic<?> parse(String var0) {
      try {
         ...
         LOGGER.error("Parsing {}", var0, var1_1);
