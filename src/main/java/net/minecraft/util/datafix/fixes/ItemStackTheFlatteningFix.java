...
public class ItemStackTheFlatteningFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceTheFlatteningFix", var1, var2x_ -> {
         Optional<Pair<String, String>> var3x = var2x_.getOptional(var2x);
         if (!var3x.isPresent()) {
            return var2x_;
         } else {
            Typed<?> var4 = var2x_;
            Dynamic<?> var5x = (Dynamic)var2x_.get(DSL.remainderFinder());
            int var6xx = var5x.get("Damage").asInt(0);
            String var7xxx = updateItem((String)((Pair)var3x.get()).getSecond(), var6xx);
            if (var7xxx != null) {
               var4 = var2x_.set(var2x, Pair.of(References.ITEM_NAME.typeName(), var7xxx));
            }

            if (DAMAGE_IDS.contains(((Pair)var3x.get()).getSecond())) {
               Typed<?> var8 = var2x_.getOrCreateTyped(var3xx);
               Dynamic<?> var9x = (Dynamic)var8.get(DSL.remainderFinder());
               var9x = var9x.set("Damage", var9x.createInt(var6xx));
               var4 = var4.set(var3xx, var8.set(DSL.remainderFinder(), var9x));
            }

            return var4.set(DSL.remainderFinder(), var5x.remove("Damage"));
         }
      });
   }
