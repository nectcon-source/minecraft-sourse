      ...
      return this.fixTypeEverywhereTyped(
         ...
         var0 -> var0.update(
               ...
               var0x -> {
                  ...
                  if (var1.isPresent()) {
                     UUID var2x = UUID.fromString(var1.get());
                     return var0x.remove("UUID")
                        .set("UUIDMost", var0x.createLong(var2x.getMostSignificantBits()))
                        .set("UUIDLeast", var0x.createLong(var2x.getLeastSignificantBits()));
                  } else {
                     return var0x;
                  }
               }
