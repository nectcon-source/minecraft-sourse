...
public class ItemIdFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      Type<Either<Integer, Pair<String, String>>> var1 = DSL.or(DSL.intType(), DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString()));
      Type<Pair<String, String>> var2 = DSL.named(References.ITEM_NAME.typeName(), NamespacedSchema.namespacedString());
      OpticFinder<Either<Integer, Pair<String, String>>> var3xx = DSL.fieldFinder("id", var1);
      return this.fixTypeEverywhereTyped(
         "ItemIdFix",
         this.getInputSchema().getType(References.ITEM_STACK),
         this.getOutputSchema().getType(References.ITEM_STACK),
         var2x -> var2x.update(var3xx, var2, var0x -> (Pair)var0x.map(var0xx -> Pair.of(References.ITEM_NAME.typeName(), getItem(var0xx)), var0xx -> var0xx))
      );
   }
}
