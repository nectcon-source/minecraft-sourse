...
public class BlockEntityIdFix extends DataFix {
   private static final Map<String, String> ID_MAP = DataFixUtils.make(Maps.newHashMap(), var0 -> {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> var2x = this.getOutputSchema().getType(References.ITEM_STACK);
      TaggedChoiceType<String> var3xx = (TaggedChoiceType<String>) this.getInputSchema().findChoiceType(References.BLOCK_ENTITY);
      TaggedChoiceType<String> var4xxx = (TaggedChoiceType<String>) this.getOutputSchema().findChoiceType(References.BLOCK_ENTITY);
      return TypeRewriteRule.seq(
         this.convertUnchecked("item stack block entity name hook converter", var1, var2x),
         this.fixTypeEverywhere("BlockEntityIdFix", var3xx, var4xxx, var0 -> var0x -> var0x.mapFirst(var0xx -> ID_MAP.getOrDefault(var0xx, var0xx)))
      );
   }
}
