...
public class EntityIdFix extends DataFix {
   ...
   public TypeRewriteRule makeRule() {
      ...
      Type<?> var3xx = this.getInputSchema().getType(References.ITEM_STACK);
      Type<?> var4xxx = this.getOutputSchema().getType(References.ITEM_STACK);
      return TypeRewriteRule.seq(
         this.convertUnchecked("item stack entity name hook converter", var3xx, var4xxx),
         this.fixTypeEverywhere("EntityIdFix", var1, var2x, var0 -> var0x -> var0x.mapFirst(var0xx -> ID_MAP.getOrDefault(var0xx, var0xx)))
      );
   }
}
