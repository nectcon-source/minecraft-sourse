...
public class ItemStackEnchantmentNamesFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(
         "ItemStackEnchantmentFix", var1, var2x -> var2x.updateTyped(var2x_, var1xx -> var1xx.update(DSL.remainderFinder(), this::fixTag))
      );
   }

   private Dynamic<?> fixTag(Dynamic<?> var1) {
      Optional<? extends Dynamic<?>> var2 = var1.get("ench")
         .asStreamOpt()
