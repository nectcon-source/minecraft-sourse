...
public class DataFixers {
   ...
   private static void addFixers(DataFixerBuilder var0) {
      ...
      var0.addFixer(ItemRenameFix.create(var18, "cooked_fished item renamer", (var0x) -> Objects.equals(NamespacedSchema.ensureNamespaced(var0x), "minecraft:cooked_fished") ? "minecraft:cooked_fish" : var0x));
      ...
      var0.addFixer(BlockRenameFix.create(var52, "Colorless shulker block fixer", (var0x) -> Objects.equals(NamespacedSchema.ensureNamespaced(var0x), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : var0x));
      var0.addFixer(ItemRenameFix.create(var52, "Colorless shulker item fixer", (var0x) -> Objects.equals(NamespacedSchema.ensureNamespaced(var0x), "minecraft:purple_shulker_box") ? "minecraft:shulker_box" : var0x));
