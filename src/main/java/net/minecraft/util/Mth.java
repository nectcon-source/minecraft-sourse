...
public class Mth {
   ...
   private static final float[] SIN = Util.make(new float[65536], (var0x) -> {
      for(int var1 = 0; var1 < var0x.length; ++var1) {
         var0x[var1] = (float)Math.sin((double)var1 * Math.PI * (double)2.0F / (double)65536.0F);
      }
   ...
   public static double clampedLerp(double var0, double var2, double var4) {
      if (var4 < (double)0.0F) {
         ...
         return var4 > (double)1.0F ? var2 : lerp(var4, var0, var2);
      }
   }
   ...
   public static boolean equal(double var0, double var2) {
      return Math.abs(var2 - var0) < (double)1.0E-5F;
   }
   ...
   public static double wrapDegrees(double var0) {
      double var2 = var0 % (double)360.0F;
      if (var2 >= (double)180.0F) {
         var2 -= 360.0F;
      }
   ...
   public static double atan2(double var0, double var2) {
      ...
      if (Double.isNaN(var4)) {
         ...
         boolean var6 = var0 < (double)0.0F;
         if (var6) {
            var0 = -var0;
         }

         boolean var7 = var2 < (double)0.0F;
         if (var7) {
            var2 = -var2;
         }
         ...
         double var22 = ((double)6.0F + var20 * var20) * var20 * 0.16666666666666666;
         double var24 = var14 + var22;
         if (var8) {
            var24 = (Math.PI / 2D) - var24;
         }
   ...
   public static double smoothstep(double var0) {
      return var0 * var0 * var0 * (var0 * (var0 * (double)6.0F - (double)15.0F) + (double)10.0F);
   }
   ...
   static {
      for(int var0 = 0; var0 < 257; ++var0) {
         double var1 = (double)var0 / (double)256.0F;
