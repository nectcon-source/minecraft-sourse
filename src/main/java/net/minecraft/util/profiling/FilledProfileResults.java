...
public class FilledProfileResults implements ProfileResults {
   ...
   public List<ResultField> getTimes(String var1) {
      ...
      List<ResultField> var11 = Lists.newArrayList();
      if (!var1.isEmpty()) {
         var1 = var1 + '\u001e';
      }
      ...
      for(String var16 : this.entries.keySet()) {
         if (isDirectChild(var1, var16)) {
            ...
            double var20 = (double)var18 * (double)100.0F / (double)var12;
            double var22 = (double)var18 * (double)100.0F / (double)var4;
      ...
      if ((float)var12 > var25) {
         var11.add(new ResultField("unspecified", (double)((float)var12 - var25) * (double)100.0F / (double)var12, (double)((float)var12 - var25) * (double)100.0F / (double)var4, var9));
      }

      Collections.sort(var11);
      var11.add(0, new ResultField(var2, (double)100.0F, (double)var12 * (double)100.0F / (double)var4, var9));
      return var11;
   }
   ...
   private Map<String, FilledProfileResults.CounterCollector> getCounterValues() {
      Map<String, CounterCollector> var1 = Maps.newTreeMap();
      this.entries.forEach((var1x, var2) -> {
         Object2LongMap<String> var3 = var2.getCounters();
         if (!var3.isEmpty()) {
            List<String> var4 = SPLITTER.splitToList(var1x);
   ...
   public boolean saveResults(File var1) {
      ...
      try {
         ...
         LOGGER.error("Could not save profiler results to {}", var1, var3_1);
         var4 = false;
      } finally {
   ...
   protected String getProfilerResults(long var1, int var3) {
      ...
      Map<String, CounterCollector> var5 = this.getCounterValues();
      if (!var5.isEmpty()) {
   ...
   private void appendProfilerResults(int var1, String var2, StringBuilder var3) {
      List<ResultField> var4 = this.getTimes(var2);
      Object2LongMap<String> var5 = ((ProfilerPathEntry)ObjectUtils.firstNonNull(new ProfilerPathEntry[]{(ProfilerPathEntry)this.entries.get(var2), EMPTY})).getCounters();
         ...
         for(int var6 = 1; var6 < var4.size(); ++var6) {
            ...
            if (!"unspecified".equals(var7.name)) {
               try {
                  ...
                  var3.append("[[ EXCEPTION ").append(var8_1).append(" ]]");
               }
            }
         }
   ...
   static class CounterCollector {
      ...
      public void addValue(Iterator<String> var1, long var2) {
         ...
         if (!var1.hasNext()) {
            ...
            this.children.computeIfAbsent(var1.next(), var0 -> new FilledProfileResults.CounterCollector()).addValue(var1, var2);
         }
      }
   }
}
