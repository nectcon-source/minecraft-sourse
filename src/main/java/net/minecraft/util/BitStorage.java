...
public class BitStorage {
    ...
    public BitStorage(int var1, int var2, @Nullable long[] var3) {
        ...
        if (var3 != null) {
            if (var3.length != var5) {
                throw Util.pauseInIde(new RuntimeException("Invalid length given for storage, got: " + var3.length + " but expected: " + var5));
            }
    ...
    public int getAndSet(int var1, int var2) {
        Validate.inclusiveBetween(0L, (this.size - 1), (long)var1);
    ...
    public void set(int var1, int var2) {
        Validate.inclusiveBetween(0L, (this.size - 1), var1);
        Validate.inclusiveBetween(0L, this.mask, var2);
        int var3 = this.cellIndex(var1);
        long var4 = this.data[var3];
        int var6 = (var1 - var3 * this.valuesPerLong) * this.bits;
        this.data[var3] = var4 & ~(this.mask << var6) | ((long)var2 & this.mask) << var6;
