...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/item/enchantment/Enchantments.class */
public class Enchantments {
    ...
    private static Enchantment register(String str, Enchantment enchantment) {
        return (Enchantment) Registry.register(Registry.ENCHANTMENT, str, enchantment);
    }
}
