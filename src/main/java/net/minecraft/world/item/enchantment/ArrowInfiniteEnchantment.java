...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/item/enchantment/ArrowInfiniteEnchantment.class */
public class ArrowInfiniteEnchantment extends Enchantment {
    public ArrowInfiniteEnchantment(Enchantment.Rarity rarity, EquipmentSlot... equipmentSlotArr) {
