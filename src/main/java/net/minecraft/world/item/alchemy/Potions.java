...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/item/alchemy/Potions.class */
public class Potions {
    ...
    private static Potion register(String str, Potion potion) {
        return (Potion) Registry.register(Registry.POTION, str, potion);
    }
}
