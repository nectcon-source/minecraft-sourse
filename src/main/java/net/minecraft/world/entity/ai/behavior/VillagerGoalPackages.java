...
public class VillagerGoalPackages {
   public static ImmutableList<Pair<Integer, ? extends Behavior<? super Villager>>> getCorePackage(VillagerProfession var0, float var1) {
      return ImmutableList.of(
         ...
         Pair.of(0, new ValidateNearbyPoi(var0.getJobPoiType(), MemoryModuleType.JOB_SITE)),
         Pair.of(0, new ValidateNearbyPoi(var0.getJobPoiType(), MemoryModuleType.POTENTIAL_JOB_SITE)),
         ...
         new Pair[]{
            ...
            Pair.of(6, new AcquirePoi(var0.getJobPoiType(), MemoryModuleType.JOB_SITE, MemoryModuleType.POTENTIAL_JOB_SITE, true, Optional.empty())),
         ...
         Pair.of(
            ...
            new RunOne(
               ImmutableList.of(
                  ...
                  Pair.of(new InteractWith<>(EntityType.VILLAGER, 8, AgableMob::canBreed, AgableMob::canBreed, MemoryModuleType.BREED_TARGET, var1, 2), 1),
