...
public class StartAttacking<E extends Mob> extends Behavior<E> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, E var2) {
      if (!this.canAttackPredicate.test(var2)) {
         ...
         Optional<? extends LivingEntity> var3 = (Optional)this.targetFinderFunction.apply(var2);
         return var3.isPresent() && ((LivingEntity)var3.get()).isAlive();
      }
   }

   protected void start(ServerLevel var1, E var2, long var3) {
      (this.targetFinderFunction.apply(var2)).ifPresent((var2x) -> this.setAttackTarget(var2, var2x));
   }

   private void setAttackTarget(E var1, LivingEntity var2) {
      var1.getBrain().setMemory(MemoryModuleType.ATTACK_TARGET, var2);
