...
public class HarvestFarmland extends Behavior<Villager> {
   ...
   protected void tick(ServerLevel var1, Villager var2, long var3) {
      if (this.aboveFarmlandPos == null || this.aboveFarmlandPos.closerThan(var2.position(), (double)1.0F)) {
         if (this.aboveFarmlandPos != null && var3 > this.nextOkStartTime) {
            ...
            if (var5.isAir() && var7 instanceof FarmBlock && var2.hasFarmSeeds()) {
               ...
               for(int var9 = 0; var9 < var8.getContainerSize(); ++var9) {
                  ...
                  if (var11) {
                     var1.playSound(null, (double)this.aboveFarmlandPos.getX(), (double)this.aboveFarmlandPos.getY(), this.aboveFarmlandPos.getZ(), SoundEvents.CROP_PLANTED, SoundSource.BLOCKS, 1.0F, 1.0F);
                     var10.shrink(1);
                     if (var10.isEmpty()) {
