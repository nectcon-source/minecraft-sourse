...
public class LocateHidingPlace extends Behavior<LivingEntity> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, LivingEntity var2) {
      Optional<BlockPos> var3 = var1.getPoiManager().find((var0) -> var0 == PoiType.HOME, (var0) -> true, var2.blockPosition(), this.closeEnoughDist + 1, PoiManager.Occupancy.ANY);
   ...
   protected void start(ServerLevel var1, LivingEntity var2, long var3) {
      ...
      if (!var6.isPresent()) {
         var6 = var1.getPoiManager().getRandom((var0) -> var0 == PoiType.HOME, (var0) -> true, PoiManager.Occupancy.ANY, var2.blockPosition(), this.radius, var2.getRandom());
         if (!var6.isPresent()) {
