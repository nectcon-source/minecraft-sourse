...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/ai/attributes/Attributes.class */
public class Attributes {
    ...
    private static Attribute register(String str, Attribute attribute) {
        return (Attribute) Registry.register(Registry.ATTRIBUTE, str, attribute);
    }
}
