...
public class BackUpIfTooClose<E extends Mob> extends Behavior<E> {
   ...
   protected void start(ServerLevel var1, E var2, long var3) {
      var2.getBrain().setMemory(MemoryModuleType.LOOK_TARGET, new EntityTracker(this.getTarget(var2), true));
   ...
   private boolean isTargetVisible(E var1) {
      return (var1.getBrain().getMemory(MemoryModuleType.VISIBLE_LIVING_ENTITIES).get()).contains(this.getTarget(var1));
   }
