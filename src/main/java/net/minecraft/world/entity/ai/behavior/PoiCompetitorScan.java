...
public class PoiCompetitorScan extends Behavior<Villager> {
   ...
   protected void start(ServerLevel var1, Villager var2, long var3) {
      ...
      var1.getPoiManager().getType(var5.pos()).ifPresent((var3x) -> BehaviorUtils.getNearbyVillagersWithCondition(var2, (var3_) -> this.competesForSameJobsite(var5, var3x, var3_)).reduce(var2, PoiCompetitorScan::selectWinner));
   }
