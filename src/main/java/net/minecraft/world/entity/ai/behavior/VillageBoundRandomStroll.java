...
public class VillageBoundRandomStroll extends Behavior<PathfinderMob> {
   ...
   private void setTargetedPos(PathfinderMob var1, SectionPos var2) {
      Optional<Vec3> var3 = Optional.ofNullable(RandomPos.getPosTowards(var1, this.maxXyDist, this.maxYDist, Vec3.atBottomCenterOf(var2.center())));
   ...
   private void setRandomPos(PathfinderMob var1) {
      Optional<Vec3> var2 = Optional.ofNullable(RandomPos.getLandPos(var1, this.maxXyDist, this.maxYDist));
