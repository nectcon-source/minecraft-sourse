...
public class YieldJobSite extends Behavior<Villager> {
   ...
   protected void start(ServerLevel var1, Villager var2, long var3) {
      ...
      Optional<PoiType> var6 = var1.getPoiManager().getType(var5);
      if (var6.isPresent()) {
         BehaviorUtils.getNearbyVillagersWithCondition(var2, (var3x) -> this.nearbyWantsJobsite((PoiType)var6.get(), var3x, var5)).findFirst().ifPresent((var4) -> this.yieldJobSite(var1, var2, var4, var5, var4.getBrain().getMemory(MemoryModuleType.JOB_SITE).isPresent()));
      }
   }
   ...
   private boolean nearbyWantsJobsite(PoiType var1, Villager var2, BlockPos var3) {
      ...
      if (var4) {
         ...
         Optional<GlobalPos> var5 = var2.getBrain().getMemory(MemoryModuleType.JOB_SITE);
