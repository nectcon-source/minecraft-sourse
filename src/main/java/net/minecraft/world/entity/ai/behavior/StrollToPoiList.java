...
public class StrollToPoiList extends Behavior<Villager> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, Villager var2) {
      Optional<List<GlobalPos>> var3 = var2.getBrain().getMemory(this.strollToMemoryType);
      Optional<GlobalPos> var4 = var2.getBrain().getMemory(this.mustBeCloseToMemoryType);
