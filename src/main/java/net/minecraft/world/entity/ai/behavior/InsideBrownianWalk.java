...
public class InsideBrownianWalk extends Behavior<PathfinderMob> {
   ...
   protected void start(ServerLevel var1, PathfinderMob var2, long var3) {
      ...
      Optional<BlockPos> var7 = var6.stream().filter((var1x) -> !var1.canSeeSky(var1x)).filter((var2x) -> var1.loadedAndEntityCanStandOn(var2x, var2)).filter((var2x) -> var1.noCollision(var2)).findFirst();
