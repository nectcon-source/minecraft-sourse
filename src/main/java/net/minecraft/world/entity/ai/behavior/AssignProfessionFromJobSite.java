...
public class AssignProfessionFromJobSite extends Behavior<Villager> {
   ...
   protected boolean checkExtraStartConditions(ServerLevel var1, Villager var2) {
      ...
      return var3.closerThan(var2.position(), (double)2.0F) || var2.assignProfessionWhenSpawned();
   }
   ...
   protected void start(ServerLevel var1, Villager var2, long var3) {
      ...
      if (var2.getVillagerData().getProfession() == VillagerProfession.NONE) {
         ...
         Optional.ofNullable(var6.getLevel(var5.dimension())).flatMap((var1x) -> var1x.getPoiManager().getType(var5.pos())).flatMap((var0) -> Registry.VILLAGER_PROFESSION.stream().filter((var1_) -> var1_.getJobPoiType() == var0).findFirst()).ifPresent((var2x) -> {
