...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/ai/sensing/SensorType.class */
public class SensorType<U extends Sensor<?>> {
    ...
    private static <U extends Sensor<?>> SensorType<U> register(String str, Supplier<U> supplier) {
        return (SensorType) Registry.register(Registry.SENSOR_TYPE, new ResourceLocation(str), new SensorType(supplier));
    }
}
