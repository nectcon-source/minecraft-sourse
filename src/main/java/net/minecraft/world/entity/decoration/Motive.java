...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/decoration/Motive.class */
public class Motive {
    ...
    private static Motive register(String str, int i, int i2) {
        return (Motive) Registry.register(Registry.MOTIVE, str, new Motive(i, i2));
    }

    public Motive(int i, int i2) {
        this.width = i;
        this.height = i2;
    }
