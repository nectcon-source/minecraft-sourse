...
public class VillagerTrades {
    ...
    /* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerTrades$EmeraldForItems.class */
    ...
    /* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerTrades$EmeraldsForVillagerTypeItem.class */
    static class EmeraldsForVillagerTypeItem implements ItemListing {
        ...
        public EmeraldsForVillagerTypeItem(int i, int i2, int i3, Map<VillagerType, Item> map) {
            Registry.VILLAGER_TYPE.stream().filter(villagerType -> {
                ...
                throw new IllegalStateException("Missing trade for villager type: " + Registry.VILLAGER_TYPE.getKey(villagerType2));
            });
            this.trades = map;
            this.cost = i;
            this.maxUses = i2;
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            if (entity instanceof VillagerDataHolder) {
                return new MerchantOffer(new ItemStack(this.trades.get(((VillagerDataHolder) entity).getVillagerData().getType()), this.cost), new ItemStack(Items.EMERALD), this.maxUses, this.villagerXp, 0.05f);
            }
            return null;
        }
    }

    /* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerTrades$ItemsForEmeralds.class */
    ...
    /* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerTrades$SuspisciousStewForEmerald.class */
    static class SuspisciousStewForEmerald implements ItemListing {
        ...
        public SuspisciousStewForEmerald(MobEffect mobEffect, int i, int i2) {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            ...
            return new MerchantOffer(new ItemStack(Items.EMERALD, 1), itemStack, 12, this.f451xp, this.priceMultiplier);
        }
    }

    /* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerTrades$EnchantedItemForEmeralds.class */
    static class EnchantedItemForEmeralds implements ItemListing {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            ...
            return new MerchantOffer(new ItemStack(Items.EMERALD, Math.min(this.baseEmeraldCost + nextInt, 64)), EnchantmentHelper.enchantItem(random, new ItemStack(this.itemStack.getItem()), nextInt, false), this.maxUses, this.villagerXp, this.priceMultiplier);
        }
    }

    /* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerTrades$TippedArrowForItemsAndEmeralds.class */
    static class TippedArrowForItemsAndEmeralds implements ItemListing {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            ...
            return new MerchantOffer(itemStack, new ItemStack(this.fromItem, this.fromCount), PotionUtils.setPotion(new ItemStack(this.toItem.getItem(), this.toCount), list.get(random.nextInt(list.size()))), this.maxUses, this.villagerXp, this.priceMultiplier);
        }
    }

    /* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerTrades$DyedArmorForEmeralds.class */
    ...
    /* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerTrades$EnchantBookForEmeralds.class */
    static class EnchantBookForEmeralds implements ItemListing {
        ...
        @Override // net.minecraft.world.entity.npc.VillagerTrades.ItemListing
        public MerchantOffer getOffer(Entity entity, Random random) {
            List<Enchantment> list = (List) Registry.ENCHANTMENT.stream().filter((v0) -> {
            ...
            return new MerchantOffer(new ItemStack(Items.EMERALD, nextInt2), new ItemStack(Items.BOOK), createForEnchantment, 12, this.villagerXp, 0.2f);
        }
    }

    /* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerTrades$TreasureMapForEmeralds.class */
    static class TreasureMapForEmeralds implements ItemListing {
        ...
        public MerchantOffer getOffer(Entity entity, Random random) {
            ...
            if ((entity.level instanceof ServerLevel) && (findNearestMapFeature = (serverLevel = (ServerLevel) entity.level).findNearestMapFeature(this.destination, entity.blockPosition(), 100, true)) != null) {
                ItemStack create = MapItem.create(serverLevel, findNearestMapFeature.getX(), findNearestMapFeature.getZ(), (byte) 2, true, true);
                MapItem.renderBiomePreviewMap(serverLevel, create);
                MapItemSavedData.addTargetDecoration(create, findNearestMapFeature, "+", this.destinationType);
                create.setHoverName(new TranslatableComponent("filled_map." + this.destination.getFeatureName().toLowerCase(Locale.ROOT)));
                return new MerchantOffer(new ItemStack(Items.EMERALD, this.emeraldCost), new ItemStack(Items.COMPASS), create, this.maxUses, this.villagerXp, 0.2f);
            }
            return null;
        }
    }

    /* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerTrades$ItemsAndEmeraldsToItems.class */
