...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/entity/npc/VillagerProfession.class */
public class VillagerProfession {
    ...
    private VillagerProfession(String str, PoiType poiType, ImmutableSet<Item> immutableSet, ImmutableSet<Block> immutableSet2, @Nullable SoundEvent soundEvent) {
        this.name = str;
    ...
    static VillagerProfession register(String str, PoiType poiType, @Nullable SoundEvent soundEvent) {
        return register(str, poiType, ImmutableSet.of(), ImmutableSet.of(), soundEvent);
    }

    static VillagerProfession register(String str, PoiType poiType, ImmutableSet<Item> immutableSet, ImmutableSet<Block> immutableSet2, @Nullable SoundEvent soundEvent) {
        return (VillagerProfession) Registry.register(Registry.VILLAGER_PROFESSION, new ResourceLocation(str), new VillagerProfession(str, poiType, immutableSet, immutableSet2, soundEvent));
    }
}
