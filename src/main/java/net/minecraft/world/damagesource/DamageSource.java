...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/damagesource/DamageSource.class */
public class DamageSource {
    ...
    public Component getLocalizedDeathMessage(LivingEntity livingEntity) {
        ...
        if (killCredit != null) {
            return new TranslatableComponent(str2, livingEntity.getDisplayName(), killCredit.getDisplayName());
        }
        return new TranslatableComponent(str, livingEntity.getDisplayName());
    }
