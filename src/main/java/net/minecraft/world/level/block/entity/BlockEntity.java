...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/block/entity/BlockEntity.class */
public abstract class BlockEntity {
    ...
    public CompoundTag save(CompoundTag compoundTag) {
        return saveMetadata(compoundTag);
    }
    ...
    public CompoundTag getUpdateTag() {
        return saveMetadata(new CompoundTag());
    }
