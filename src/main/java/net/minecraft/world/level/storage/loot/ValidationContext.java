...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/storage/loot/ValidationContext.class */
public class ValidationContext {
    ...
    public ValidationContext enterTable(String str, ResourceLocation resourceLocation) {
        return new ValidationContext(this.problems, () -> {
            return getContext() + str;
        }, this.params, this.conditionResolver, this.visitedConditions, this.tableResolver, ImmutableSet.<ResourceLocation>builder().addAll(this.visitedTables).add(resourceLocation).build());
    }

    public ValidationContext enterCondition(String str, ResourceLocation resourceLocation) {
        return new ValidationContext(this.problems, () -> {
            return getContext() + str;
        }, this.params, this.conditionResolver, ImmutableSet.<ResourceLocation>builder().addAll(this.visitedConditions).add(resourceLocation).build(), this.tableResolver, this.visitedTables);
    }
