...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/storage/loot/functions/LootItemFunctions.class */
public class LootItemFunctions {
    ...
    private static LootItemFunctionType register(String str, Serializer<? extends LootItemFunction> serializer) {
        return (LootItemFunctionType) Registry.register(Registry.LOOT_FUNCTION_TYPE, new ResourceLocation(str), new LootItemFunctionType(serializer));
    }

    public static Object createGsonAdapter() {
        return GsonAdapterFactory.builder(Registry.LOOT_FUNCTION_TYPE, "function", "function", (v0) -> {
            return v0.getType();
        }).build();
    }

    public static BiFunction<ItemStack, LootContext, ItemStack> compose(BiFunction<ItemStack, LootContext, ItemStack>[] biFunctionArr) {
