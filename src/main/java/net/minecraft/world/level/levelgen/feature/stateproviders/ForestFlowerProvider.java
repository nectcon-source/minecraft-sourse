...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/levelgen/feature/stateproviders/ForestFlowerProvider.class */
public class ForestFlowerProvider extends BlockStateProvider {
    ...
    public BlockState getState(Random random, BlockPos blockPos) {
        return FLOWERS[(int) (Mth.clamp((1.0d + Biome.BIOME_INFO_NOISE.getValue(blockPos.getX() / 48.0d, blockPos.getZ() / 48.0d, false)) / 2.0d, 0.0d, 0.9999d) * FLOWERS.length)];
    }
}
