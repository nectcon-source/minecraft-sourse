...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/levelgen/feature/DesertPyramidFeature.class */
public class DesertPyramidFeature extends StructureFeature<NoneFeatureConfiguration> {
    ...
    /* loaded from: client_deobf_norm.jar:net/minecraft/world/level/levelgen/feature/DesertPyramidFeature$FeatureStart.class */
    public static class FeatureStart extends StructureStart<NoneFeatureConfiguration> {
        ...
        public void generatePieces(RegistryAccess registryAccess, ChunkGenerator chunkGenerator, StructureManager structureManager, int i, int i2, Biome biome, NoneFeatureConfiguration noneFeatureConfiguration) {
            this.pieces.add(new DesertPyramidPiece(this.random, i * 16, i2 * 16));
