...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/levelgen/structure/templatesystem/StructurePlaceSettings.class */
public class StructurePlaceSettings {
    ...
    public StructurePlaceSettings setKnownShape(boolean z) {
        this.knownShape = z;
        return this;
    }
    ...
    private BoundingBox calculateBoundingBox(@Nullable ChunkPos chunkPos) {
        ...
        return new BoundingBox(i, 0, i2, (i + 16) - 1, 255, (i2 + 16) - 1);
    }

    public StructurePlaceSettings setFinalizeEntities(boolean z) {
