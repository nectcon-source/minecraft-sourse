...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/levelgen/surfacebuilders/SurfaceBuilder.class */
public abstract class SurfaceBuilder<C extends SurfaceBuilderConfiguration> {
    ...
    public abstract void apply(Random random, ChunkAccess chunkAccess, Biome biome, int i, int i2, int i3, double d, BlockState blockState, BlockState blockState2, int i4, long j, C c);

    private static <C extends SurfaceBuilderConfiguration, F extends SurfaceBuilder<C>> F register(String str, F f) {
        return (F) Registry.register(Registry.SURFACE_BUILDER, str, f);
    }
