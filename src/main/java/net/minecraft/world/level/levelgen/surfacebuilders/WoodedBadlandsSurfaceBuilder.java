...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/levelgen/surfacebuilders/WoodedBadlandsSurfaceBuilder.class */
                ...
                if (blockState6.isAir()) {
                    ...
                    if (i7 == -1) {
                        ...
                        if (i9 >= i4 - 1) {
                            ...
                            if (blockState5 == WHITE_TERRACOTTA) {
