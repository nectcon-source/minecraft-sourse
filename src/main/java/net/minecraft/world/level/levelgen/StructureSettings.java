...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/levelgen/StructureSettings.class */
public class StructureSettings {
    public static final Codec<StructureSettings> CODEC = RecordCodecBuilder.create(instance -> {
        ...
        }), Codec.simpleMap(Registry.STRUCTURE_FEATURE, StructureFeatureConfiguration.CODEC, Registry.STRUCTURE_FEATURE).fieldOf("structures").forGetter(structureSettings2 -> {
            return structureSettings2.structureConfig;
    ...
    public static final ImmutableMap<StructureFeature<?>, StructureFeatureConfiguration> DEFAULTS = ImmutableMap.<StructureFeature<?>, StructureFeatureConfiguration>builder()
            ...
            .put(StructureFeature.NETHER_FOSSIL, new StructureFeatureConfiguration(2, 1, 14357921)).build();
    ...
    static {
        Iterator it = Registry.STRUCTURE_FEATURE.iterator();
        while (it.hasNext()) {
            StructureFeature<?> structureFeature = (StructureFeature) it.next();
    ...
    public StructureSettings(boolean z) {
