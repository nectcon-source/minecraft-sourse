...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/levelgen/feature/StructurePieceType.class */
public interface StructurePieceType {
    ...
    static StructurePieceType setPieceId(StructurePieceType structurePieceType, String str) {
        return (StructurePieceType) Registry.register(Registry.STRUCTURE_PIECE, str.toLowerCase(Locale.ROOT), structurePieceType);
    }
}
