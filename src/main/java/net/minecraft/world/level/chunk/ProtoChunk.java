...
public class ProtoChunk implements ChunkAccess {
    ...
    public ProtoChunk(ChunkPos var1, UpgradeData var2) {
        this(var1, var2, null, new ProtoTickList<>((var0) -> var0 == null || var0.defaultBlockState().isAir(), var1), new ProtoTickList((var0) -> var0 == null || var0 == Fluids.EMPTY, var1));
    }
    ...
    public BlockState setBlockState(BlockPos var1, BlockState var2, boolean var3) {
        ...
        if (var5 >= 0 && var5 < 256) {
            if (this.sections[var5 >> 4] == LevelChunk.EMPTY_SECTION && var2.is(Blocks.AIR)) {
                ...
                EnumSet<Heightmap.Types> var14 = this.getStatus().heightmapsAfter();
                EnumSet<Heightmap.Types> var10 = null;

                for(Heightmap.Types var12 : var14) {
                ...
                for(Heightmap.Types var16 : var14) {
                    ((Heightmap)this.heightmaps.get(var16)).update(var4 & 15, var5, var6 & 15, var2);
                }
    ...
    public Set<BlockPos> getBlockEntitiesPos() {
        Set<BlockPos> var1 = Sets.newHashSet(this.blockEntityNbts.keySet());
    ...
    public LongSet getReferencesForFeature(StructureFeature<?> var1) {
        return (LongSet)this.structuresRefences.computeIfAbsent(var1, (var0) -> new LongOpenHashSet());
    }
    ...
    public BitSet getOrCreateCarvingMask(GenerationStep.Carving var1) {
        return (BitSet)this.carvingMasks.computeIfAbsent(var1, (var0) -> new BitSet(65536));
    }
