...
public class PalettedContainer<T> implements PaletteResize<T> {
    ...
    public void acquire() {
        if (this.lock.isLocked() && !this.lock.isHeldByCurrentThread()) {
            ...
            var3.setDetail("Thread dumps", var1);
    ...
    public int onResize(int var1, T var2) {
        ...
        for(int var5 = 0; var5 < var3.getSize(); ++var5) {
            T var6 = (T)var4.valueFor(var3.get(var5));
            if (var6 != null) {
                this.set(var5, var6);
            }
        }

        int var7 = this.palette.idFor(var2);
        this.release();
        return var7;
    }
    ...
    public T getAndSet(int var1, int var2, int var3, T var4) {
        this.acquire();
        T var5 = (T)this.getAndSet(getIndex(var1, var2, var3), var4);
        this.release();
        return var5;
    }

    public T getAndSetUnchecked(int var1, int var2, int var3, T var4) {
        return (T)this.getAndSet(getIndex(var1, var2, var3), var4);
    }

    protected T getAndSet(int var1, T var2) {
        int var3 = this.palette.idFor(var2);
        int var4 = this.storage.getAndSet(var1, var3);
        T var5 = (T)this.palette.valueFor(var4);
        return (T)(var5 == null ? this.defaultValue : var5);
    }
    ...
    public T get(int var1, int var2, int var3) {
        return (T)this.get(getIndex(var1, var2, var3));
    }

    protected T get(int var1) {
        T var2 = (T)this.palette.valueFor(this.storage.get(var1));
    ...
    public void read(ListTag var1, long[] var2) {
        ...
        if (this.palette == this.globalPalette) {
            Palette<T> var5 = new HashMapPalette(this.registry, var3, this.dummyPaletteResize, this.reader, this.writer);
            var5.read(var1);
    ...
    public void count(CountConsumer<T> var1) {
        ...
        this.storage.getAll((var1x) -> var2.put(var1x, var2.get(var1x) + 1));
        var2.int2IntEntrySet().forEach((var2x) -> var1.accept(this.palette.valueFor(var2x.getIntKey()), var2x.getIntValue()));
    }
