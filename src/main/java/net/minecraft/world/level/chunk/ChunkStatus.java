...
public class ChunkStatus {
    ...
    private static ChunkStatus register(String var0, @Nullable ChunkStatus var1, int var2, EnumSet<Heightmap.Types> var3, ChunkType var4, GenerationTask var5, LoadingTask var6) {
        return (ChunkStatus)Registry.register(Registry.CHUNK_STATUS, var0, new ChunkStatus(var0, var1, var2, var3, var4, var5, var6));
    }
    ...
    static {
        ...
        BIOMES = registerSimple("biomes", STRUCTURE_REFERENCES, 0, PRE_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3) -> var1.createBiomes(var0.registryAccess().registryOrThrow(Registry.BIOME_REGISTRY), var3));
        ...
        SURFACE = registerSimple("surface", NOISE, 0, PRE_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3) -> var1.buildSurfaceAndBedrock(new WorldGenRegion(var0, var2), var3));
        CARVERS = registerSimple("carvers", SURFACE, 0, PRE_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3) -> var1.applyCarvers(var0.getSeed(), var0.getBiomeManager(), var3, Carving.AIR));
        LIQUID_CARVERS = registerSimple("liquid_carvers", CARVERS, 0, POST_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3) -> var1.applyCarvers(var0.getSeed(), var0.getBiomeManager(), var3, Carving.LIQUID));
        FEATURES = register("features", LIQUID_CARVERS, 8, POST_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3, var4, var5, var6, var7) -> {
            ...
            if (!var7.getStatus().isOrAfter(var0)) {
                Heightmap.primeHeightmaps(var7, EnumSet.of(Types.MOTION_BLOCKING, Types.MOTION_BLOCKING_NO_LEAVES, Types.OCEAN_FLOOR, Types.WORLD_SURFACE));
        ...
        LIGHT = register("light", FEATURES, 1, POST_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3, var4, var5, var6, var7) -> lightChunk(var0, var4, var7), (var0, var1, var2, var3, var4, var5) -> lightChunk(var0, var3, var5));
        SPAWN = registerSimple("spawn", LIGHT, 0, POST_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3) -> var1.spawnOriginalMobs(new WorldGenRegion(var0, var2)));
        HEIGHTMAPS = registerSimple("heightmaps", SPAWN, 0, POST_FEATURES, ChunkStatus.ChunkType.PROTOCHUNK, (var0, var1, var2, var3) -> {
        });
        FULL = register("full", HEIGHTMAPS, 0, POST_FEATURES, ChunkStatus.ChunkType.LEVELCHUNK, (var0, var1, var2, var3, var4, var5, var6, var7) -> (CompletableFuture)var5.apply(var7), (var0, var1, var2, var3, var4, var5) -> (CompletableFuture)var4.apply(var5));
