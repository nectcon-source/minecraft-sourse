...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/material/MaterialColor.class */
public class MaterialColor {
    ...
    private MaterialColor(int i, int i2) {
        if (i < 0 || i > 63) {
    ...
    public int calculateRGBColor(int i) {
        ...
        return (-16777216) | ((((this.col & 255) * i2) / 255) << 16) | (((((this.col >> 8) & 255) * i2) / 255) << 8) | ((((this.col >> 16) & 255) * i2) / 255);
    }
}
