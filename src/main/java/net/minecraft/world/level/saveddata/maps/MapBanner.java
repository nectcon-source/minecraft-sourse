...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/saveddata/maps/MapBanner.class */
public class MapBanner {
    ...
    public static MapBanner load(CompoundTag compoundTag) {
        return new MapBanner(NbtUtils.readBlockPos(compoundTag.getCompound("Pos")), DyeColor.byName(compoundTag.getString("Color"), DyeColor.WHITE), compoundTag.contains("Name") ? Component.Serializer.fromJson(compoundTag.getString("Name")) : null);
    }
    ...
    public static MapBanner fromWorld(BlockGetter blockGetter, BlockPos blockPos) {
        ...
        if (blockEntity instanceof BannerBlockEntity) {
            ...
            return new MapBanner(blockPos, bannerBlockEntity.getBaseColor(() -> {
                return blockGetter.getBlockState(blockPos);
            }), bannerBlockEntity.hasCustomName() ? bannerBlockEntity.getCustomName() : null);
        }
        return null;
    }
