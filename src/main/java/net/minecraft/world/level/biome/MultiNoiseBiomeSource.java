...
//                  .listOf()
//                  .fieldOf("biomes")
//                  .forGetter(var0x -> Collections.singletonList(var0x.parameters)),
...
//   );
    public static final MapCodec<MultiNoiseBiomeSource> DIRECT_CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                    ...
                    ).listOf().fieldOf("biomes").forGetter(source -> source.parameters),
                    MultiNoiseBiomeSource.NoiseParameters.CODEC.fieldOf("temperature_noise").forGetter(source -> source.temperatureParams),
                    MultiNoiseBiomeSource.NoiseParameters.CODEC.fieldOf("humidity_noise").forGetter(source -> source.humidityParams),
                    MultiNoiseBiomeSource.NoiseParameters.CODEC.fieldOf("altitude_noise").forGetter(source -> source.altitudeParams),
                    MultiNoiseBiomeSource.NoiseParameters.CODEC.fieldOf("weirdness_noise").forGetter(source -> source.weirdnessParams)
    ...
    private Optional<MultiNoiseBiomeSource.PresetInstance> preset() {
        return this.preset
                .map(var1 -> new MultiNoiseBiomeSource.PresetInstance((MultiNoiseBiomeSource.Preset)var1.getSecond(), (Registry)var1.getFirst(), this.seed));
    }

    @Override
    public Biome getNoiseBiome(int var1, int var2, int var3) {
        int var4 = this.useY ? var2 : 0;
        Biome.ClimateParameters var5x = new Biome.ClimateParameters(
                (float)this.temperatureNoise.getValue((double)var1, (double)var4, (double)var3),
                (float)this.humidityNoise.getValue((double)var1, (double)var4, (double)var3),
                (float)this.altitudeNoise.getValue((double)var1, (double)var4, (double)var3),
                (float)this.weirdnessNoise.getValue((double)var1, (double)var4, (double)var3),
                0.0F
        );
        return this.parameters
                .stream()
                .min(Comparator.comparing(var1x -> ((Biome.ClimateParameters)var1x.getFirst()).fitness(var5x)))
                .map(Pair::getSecond)
                .map(Supplier::get)
    ...
    public static class Preset {
        ...
        public static final MultiNoiseBiomeSource.Preset NETHER = new MultiNoiseBiomeSource.Preset(
                ...
                (var0, var1, var2) -> new MultiNoiseBiomeSource(
                        var2,
                        ImmutableList.of(
                                Pair.of(new Biome.ClimateParameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier<Biome>)() -> var1.getOrThrow(Biomes.NETHER_WASTES)),
                                Pair.of(new Biome.ClimateParameters(0.0F, -0.5F, 0.0F, 0.0F, 0.0F), (Supplier<Biome>)() -> var1.getOrThrow(Biomes.SOUL_SAND_VALLEY)),
                                Pair.of(new Biome.ClimateParameters(0.4F, 0.0F, 0.0F, 0.0F, 0.0F), (Supplier<Biome>)() -> var1.getOrThrow(Biomes.CRIMSON_FOREST)),
                                Pair.of(new Biome.ClimateParameters(0.0F, 0.5F, 0.0F, 0.0F, 0.375F), (Supplier<Biome>)() -> var1.getOrThrow(Biomes.WARPED_FOREST)),
                                Pair.of(new Biome.ClimateParameters(-0.5F, 0.0F, 0.0F, 0.0F, 0.175F), (Supplier<Biome>)() -> var1.getOrThrow(Biomes.BASALT_DELTAS))
                        ),
        ...
        public MultiNoiseBiomeSource biomeSource(Registry<Biome> var1, long var2) {
            return this.biomeSource.apply(this, var1, var2);
        }
    }
        ...
        public static final MapCodec<MultiNoiseBiomeSource.PresetInstance> CODEC = RecordCodecBuilder.mapCodec(
                var0 -> var0.group(
                                ResourceLocation.CODEC
                                        .flatXmap(
                                                var0x -> Optional.ofNullable(MultiNoiseBiomeSource.Preset.BY_NAME.get(var0x))
