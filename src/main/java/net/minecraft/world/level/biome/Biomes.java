...
/* loaded from: client_deobf_norm.jar:net/minecraft/world/level/biome/Biomes.class */
public abstract class Biomes {
    ...
    private static ResourceKey<Biome> register(String str) {
        return ResourceKey.create(Registry.BIOME_REGISTRY, new ResourceLocation(str));
    }
}
