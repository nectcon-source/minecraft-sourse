...
public class SkyLightSectionStorage extends LayerLightSectionStorage<SkyLightSectionStorage.SkyDataLayerStorageMap> {
    ...
    protected SkyLightSectionStorage(LightChunkGetter var1) {
        super(LightLayer.SKY, var1, new SkyDataLayerStorageMap(new Long2ObjectOpenHashMap(), new Long2IntOpenHashMap(), Integer.MAX_VALUE));
    }

    protected int getLightValue(long var1) {
        long var3 = SectionPos.blockToSection(var1);
        int var5 = SectionPos.y(var3);
        SkyDataLayerStorageMap var6 = this.visibleSectionData;
    ...
    protected DataLayer createDataLayer(long var1) {
        DataLayer var3 = this.queuedSections.get(var1);
        if (var3 != null) {
            return var3;
        } else {
                        ...
                        if (var7 == 1) {
                            ...
                            for(int var31 = 0; var31 < 16; ++var31) {
                                for(int var32 = 0; var32 < 16; ++var32) {
                                    long var33 = BlockPos.asLong(SectionPos.sectionToBlockCoord(SectionPos.x(var5)) + var31, SectionPos.sectionToBlockCoord(SectionPos.y(var5)), SectionPos.sectionToBlockCoord(SectionPos.z(var5)) + var32);
                                    long var34 = BlockPos.asLong(SectionPos.sectionToBlockCoord(SectionPos.x(var5)) + var31, SectionPos.sectionToBlockCoord(SectionPos.y(var5)) - 1, SectionPos.sectionToBlockCoord(SectionPos.z(var5)) + var32);
                    ...
                    if (this.sectionsWithSources.remove(var24) && this.storingLightForSection(var24)) {
                        for(int var25 = 0; var25 < 16; ++var25) {
                            for(int var27 = 0; var27 < 16; ++var27) {
                                long var29 = BlockPos.asLong(SectionPos.sectionToBlockCoord(SectionPos.x(var24)) + var25, SectionPos.sectionToBlockCoord(SectionPos.y(var24)) + 16 - 1, SectionPos.sectionToBlockCoord(SectionPos.z(var24)) + var27);
                                var1.checkEdge(Long.MAX_VALUE, var29, 15, false);
                            }
                        }
                    }
                }
    ...
    protected boolean hasLightSource(long var1) {
        ...
        if ((var3 & 15) != 15) {
            ...
            if (!this.columnsWithSkySources.contains(var6)) {
                ...
                int var8 = this.updatingSectionData.topSections.get(var6);
