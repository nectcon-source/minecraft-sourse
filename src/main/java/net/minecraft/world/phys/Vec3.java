...
public class Vec3 implements Position {
    ...
    public static Vec3 fromRGB24(int var0) {
        double var1 = (double)(var0 >> 16 & 255) / (double)255.0F;
        double var3 = (double)(var0 >> 8 & 255) / (double)255.0F;
        double var5 = (double)(var0 & 255) / (double)255.0F;
        return new Vec3(var1, var3, var5);
    }

    public static Vec3 atCenterOf(Vec3i var0) {
        return new Vec3((double)var0.getX() + (double)0.5F, (double)var0.getY() + (double)0.5F, (double)var0.getZ() + (double)0.5F);
    }
    ...
    public static Vec3 atBottomCenterOf(Vec3i var0) {
        return new Vec3((double)var0.getX() + (double)0.5F, var0.getY(), (double)var0.getZ() + (double)0.5F);
    }

    public static Vec3 upFromBottomCenterOf(Vec3i var0, double var1) {
        return new Vec3((double)var0.getX() + (double)0.5F, (double)var0.getY() + var1, (double)var0.getZ() + (double)0.5F);
    }
    ...
    public Vec3 normalize() {
        double var1 = Mth.sqrt(this.x * this.x + this.y * this.y + this.z * this.z);
    ...
    public static Vec3 directionFromRotation(float var0, float var1) {
        float var2 = Mth.cos(-var1 * ((float)Math.PI / 180F) - (float)Math.PI);
        float var3 = Mth.sin(-var1 * ((float)Math.PI / 180F) - (float)Math.PI);
        float var4 = -Mth.cos(-var0 * ((float)Math.PI / 180F));
        float var5 = Mth.sin(-var0 * ((float)Math.PI / 180F));
        return new Vec3((var3 * var4), var5, (var2 * var4));
    }

    public Vec3 align(EnumSet<Direction.Axis> var1) {
        double var2 = var1.contains(Axis.X) ? (double)Mth.floor(this.x) : this.x;
        double var4 = var1.contains(Axis.Y) ? (double)Mth.floor(this.y) : this.y;
        double var6 = var1.contains(Axis.Z) ? (double)Mth.floor(this.z) : this.z;
