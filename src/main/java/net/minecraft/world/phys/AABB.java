...
public class AABB {
    ...
    public static AABB unitCubeFromLowerCorner(Vec3 var0) {
        return new AABB(var0.x, var0.y, var0.z, var0.x + (double)1.0F, var0.y + (double)1.0F, var0.z + (double)1.0F);
    }
    ...
    public Optional<Vec3> clip(Vec3 var1, Vec3 var2) {
        double[] var3 = new double[]{(double)1.0F};
    ...
    public static BlockHitResult clip(Iterable<AABB> var0, Vec3 var1, Vec3 var2, BlockPos var3) {
        double[] var4 = new double[]{(double)1.0F};
        Direction var5 = null;
    ...
    private static Direction clipPoint(double[] var0, @Nullable Direction var1, double var2, double var4, double var6, double var8, double var10, double var12, double var14, double var16, Direction var18, double var19, double var21, double var23) {
        ...
        if ((double)0.0F < var25 && var25 < var0[0] && var10 - 1.0E-7 < var27 && var27 < var12 + 1.0E-7 && var14 - 1.0E-7 < var29 && var29 < var16 + 1.0E-7) {
            var0[0] = var25;
            return var18;
        } else {
            return var1;
    ...
    public static AABB ofSize(double var0, double var2, double var4) {
        return new AABB(-var0 / (double)2.0F, -var2 / (double)2.0F, -var4 / (double)2.0F, var0 / (double)2.0F, var2 / (double)2.0F, var4 / (double)2.0F);
    }
}
