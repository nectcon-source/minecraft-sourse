...
public final class BitSetDiscreteVoxelShape extends DiscreteVoxelShape {
    ...
    public BitSetDiscreteVoxelShape(DiscreteVoxelShape var1) {
        ...
        this.xMin = var1.firstFull(Axis.X);
        this.yMin = var1.firstFull(Axis.Y);
        this.zMin = var1.firstFull(Axis.Z);
        this.xMax = var1.lastFull(Axis.X);
        this.yMax = var1.lastFull(Axis.Y);
        this.zMax = var1.lastFull(Axis.Z);
    }
