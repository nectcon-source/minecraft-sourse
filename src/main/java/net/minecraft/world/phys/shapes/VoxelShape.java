...
public abstract class VoxelShape {
    ...
    public VoxelShape move(double var1, double var3, double var5) {
        return (VoxelShape)(this.isEmpty() ? Shapes.empty() : new ArrayVoxelShape(this.shape, new OffsetDoubleList(this.getCoords(Axis.X), var1), new OffsetDoubleList(this.getCoords(Axis.Y), var3), new OffsetDoubleList(this.getCoords(Axis.Z), var5)));
    }
    ...
    public void forAllEdges(Shapes.DoubleLineConsumer var1) {
        this.shape.forAllEdges((var2, var3, var4, var5, var6, var7) -> var1.consume(this.get(Axis.X, var2), this.get(Axis.Y, var3), this.get(Axis.Z, var4), this.get(Axis.X, var5), this.get(Axis.Y, var6), this.get(Axis.Z, var7)), true);
    }

    public void forAllBoxes(Shapes.DoubleLineConsumer var1) {
        DoubleList var2 = this.getCoords(Axis.X);
        DoubleList var3 = this.getCoords(Axis.Y);
        DoubleList var4 = this.getCoords(Axis.Z);
    ...
    public List<AABB> toAabbs() {
        List<AABB> var1 = Lists.newArrayList();
    ...
    protected boolean isFullWide(double var1, double var3, double var5) {
        return this.shape.isFullWide(this.findIndex(Axis.X, var1), this.findIndex(Axis.Y, var3), this.findIndex(Axis.Z, var5));
    }
    ...
    private VoxelShape calculateFace(Direction var1) {
        ...
        if (var4.size() == 2 && DoubleMath.fuzzyEquals(var4.getDouble(0), (double)0.0F, 1.0E-7) && DoubleMath.fuzzyEquals(var4.getDouble(1), (double)1.0F, 1.0E-7)) {
            return this;
        } else {
            int var5 = this.findIndex(var2, var3 == AxisDirection.POSITIVE ? 0.9999999 : 1.0E-7);
            return new SliceShape(this, var2, var5);
        }
    }

    public double collide(Direction.Axis var1, AABB var2, double var3) {
        return this.collideX(AxisCycle.between(var1, Axis.X), var2, var3);
    }
    ...
    protected double collideX(AxisCycle var1, AABB var2, double var3) {
        if (this.isEmpty()) {
            ...
            Direction.Axis var6 = var5.cycle(Axis.X);
            Direction.Axis var7 = var5.cycle(Axis.Y);
            Direction.Axis var8 = var5.cycle(Axis.Z);
