...
public final class Shapes {
    ...
    public static VoxelShape create(AABB var0) {
        ...
        if (var1 >= 0 && var2 >= 0 && var3 >= 0) {
            if (var1 == 0 && var2 == 0 && var3 == 0) {
                return var0.contains((double)0.5F, (double)0.5F, (double)0.5F) ? block() : empty();
            } else {
                int var4 = 1 << var1;
                int var5 = 1 << var2;
                int var6 = 1 << var3;
    ...
    private static int findBits(double var0, double var2) {
        if (!(var0 < -1.0E-7) && !(var2 > 1.0000001)) {
            for(int var4 = 0; var4 <= 3; ++var4) {
                ...
                boolean var9 = Math.abs(var5 - Math.floor(var5)) < 1.0E-7;
                boolean var10 = Math.abs(var7 - Math.floor(var7)) < 1.0E-7;
                if (var9 && var10) {
                    return var4;
                }
            }
    ...
    public static VoxelShape joinUnoptimized(VoxelShape var0, VoxelShape var1, BooleanOp var2) {
        if (var2.apply(false, false)) {
            ...
            if (var0.isEmpty()) {
                ...
                IndexMerger var5 = createIndexMerger(1, var0.getCoords(Axis.X), var1.getCoords(Axis.X), var3, var4);
                IndexMerger var6 = createIndexMerger(var5.getList().size() - 1, var0.getCoords(Axis.Y), var1.getCoords(Axis.Y), var3, var4);
                IndexMerger var7 = createIndexMerger((var5.getList().size() - 1) * (var6.getList().size() - 1), var0.getCoords(Axis.Z), var1.getCoords(Axis.Z), var3, var4);
    ...
    public static boolean joinIsNotEmpty(VoxelShape var0, VoxelShape var1, BooleanOp var2) {
        if (var2.apply(false, false)) {
            ...
            for(Direction.Axis var8 : AxisCycle.AXIS_VALUES) {
                if (var0.max(var8) < var1.min(var8) - 1.0E-7) {
                    return var3 || var4;
                }

                if (var1.max(var8) < var0.min(var8) - 1.0E-7) {
                    return var3 || var4;
                }
            }

            IndexMerger var9 = createIndexMerger(1, var0.getCoords(Axis.X), var1.getCoords(Axis.X), var3, var4);
            IndexMerger var10 = createIndexMerger(var9.getList().size() - 1, var0.getCoords(Axis.Y), var1.getCoords(Axis.Y), var3, var4);
            IndexMerger var11 = createIndexMerger((var9.getList().size() - 1) * (var10.getList().size() - 1), var0.getCoords(Axis.Z), var1.getCoords(Axis.Z), var3, var4);
    ...
    private static boolean joinIsNotEmpty(IndexMerger var0, IndexMerger var1, IndexMerger var2, DiscreteVoxelShape var3, DiscreteVoxelShape var4, BooleanOp var5) {
        return !var0.forMergedIndexes((var5x, var6, var7) -> var1.forMergedIndexes((var6x, var7x, var8) -> var2.forMergedIndexes((var7_, var8x, var9) -> !var5.apply(var3.isFullWide(var5x, var6x, var7), var4.isFullWide(var6, var7x, var8x)))));
    }

    public static double collide(Direction.Axis var0, AABB var1, Stream<VoxelShape> var2, double var3) {
        for(Iterator<VoxelShape> var5 = var2.iterator(); var5.hasNext(); var3 = ((VoxelShape)var5.next()).collide(var0, var1, var3)) {
    ...
    public static double collide(Direction.Axis var0, AABB var1, LevelReader var2, double var3, CollisionContext var5, Stream<VoxelShape> var6) {
        return collide(var1, var2, var3, var5, AxisCycle.between(var0, Axis.Z), var6);
    }
    ...
    private static double collide(AABB var0, LevelReader var1, double var2, CollisionContext var4, AxisCycle var5, Stream<VoxelShape> var6) {
        if (!(var0.getXsize() < 1.0E-6) && !(var0.getYsize() < 1.0E-6) && !(var0.getZsize() < 1.0E-6)) {
            if (Math.abs(var2) < 1.0E-7) {
                ...
                Direction.Axis var8 = var7.cycle(Axis.X);
                Direction.Axis var9 = var7.cycle(Axis.Y);
                Direction.Axis var10 = var7.cycle(Axis.Z);
                BlockPos.MutableBlockPos var11 = new BlockPos.MutableBlockPos();
                int var12 = Mth.floor(var0.min(var8) - 1.0E-7) - 1;
                int var13 = Mth.floor(var0.max(var8) + 1.0E-7) + 1;
                int var14 = Mth.floor(var0.min(var9) - 1.0E-7) - 1;
                int var15 = Mth.floor(var0.max(var9) + 1.0E-7) + 1;
                double var16 = var0.min(var10) - 1.0E-7;
                double var18 = var0.max(var10) + 1.0E-7;
                boolean var20 = var2 > (double)0.0F;
                int var21 = var20 ? Mth.floor(var0.max(var10) - 1.0E-7) - 1 : Mth.floor(var0.min(var10) + 1.0E-7) + 1;
                ...
                var6.forEach((var3) -> var29[0] = var3.collide(var10, var0, var29[0]));
                return var29[0];
            }
        } else {
            return var2;
    ...
    private static int lastC(double var0, double var2, double var4) {
        return var0 > (double)0.0F ? Mth.floor(var4 + var0) + 1 : Mth.floor(var2 + var0) - 1;
    }
    ...
    public static boolean blockOccudes(VoxelShape var0, VoxelShape var1, Direction var2) {
        if (var0 == block() && var1 == block()) {
            ...
            VoxelShape var5 = var4 == AxisDirection.POSITIVE ? var0 : var1;
            VoxelShape var6 = var4 == AxisDirection.POSITIVE ? var1 : var0;
            BooleanOp var7 = var4 == AxisDirection.POSITIVE ? BooleanOp.ONLY_FIRST : BooleanOp.ONLY_SECOND;
            return DoubleMath.fuzzyEquals(var5.max(var3), 1.0F, 1.0E-7) && DoubleMath.fuzzyEquals(var6.min(var3), (double)0.0F, 1.0E-7) && !joinIsNotEmpty(new SliceShape(var5, var3, var5.shape.getSize(var3) - 1), new SliceShape(var6, var3, 0), var7);
        }
    }
    ...
    public static VoxelShape getFaceShape(VoxelShape var0, Direction var1) {
        if (var0 == block()) {
            ...
            boolean var2;
            int var3;
            if (var1.getAxisDirection() == AxisDirection.POSITIVE) {
                var2 = DoubleMath.fuzzyEquals(var0.max(var4), (double)1.0F, 1.0E-7);
                var3 = var0.shape.getSize(var4) - 1;
            } else {
                var2 = DoubleMath.fuzzyEquals(var0.min(var4), (double)0.0F, 1.0E-7);
                var3 = 0;
            }
    ...
    public static boolean mergedFaceOccludes(VoxelShape var0, VoxelShape var1, Direction var2) {
        if (var0 != block() && var1 != block()) {
            ...
            VoxelShape var5 = var4 == AxisDirection.POSITIVE ? var0 : var1;
            VoxelShape var6 = var4 == AxisDirection.POSITIVE ? var1 : var0;
            if (!DoubleMath.fuzzyEquals(var5.max(var3), (double)1.0F, 1.0E-7)) {
                var5 = empty();
            }

            if (!DoubleMath.fuzzyEquals(var6.min(var3), (double)0.0F, 1.0E-7)) {
                var6 = empty();
            }
    ...
    protected static IndexMerger createIndexMerger(int var0, DoubleList var1, DoubleList var2, boolean var3, boolean var4) {
        ...
        if (var1.getDouble(var5) < var2.getDouble(0) - 1.0E-7) {
            ...
            if (var1 instanceof IdenticalMerger) {
                ...
                return (var2 instanceof IdenticalMerger ? (IndexMerger)var2 : new IdenticalMerger(var1));
            }
        } else {
