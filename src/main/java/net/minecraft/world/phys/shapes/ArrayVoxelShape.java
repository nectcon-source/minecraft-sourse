...
public final class ArrayVoxelShape extends VoxelShape {
    ...
    protected ArrayVoxelShape(DiscreteVoxelShape var1, double[] var2, double[] var3, double[] var4) {
        this(var1, DoubleArrayList.wrap(Arrays.copyOf(var2, var1.getXSize() + 1)), DoubleArrayList.wrap(Arrays.copyOf(var3, var1.getYSize() + 1)), DoubleArrayList.wrap(Arrays.copyOf(var4, var1.getZSize() + 1)));
    }
