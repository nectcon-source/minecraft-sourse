   ...
   public void connect(final RealmsServer var1, final String var2, final int var3) {
      ...
      (new Thread("Realms-connect-task") {
         public void run() {
            ...
            try {
            ...
            } catch (UnknownHostException var2_4) {
               var4.getClientPackSource().clearServerPack();
               if (RealmsConnect.this.aborted) {
                  return;
               }

               RealmsConnect.LOGGER.error("Couldn't connect to world", var2_4);
               DisconnectedRealmsScreen var8 = new DisconnectedRealmsScreen(RealmsConnect.this.onlineScreen, CommonComponents.CONNECT_FAILED, new TranslatableComponent("disconnect.genericReason", new Object[]{"Unknown host '" + var2 + "'"}));
               var4.execute(() -> var4.setScreen(var8));
               ...
               RealmsConnect.LOGGER.error("Couldn't connect to world", var2_1);
               String var3x = var2_1.toString();
               if (var1x != null) {
                  String var4x = var1x + ":" + var3;
                  var3x = var3x.replaceAll(var4x, "");
               }

               DisconnectedRealmsScreen var9 = new DisconnectedRealmsScreen(RealmsConnect.this.onlineScreen, CommonComponents.CONNECT_FAILED, new TranslatableComponent("disconnect.genericReason", new Object[]{var3x}));
               var4.execute(() -> var4.setScreen(var9));
            }
