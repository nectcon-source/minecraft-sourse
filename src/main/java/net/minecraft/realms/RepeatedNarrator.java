...
public class RepeatedNarrator {
   ...
   public void narrate(String var1) {
      Params var2 = this.params.updateAndGet((var2x) -> var2x != null && var1.equals(var2x.narration) ? var2x : new Params(var1, RateLimiter.create((double)this.permitsPerSecond)));
