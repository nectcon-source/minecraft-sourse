...
public class GameProfileCache {
   ...
   private static GameProfile lookupGameProfile(GameProfileRepository var0, String var1) {
      final AtomicReference<GameProfile> var2 = new AtomicReference();
   ...
   public List<GameProfileCache.GameProfileInfo> load() {
      List<GameProfileInfo> var1 = Lists.newArrayList();

      try (Reader var2 = Files.newReader(this.file, StandardCharsets.UTF_8)) {
         JsonArray var4 = (JsonArray)this.gson.fromJson(var2, JsonArray.class);
         if (var4 == null) {
            Object var5 = var1;
            return (List<GameProfileInfo>)var5;
         }

         DateFormat var21 = createDateFormat();
         var4.forEach((var2x) -> {
            GameProfileInfo var3 = readGameProfile(var2x, var21);
            if (var3 != null) {
               var1.add(var3);
            }
      ...
      } catch (JsonParseException | IOException var2_1) {
         LOGGER.warn("Failed to load profile cache {}", this.file, var2_1);
      }
   ...
   public void save() {
      ...
      try (Writer var4 = Files.newWriter(this.file, StandardCharsets.UTF_8)) {
         var4.write(var3);
      ...
      if (var0.isJsonObject()) {
         ...
         if (var3 != null && var4 != null) {
            ...
            if (var7 != null && var6 != null && var8 != null) {
               ...
               return new GameProfileInfo(new GameProfile(var9, var7), var8);
            } else {
               return null;
            }
         } else {
