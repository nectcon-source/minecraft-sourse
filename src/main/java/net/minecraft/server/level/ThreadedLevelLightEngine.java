...
public class ThreadedLevelLightEngine extends LevelLightEngine implements AutoCloseable {
   ...
   public void checkBlock(BlockPos var1) {
      ...
      this.addTask(var1.getX() >> 4, var1.getZ() >> 4, ThreadedLevelLightEngine.TaskType.POST_UPDATE, Util.name(() -> super.checkBlock(var2), () -> "checkBlock " + var2));
   }
   ...
   public void enableLightSources(ChunkPos var1, boolean var2) {
      this.addTask(var1.x, var1.z, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name(() -> super.enableLightSources(var1, var2), () -> "enableLight " + var1 + " " + var2));
   }

   @Override
   public void queueSectionData(LightLayer var1, SectionPos var2, @Nullable DataLayer var3, boolean var4) {
      this.addTask(
         var2.x(), var2.z(), () -> 0, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name(() -> super.queueSectionData(var1, var2, var3, var4), () -> "queueData " + var2)
      );
   }
   ...
   public void retainData(ChunkPos var1, boolean var2) {
      this.addTask(var1.x, var1.z, () -> 0, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name(() -> super.retainData(var1, var2), () -> "retainData " + var1));
   }
   ...
   public CompletableFuture<ChunkAccess> lightChunk(ChunkAccess var1, boolean var2) {
      ...
      this.addTask(var3.x, var3.z, ThreadedLevelLightEngine.TaskType.PRE_UPDATE, Util.name(() -> {
         ...
         if (!var2) {
            var1.getLights().forEach((var2x) -> super.onBlockEmissionIncrease(var2x, var1.getLightEmission(var2x)));
         }
   ...
   private void runUpdate() {
      ...
      ObjectListIterator<Pair<TaskType, Runnable>> var2 = this.lightTasks.iterator();

      int var3;
      for(var3 = 0; var2.hasNext() && var3 < var1; ++var3) {
         Pair<TaskType, Runnable> var4 = (Pair)var2.next();
      ...
      for(int var5 = 0; var2.hasNext() && var5 < var1; ++var5) {
         Pair<TaskType, Runnable> var6 = (Pair)var2.next();
