...
public abstract class DistanceManager {
   ...
   protected DistanceManager(Executor var1, Executor var2) {
      ProcessorHandle<Runnable> var3 = ProcessorHandle.of("player ticket throttler", var2::execute);
   ...
   protected void purgeStaleTickets() {
      ...
      ObjectIterator<Long2ObjectMap.Entry<SortedArraySet<Ticket<?>>>> var1 = this.tickets.long2ObjectEntrySet().fastIterator();

      while(var1.hasNext()) {
         Long2ObjectMap.Entry<SortedArraySet<Ticket<?>>> var2 = (Long2ObjectMap.Entry)var1.next();
         if ((var2.getValue()).removeIf((var1x) -> var1x.timedOut(this.ticketTickCounter))) {
   ...
   public boolean runAllUpdates(ChunkMap var1) {
      ...
      if (!this.chunksToUpdateFutures.isEmpty()) {
         this.chunksToUpdateFutures.forEach((var1x) -> var1x.updateFutures(var1));
   ...
   private void addTicket(long var1, Ticket<?> var3) {
      SortedArraySet<Ticket<?>> var4 = this.getTickets(var1);
   ...
   public <T> void removeTicket(TicketType<T> var1, ChunkPos var2, int var3, T var4) {
      Ticket<T> var5 = new Ticket(var1, var3, var4);
   ...
   public <T> void removeRegionTicket(TicketType<T> var1, ChunkPos var2, int var3, T var4) {
      Ticket<T> var5 = new Ticket(var1, 33 - var3, var4);
      this.removeTicket(var2.toLong(), var5);
   }
   ...
   protected void updateChunkForced(ChunkPos var1, boolean var2) {
      Ticket<ChunkPos> var3 = new Ticket(TicketType.FORCED, 31, var1);
      if (var2) {
   ...
   public void addPlayer(SectionPos var1, ServerPlayer var2) {
      ...
      (this.playersPerChunk.computeIfAbsent(var3, (var0) -> new ObjectOpenHashSet())).add(var2);
   ...
   protected String getTicketDebugString(long var1) {
      SortedArraySet<Ticket<?>> var3 = (SortedArraySet)this.tickets.get(var1);
      String var4;
   ...
   class ChunkTicketTracker extends ChunkTracker {
      ...
      protected int getLevelFromSource(long var1) {
         SortedArraySet<Ticket<?>> var3 = (SortedArraySet)DistanceManager.this.tickets.get(var1);
         if (var3 == null) {
   ...
   class FixedPlayerDistanceChunkTracker extends ChunkTracker {
      ...
      private boolean havePlayer(long var1) {
         ObjectSet<ServerPlayer> var3 = DistanceManager.this.playersPerChunk.get(var1);
      ...
      private void onLevelChange(long var1, int var3, boolean var4, boolean var5) {
         if (var4 != var5) {
            ...
            if (var5) {
               ...
               DistanceManager.this.ticketThrottlerReleaser.tell(ChunkTaskPriorityQueueSorter.release(() -> DistanceManager.this.mainThreadExecutor.execute(() -> DistanceManager.this.removeTicket(var1, var6)), var1, true));
            }
         }
      }
