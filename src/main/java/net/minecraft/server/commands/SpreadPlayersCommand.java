...
public class SpreadPlayersCommand {
   ...
   private static int spreadPlayers(CommandSourceStack var0, Vec2 var1, float var2, float var3, int var4, boolean var5, Collection<? extends Entity> var6) throws CommandSyntaxException {
      ...
      Position[] var16 = createInitialPositions(var7, var5 ? getNumberOfTeams(var6) : var6.size(), var8, var10, var12, var14);
   ...
   private static void spreadPositions(
      ...
      if (var18 == (double)Float.MAX_VALUE) {
         var18 = (double)0.0F;
      }
   ...
   private static double setPlayerPositions(Collection<? extends Entity> var0, ServerLevel var1, SpreadPlayersCommand.Position[] var2, int var3, boolean var4) {
      double var5 = 0.0;
      int var7x = 0;
      Map<Team, SpreadPlayersCommand.Position> var8xx = Maps.newHashMap();

      for(Entity var10 : var0) {
         SpreadPlayersCommand.Position var11xxx;
         if (var4) {
            Team var12xxxx = var10 instanceof Player ? var10.getTeam() : null;
            if (!var8xx.containsKey(var12xxxx)) {
               var8xx.put(var12xxxx, var2[var7x++]);
            }

            var11xxx = var8xx.get(var12xxxx);
         } else {
            var11xxx = var2[var7x++];
         }

         var10.teleportToWithTicket((double)Mth.floor(var11xxx.x) + 0.5, (double)var11xxx.getSpawnY(var1, var3), (double)Mth.floor(var11xxx.z) + 0.5);
         double var21xxx = Double.MAX_VALUE;

         for(SpreadPlayersCommand.Position var17 : var2) {
            if (var11xxx != var17) {
               double var18xxxx = var11xxx.dist(var17);
               var21xxx = Math.min(var18xxxx, var21xxx);
            }
         }
