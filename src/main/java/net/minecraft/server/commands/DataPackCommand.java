...
public class DataPackCommand {
   ...
   private static final SuggestionProvider<CommandSourceStack> UNSELECTED_PACKS = (var0, var1) -> {
      ...
      return SharedSuggestionProvider.suggest(var2.getAvailableIds().stream().filter((var1x) -> !var3.contains(var1x)).map(StringArgumentType::escapeIfRequired), var1);
   };
   ...
   private static int enablePack(CommandSourceStack var0, Pack var1, DataPackCommand.Inserter var2) throws CommandSyntaxException {
      ...
      List<Pack> var4 = Lists.newArrayList(var3.getSelectedPacks());
   ...
   private static int disablePack(CommandSourceStack var0, Pack var1) {
      ...
      List<Pack> var3 = Lists.newArrayList(var2.getSelectedPacks());
      var3.remove(var1);
   ...
   private static int listAvailablePacks(CommandSourceStack var0) {
      ...
      var1.reload();
      Collection<? extends Pack> var2 = var1.getSelectedPacks();
      Collection<? extends Pack> var3 = var1.getAvailablePacks();
      List<Pack> var4 = var3.stream().filter((var1x) -> !var2.contains(var1x)).collect(Collectors.toList());
      if (var4.isEmpty()) {
         var0.sendSuccess(new TranslatableComponent("commands.datapack.list.available.none"), false);
      } else {
         var0.sendSuccess(new TranslatableComponent("commands.datapack.list.available.success", new Object[]{var4.size(), ComponentUtils.formatList(var4, (var0x) -> var0x.getChatLink(false))}), false);
      }
   ...
   private static int listEnabledPacks(CommandSourceStack var0) {
      ...
      if (var2.isEmpty()) {
         ...
         var0.sendSuccess(new TranslatableComponent("commands.datapack.list.enabled.success", new Object[]{var2.size(), ComponentUtils.formatList(var2, (var0x) -> var0x.getChatLink(true))}), false);
      }
