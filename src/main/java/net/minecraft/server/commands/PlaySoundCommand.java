...
public class PlaySoundCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      RequiredArgumentBuilder<CommandSourceStack, ResourceLocation> var1 = Commands.argument("sound", ResourceLocationArgument.id())
         .suggests(SuggestionProviders.AVAILABLE_SOUNDS);

      for(SoundSource var3 : SoundSource.values()) {
         var1.then(source(var3));
      }
   ...
   private static int playSound(
      ...
      double var8 = Math.pow(var5 > 1.0F ? (double)(var5 * 16.0F) : (double)16.0F, (double)2.0F);
      int var10 = 0;
      ...
      for(ServerPlayer var12 : var1) {
         ...
         if (var19 > var8) {
            ...
            var21 = new Vec3(var12.getX() + var13 / var23 * (double)2.0F, var12.getY() + var15 / var23 * (double)2.0F, var12.getZ() + var17 / var23 * (double)2.0F);
            var22 = var7;
         }
