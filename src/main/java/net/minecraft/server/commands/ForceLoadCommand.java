...
public class ForceLoadCommand {
   ...
   private static int removeAll(CommandSourceStack var0) {
      ServerLevel var1 = var0.getLevel();
      ResourceKey<Level> var2x = var1.dimension();
      LongSet var3xx = var1.getForcedChunks();
      var3xx.forEach((LongConsumer) var1x -> var1.setChunkForced(ChunkPos.getX(var1x), ChunkPos.getZ(var1x), false));
      var0.sendSuccess(new TranslatableComponent("commands.forceload.removed.all", var2x.location()), true);
      return 0;
   }
