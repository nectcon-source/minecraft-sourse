...
public class EntityDataAccessor implements DataAccessor {
   ...
   public Component getPrintSuccess(Tag var1) {
      return new TranslatableComponent("commands.data.entity.query", this.entity.getDisplayName(), var1.getPrettyDisplay());
   }

   @Override
   public Component getPrintSuccess(NbtPathArgument.NbtPath var1, double var2, int var4) {
      return new TranslatableComponent("commands.data.entity.get", var1, this.entity.getDisplayName(), String.format(Locale.ROOT, "%.2f", var2), var4);
   }
}
