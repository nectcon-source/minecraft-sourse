...
public class ScheduleCommand {
   ...
   public static void register(CommandDispatcher<CommandSourceStack> var0) {
      var0.register(
         Commands.literal("schedule").requires(var0x -> var0x.hasPermission(2))
               .then(
   ...
   private static int schedule(CommandSourceStack var0, Pair<ResourceLocation, Either<CommandFunction, Tag<CommandFunction>>> var1, int var2, boolean var3) throws CommandSyntaxException {
      if (var2 == 0) {
         ...
         ResourceLocation var6 = var1.getFirst();
         TimerQueue<MinecraftServer> var7 = var0.getServer().getWorldData().overworldData().getScheduledEvents();
         var1.getSecond().ifLeft((var7x) -> {
