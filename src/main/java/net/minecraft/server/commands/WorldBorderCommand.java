...
public class WorldBorderCommand {
                        ...
                        .then(
                           Commands.literal("set")
                              .then(
                                 ((RequiredArgumentBuilder)Commands.argument("distance", FloatArgumentType.floatArg(-6.0E7F, 6.0E7F))
                                       .executes(
                                          var0x -> setSize((CommandSourceStack)var0x.getSource(), (double)FloatArgumentType.getFloat(var0x, "distance"), 0L)
                                       ))
                                    .then(
                                       Commands.argument("time", IntegerArgumentType.integer(0))
                                          .executes(
   ...
   private static int getSize(CommandSourceStack var0) {
      ...
      return Mth.floor(var1 + (double)0.5F);
   }
