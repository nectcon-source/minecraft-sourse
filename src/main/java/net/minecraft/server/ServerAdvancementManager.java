...
public class ServerAdvancementManager extends SimpleJsonResourceReloadListener {
   ...
   protected void apply(Map<ResourceLocation, JsonElement> var1, ResourceManager var2, ProfilerFiller var3) {
      Map<ResourceLocation, Advancement.Builder> var4 = Maps.newHashMap();
      var1.forEach((var2x, var3x) -> {
         try {
            ...
            var4.put(var2x, var5);
         } catch (IllegalArgumentException | JsonParseException var4_1) {
            LOGGER.error("Parsing error loading custom advancement {}: {}", var2x, var4_1.getMessage());
         }
