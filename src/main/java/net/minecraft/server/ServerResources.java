...
public class ServerResources implements AutoCloseable {
   ...
   public static CompletableFuture<ServerResources> loadResources(
      List<PackResources> var0, Commands.CommandSelection var1, int var2, Executor var3, Executor var4
   ) {
      ServerResources var5 = new ServerResources(var1, var2);
      CompletableFuture<Unit> var6 = var5.resources.reload(var3, var4, var0, DATA_RELOAD_INITIAL_TASK);
      return var6.whenComplete((var1x, var2x) -> {
         if (var2x != null) {
            var5.close();
         }

      }).thenApply((var1x) -> var5);
   }
