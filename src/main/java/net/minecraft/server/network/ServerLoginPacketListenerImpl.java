...
public class ServerLoginPacketListenerImpl implements ServerLoginPacketListener {
         ...
         if (this.server.getCompressionThreshold() >= 0 && !this.connection.isMemoryConnection()) {
            this.connection
               .send(
                  ...
                  (ChannelFutureListener)var1x -> this.connection.setupCompression(this.server.getCompressionThreshold())
               );
         }
   ...
   public void handleKey(ServerboundKeyPacket var1) {
      ...
      } catch (CryptException var4_1) {
         throw new IllegalStateException("Protocol error", var4_1);
      }
