...
public class CustomBossEvent extends ServerBossEvent {
   ...
   public CustomBossEvent(ResourceLocation var1, Component var2) {
      super(var2, BossBarColor.WHITE, BossBarOverlay.PROGRESS);
      this.id = var1;
   ...
   public static CustomBossEvent load(CompoundTag var0, ResourceLocation var1) {
      ...
      var2.setColor(BossBarColor.byName(var0.getString("Color")));
      var2.setOverlay(BossBarOverlay.byName(var0.getString("Overlay")));
