...
/* loaded from: client_deobf_norm.jar:net/minecraft/data/worldgen/BiomeDefaultFeatures.class */
public class BiomeDefaultFeatures {
   ...
   public static void oceanSpawns(MobSpawnSettings.Builder builder, int i, int i2, int i3) {
      builder.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(EntityType.SQUID, i, 1, i2));
      builder.addSpawn(MobCategory.WATER_AMBIENT, new MobSpawnSettings.SpawnerData(EntityType.COD, i3, 3, 6));
      commonSpawns(builder);
      builder.addSpawn(MobCategory.MONSTER, new MobSpawnSettings.SpawnerData(EntityType.DROWNED, 5, 1, 1));
   }

   public static void warmOceanSpawns(MobSpawnSettings.Builder builder, int i, int i2) {
      builder.addSpawn(MobCategory.WATER_CREATURE, new MobSpawnSettings.SpawnerData(EntityType.SQUID, i, i2, 4));
