...
//   );
   ...
   private static <FC extends FeatureConfiguration> ConfiguredFeature<FC, ?> register(String var0, ConfiguredFeature<FC, ?> var1) {
      return Registry.register(BuiltinRegistries.CONFIGURED_FEATURE, var0, var1);
   }
   ...
   public static final class States {
      ...
      protected static final BlockState SWEET_BERRY_BUSH = (BlockState) Blocks.SWEET_BERRY_BUSH.defaultBlockState().setValue(SweetBerryBushBlock.AGE, Integer.valueOf(3));
      ...
      protected static final BlockState HUGE_RED_MUSHROOM = (BlockState) Blocks.RED_MUSHROOM_BLOCK
              .defaultBlockState()
              .setValue(HugeMushroomBlock.DOWN, Boolean.valueOf(false));
      protected static final BlockState HUGE_BROWN_MUSHROOM = (BlockState) Blocks.BROWN_MUSHROOM_BLOCK
              .defaultBlockState()
              .setValue(HugeMushroomBlock.UP, Boolean.valueOf(true))
              .setValue(HugeMushroomBlock.DOWN, Boolean.valueOf(false));
      protected static final BlockState HUGE_MUSHROOM_STEM = (BlockState) Blocks.MUSHROOM_STEM
              .defaultBlockState()
