...
public class ModelTemplate {
   ...
   public ResourceLocation create(ResourceLocation var1, TextureMapping var2, BiConsumer<ResourceLocation, Supplier<JsonElement>> var3) {
      Map<TextureSlot, ResourceLocation> var4 = this.createMap(var2);
      var3.accept(var1, () -> {
   ...
   private Map<TextureSlot, ResourceLocation> createMap(TextureMapping var1) {
      return (Map<TextureSlot, ResourceLocation>) Streams.concat(new Stream[]{this.requiredSlots.stream(), var1.getForced()}).collect(ImmutableMap.toImmutableMap(Function.identity(), var1::get));
   }
}
