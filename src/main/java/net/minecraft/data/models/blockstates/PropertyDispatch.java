...
public abstract class PropertyDispatch {
   ...
   protected void putValue(Selector var1, List<Variant> var2) {
      List<Variant> var3 = this.values.put(var1, var2);
      if (var3 != null) {
   ...
   private void verifyComplete() {
      List<Property<?>> var1 = this.getDefinedProperties();
      Stream<Selector> var2 = Stream.of(Selector.empty());

      for(Property<?> var4 : var1) {
         var2 = var2.flatMap((var1x) -> {
            return var4.getAllValues().map(var1x::extend);
         });
      }

      List<Selector> var5 = var2.filter((var1x) -> !this.values.containsKey(var1x)).collect(Collectors.toList());
      if (!var5.isEmpty()) {
   ...
   public static class C1<T1 extends Comparable<T1>> extends PropertyDispatch {
      ...
      public PropertyDispatch.C1<T1> select(T1 var1, List<Variant> var2) {
         Selector var3 = Selector.of(new Property.Value[]{this.property1.value(var1)});
   ...
   public static class C2<T1 extends Comparable<T1>, T2 extends Comparable<T2>> extends PropertyDispatch {
      ...
      public PropertyDispatch.C2<T1, T2> select(T1 var1, T2 var2, List<Variant> var3) {
         Selector var4 = Selector.of(new Property.Value[]{this.property1.value(var1), this.property2.value(var2)});
      ...
      public PropertyDispatch generate(BiFunction<T1, T2, Variant> var1) {
         this.property1
            .getPossibleValues()
            .forEach(var2 -> this.property2.getPossibleValues().forEach(var3 -> this.select((T1)var2, var3, var1.apply((T1)var2, var3))));
         return this;
      }
   ...
   public static class C3<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>> extends PropertyDispatch {
      ...
      public PropertyDispatch.C3<T1, T2, T3> select(T1 var1, T2 var2, T3 var3, List<Variant> var4) {
         Selector var5 = Selector.of(new Property.Value[]{this.property1.value(var1), this.property2.value(var2), this.property3.value(var3)});
         ...
         this.property1
            ...
            .forEach(
               var2 -> this.property2
                     .getPossibleValues()
                     .forEach(
                        var3 -> this.property3.getPossibleValues().forEach(var4 -> this.select((T1)var2, (T2)var3, var4, var1.apply((T1)var2, (T2)var3, var4)))
                     )
            );
         return this;
      }
   ...
   public static class C4<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>> extends PropertyDispatch {
      ...
      public PropertyDispatch.C4<T1, T2, T3, T4> select(T1 var1, T2 var2, T3 var3, T4 var4, List<Variant> var5) {
         Selector var6 = Selector.of(new Property.Value[]{this.property1.value(var1), this.property2.value(var2), this.property3.value(var3), this.property4.value(var4)});
   ...
   public static class C5<T1 extends Comparable<T1>, T2 extends Comparable<T2>, T3 extends Comparable<T3>, T4 extends Comparable<T4>, T5 extends Comparable<T5>>
      ...
      public PropertyDispatch.C5<T1, T2, T3, T4, T5> select(T1 var1, T2 var2, T3 var3, T4 var4, T5 var5, List<Variant> var6) {
         Selector var7 = Selector.of(new Property.Value[]{this.property1.value(var1), this.property2.value(var2), this.property3.value(var3), this.property4.value(var4), this.property5.value(var5)});
