...
public final class Selector {
   ...
   public Selector extend(Property.Value<?> var1) {
      return new Selector(ImmutableList.<Property.Value<?>>builder().addAll(this.values).add(var1).build());
   }

   public Selector extend(Selector var1) {
      return new Selector(ImmutableList.<Property.Value<?>>builder().addAll(this.values).addAll(var1.values).build());
   }
