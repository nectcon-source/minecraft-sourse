...
public class ShapedRecipeBuilder {
   ...
   public ShapedRecipeBuilder define(Character var1, ItemLike var2) {
      return this.define(var1, Ingredient.of(new ItemLike[]{var2}));
   }
   ...
   public void save(Consumer<FinishedRecipe> var1, ResourceLocation var2) {
      ...
      this.advancement.parent(new ResourceLocation("recipes/root")).addCriterion("has_the_recipe", RecipeUnlockedTrigger.unlocked(var2)).rewards(net.minecraft.advancements.AdvancementRewards.Builder.recipe(var2)).requirements(RequirementsStrategy.OR);
      var1.accept(new Result(var2, this.result, this.count, this.group == null ? "" : this.group, this.rows, this.key, this.advancement, new ResourceLocation(var2.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + var2.getPath())));
   }
   ...
   class Result implements FinishedRecipe {
      ...
      public void serializeRecipeData(JsonObject var1) {
         ...
         for(Map.Entry<Character, Ingredient> var5 : this.key.entrySet()) {
