...
public class RecipeProvider implements DataProvider {
   ...
   public void run(HashCache var1) throws IOException {
      ...
      saveAdvancement(
         ...
         Advancement.Builder.advancement().addCriterion("impossible", new ImpossibleTrigger.TriggerInstance()).serializeToJson(),
              var2.resolve("data/minecraft/advancements/recipes/root.json")
      );
   }
   ...
   private static void saveRecipe(HashCache var0, JsonObject var1, Path var2) {
      try {
         ...
         LOGGER.error("Couldn't save recipe {}", var2, var3_1);
      }
   }
   ...
   private static void saveAdvancement(HashCache var0, JsonObject var1, Path var2) {
      try {
         ...
         LOGGER.error("Couldn't save recipe advancement {}", var2, var3_1);
      }
   }
   ...
   private static void buildShapelessRecipes(Consumer<FinishedRecipe> var0) {
      ...
      ShapelessRecipeBuilder.shapeless(Items.BLACK_DYE)
         ...
         .save(var0, "black_dye_from_wither_rose");
      ...
      ShapelessRecipeBuilder.shapeless(Items.BLUE_DYE)
         ...
         .save(var0, "blue_dye_from_cornflower");
      ...
      ShapelessRecipeBuilder.shapeless(Items.BONE_MEAL, 9)
         ...
         .save(var0, "bone_meal_from_bone_block");
      ...
      ShapedRecipeBuilder.shaped(Blocks.BRICK_SLAB, 6).define('#', Blocks.BRICKS).pattern("###").unlockedBy("has_brick_block", has(Blocks.BRICKS)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Items.CLOCK)
         ...
         .save(var0);
      ShapelessRecipeBuilder.shapeless(Items.COAL, 9).requires(Blocks.COAL_BLOCK).unlockedBy("has_coal_block", has(Blocks.COAL_BLOCK)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.DAYLIGHT_DETECTOR)
         ...
         .define('G', Blocks.GLASS)
         .define('W', Ingredient.of((ItemLike) ItemTags.WOODEN_SLABS))
         .pattern("GGG")
         .pattern("QQQ")
         .pattern("WWW")
         .unlockedBy("has_quartz", has(Items.QUARTZ))
      ...
      ShapedRecipeBuilder.shaped(Blocks.DETECTOR_RAIL, 6)
         ...
         .unlockedBy("has_rail", has(Blocks.RAIL))
         .save(var0);
      ShapelessRecipeBuilder.shapeless(Items.DIAMOND, 9).requires(Blocks.DIAMOND_BLOCK).unlockedBy("has_diamond_block", has(Blocks.DIAMOND_BLOCK)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.DROPPER)
         ...
         .unlockedBy("has_redstone", has(Items.REDSTONE))
         .save(var0);
      ShapelessRecipeBuilder.shapeless(Items.EMERALD, 9).requires(Blocks.EMERALD_BLOCK).unlockedBy("has_emerald_block", has(Blocks.EMERALD_BLOCK)).save(var0);
      ...
      ShapelessRecipeBuilder.shapeless(Items.FLINT_AND_STEEL)
         ...
         .unlockedBy("has_obsidian", has(Blocks.OBSIDIAN))
         .save(var0);
      ShapedRecipeBuilder.shaped(Blocks.FLOWER_POT).define('#', Items.BRICK).pattern("# #").pattern(" # ").unlockedBy("has_brick", has(Items.BRICK)).save(var0);
      ...
      ShapelessRecipeBuilder.shapeless(Items.GOLD_INGOT, 9)
         ...
         .save(var0, "gold_ingot_from_gold_block");
      ShapedRecipeBuilder.shaped(Items.GOLD_INGOT)
         ...
         .group("gold_ingot")
         .unlockedBy("has_gold_nugget", has(Items.GOLD_NUGGET))
         .save(var0, "gold_ingot_from_nuggets");
      ShapelessRecipeBuilder.shapeless(Items.GOLD_NUGGET, 9).requires(Items.GOLD_INGOT).unlockedBy("has_gold_ingot", has(Items.GOLD_INGOT)).save(var0);
      ...
      ShapelessRecipeBuilder.shapeless(Items.IRON_INGOT, 9)
         ...
         .group("iron_ingot")
         .unlockedBy("has_iron_block", has(Blocks.IRON_BLOCK))
         .save(var0, "iron_ingot_from_iron_block");
      ShapedRecipeBuilder.shaped(Items.IRON_INGOT)
         ...
         .save(var0, "iron_ingot_from_nuggets");
      ShapedRecipeBuilder.shaped(Items.IRON_LEGGINGS)
         ...
         .unlockedBy("has_iron_ingot", has(Items.IRON_INGOT))
         .save(var0);
      ShapelessRecipeBuilder.shapeless(Items.IRON_NUGGET, 9).requires(Items.IRON_INGOT).unlockedBy("has_iron_ingot", has(Items.IRON_INGOT)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.LAPIS_BLOCK)
         ...
         .save(var0);
      ShapelessRecipeBuilder.shapeless(Items.LAPIS_LAZULI, 9).requires(Blocks.LAPIS_BLOCK).unlockedBy("has_lapis_block", has(Blocks.LAPIS_BLOCK)).save(var0);
      ...
      ShapelessRecipeBuilder.shapeless(Items.LIGHT_BLUE_DYE)
         ...
         .save(var0, "light_blue_dye_from_blue_orchid");
      ...
      ShapelessRecipeBuilder.shapeless(Items.LIGHT_GRAY_DYE)
         ...
         .save(var0, "light_gray_dye_from_azure_bluet");
      ...
      ShapelessRecipeBuilder.shapeless(Items.LIGHT_GRAY_DYE)
         ...
         .save(var0, "light_gray_dye_from_oxeye_daisy");
      ShapelessRecipeBuilder.shapeless(Items.LIGHT_GRAY_DYE)
         .requires(Blocks.WHITE_TULIP)
         .group("light_gray_dye")
         .unlockedBy("has_red_flower", has(Blocks.WHITE_TULIP))
         .save(var0, "light_gray_dye_from_white_tulip");
      ...
      ShapelessRecipeBuilder.shapeless(Items.MAGENTA_DYE)
         ...
         .save(var0, "magenta_dye_from_allium");
      ...
      ShapelessRecipeBuilder.shapeless(Items.MAGENTA_DYE, 2)
         ...
         .save(var0, "magenta_dye_from_lilac");
      ShapelessRecipeBuilder.shapeless(Items.MAGENTA_DYE, 2)
      ...
      ShapelessRecipeBuilder.shapeless(Items.ORANGE_DYE)
         ...
         .save(var0, "orange_dye_from_orange_tulip");
      ...
      ShapedRecipeBuilder.shaped(Items.PAINTING)
         .define('#', Items.STICK)
         .define('X', Ingredient.of((ItemLike) ItemTags.WOOL))
         .pattern("###")
         .pattern("#X#")
         .pattern("###")
      ...
      ShapedRecipeBuilder.shaped(Blocks.PURPUR_STAIRS, 4)
         ...
         .unlockedBy("has_purpur_block", has(Blocks.PURPUR_BLOCK))
         .save(var0);
      ShapedRecipeBuilder.shaped(Blocks.QUARTZ_BLOCK).define('#', Items.QUARTZ).pattern("##").pattern("##").unlockedBy("has_quartz", has(Items.QUARTZ)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.RAIL, 16)
         ...
         .unlockedBy("has_minecart", has(Items.MINECART))
         .save(var0);
      ShapelessRecipeBuilder.shapeless(Items.REDSTONE, 9).requires(Blocks.REDSTONE_BLOCK).unlockedBy("has_redstone_block", has(Blocks.REDSTONE_BLOCK)).save(var0);
      ...
      ShapelessRecipeBuilder.shapeless(Items.RED_DYE, 2)
         ...
         .save(var0, "red_dye_from_rose_bush");
      ShapelessRecipeBuilder.shapeless(Items.RED_DYE)
      ...
      ShapedRecipeBuilder.shaped(Blocks.SLIME_BLOCK)
         ...
         .unlockedBy("has_slime_ball", has(Items.SLIME_BALL))
         .save(var0);
      ShapelessRecipeBuilder.shapeless(Items.SLIME_BALL, 9).requires(Blocks.SLIME_BLOCK).unlockedBy("has_slime", has(Blocks.SLIME_BLOCK)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.STONE_BRICK_STAIRS, 4)
         ...
         .unlockedBy("has_stone_bricks", has(ItemTags.STONE_BRICKS))
         .save(var0);
      ShapelessRecipeBuilder.shapeless(Blocks.STONE_BUTTON).requires(Blocks.STONE).unlockedBy("has_stone", has(Blocks.STONE)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Items.STONE_PICKAXE)
         ...
         .unlockedBy("has_cobblestone", has(ItemTags.STONE_TOOL_MATERIALS))
         .save(var0);
      ShapedRecipeBuilder.shaped(Blocks.STONE_PRESSURE_PLATE).define('#', Blocks.STONE).pattern("##").unlockedBy("has_stone", has(Blocks.STONE)).save(var0);
      ShapedRecipeBuilder.shaped(Items.STONE_SHOVEL)
         ...
         .unlockedBy("has_cobblestone", has(ItemTags.STONE_TOOL_MATERIALS))
         .save(var0);
      ShapedRecipeBuilder.shaped(Blocks.STONE_SLAB, 6).define('#', Blocks.STONE).pattern("###").unlockedBy("has_stone", has(Blocks.STONE)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.TRIPWIRE_HOOK, 2)
         ...
         .unlockedBy("has_string", has(Items.STRING))
         .save(var0);
      ShapedRecipeBuilder.shaped(Items.TURTLE_HELMET).define('X', Items.SCUTE).pattern("XXX").pattern("X X").unlockedBy("has_scute", has(Items.SCUTE)).save(var0);
      ...
      ShapelessRecipeBuilder.shapeless(Items.WHITE_DYE).requires(Items.BONE_MEAL).group("white_dye").unlockedBy("has_bone_meal", has(Items.BONE_MEAL)).save(var0);
      ShapelessRecipeBuilder.shapeless(Items.WHITE_DYE)
         ...
         .save(var0, "white_dye_from_lily_of_the_valley");
      ...
      ShapelessRecipeBuilder.shapeless(Items.YELLOW_DYE)
         ...
         .save(var0, "yellow_dye_from_dandelion");
      ShapelessRecipeBuilder.shapeless(Items.YELLOW_DYE, 2)
         ...
         .save(var0, "yellow_dye_from_sunflower");
      ShapelessRecipeBuilder.shapeless(Items.DRIED_KELP, 9)
         ...
         .save(var0);
      ShapelessRecipeBuilder.shapeless(Blocks.DRIED_KELP_BLOCK).requires(Items.DRIED_KELP, 9).unlockedBy("has_dried_kelp", has(Items.DRIED_KELP)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.SMOOTH_QUARTZ_SLAB, 6)
         ...
         .unlockedBy("has_smooth_quartz", has(Blocks.SMOOTH_QUARTZ))
         .save(var0);
      ShapedRecipeBuilder.shaped(Blocks.GRANITE_SLAB, 6).define('#', Blocks.GRANITE).pattern("###").unlockedBy("has_granite", has(Blocks.GRANITE)).save(var0);
      ShapedRecipeBuilder.shaped(Blocks.ANDESITE_SLAB, 6).define('#', Blocks.ANDESITE).pattern("###").unlockedBy("has_andesite", has(Blocks.ANDESITE)).save(var0);
      ...
      ShapedRecipeBuilder.shaped(Blocks.POLISHED_ANDESITE_SLAB, 6)
         ...
         .unlockedBy("has_polished_andesite", has(Blocks.POLISHED_ANDESITE))
         .save(var0);
      ShapedRecipeBuilder.shaped(Blocks.DIORITE_SLAB, 6).define('#', Blocks.DIORITE).pattern("###").unlockedBy("has_diorite", has(Blocks.DIORITE)).save(var0);
      ...
      ShapelessRecipeBuilder.shapeless(Items.NETHERITE_INGOT, 9)
         ...
         .save(var0, "netherite_ingot_from_netherite_block");
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike) ItemTags.LOGS_THAT_BURN), Items.CHARCOAL, 0.15F, 200)
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.of(Items.CHICKEN), Items.COOKED_CHICKEN, 0.35F, 200).unlockedBy("has_chicken", has(Items.CHICKEN)).save(var0);
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.KELP), Items.DRIED_KELP, 0.1F, 200)
         ...
         .save(var0, "dried_kelp_from_smelting");
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.DIAMOND_ORE.asItem()), Items.DIAMOND, 1.0F, 200)
         ...
         .save(var0, "diamond_from_smelting");
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.EMERALD_ORE.asItem()), Items.EMERALD, 1.0F, 200)
         ...
         .save(var0, "emerald_from_smelting");
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike) ItemTags.SAND), Blocks.GLASS.asItem(), 0.1F, 200).unlockedBy("has_sand", has(ItemTags.SAND)).save(var0);
      SimpleCookingRecipeBuilder.smelting(Ingredient.of((ItemLike) ItemTags.GOLD_ORES), Items.GOLD_INGOT, 1.0F, 200)
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.SEA_PICKLE.asItem()), Items.LIME_DYE, 0.1F, 200)
         ...
         .save(var0, "lime_dye_from_smelting");
      ...
      SimpleCookingRecipeBuilder.smelting(
         ...
         .save(var0, "gold_nugget_from_smelting");
      SimpleCookingRecipeBuilder.smelting(
            Ingredient.of(
               Items.IRON_PICKAXE,
               Items.IRON_SHOVEL,
      ...
      SimpleCookingRecipeBuilder.smelting(Ingredient.of(Blocks.REDSTONE_ORE), Items.REDSTONE, 0.7F, 200)
         ...
         .save(var0, "redstone_from_smelting");
      ...
      SimpleCookingRecipeBuilder.blasting(
         ...
         .unlockedBy("has_golden_boots", has(Items.GOLDEN_BOOTS))
         .unlockedBy("has_golden_horse_armor", has(Items.GOLDEN_HORSE_ARMOR))
         .save(var0, "gold_nugget_from_blasting");
      SimpleCookingRecipeBuilder.blasting(
            Ingredient.of(
               Items.IRON_PICKAXE,
               Items.IRON_SHOVEL,
      ...
      SimpleCookingRecipeBuilder.blasting(Ingredient.of(Blocks.ANCIENT_DEBRIS), Items.NETHERITE_SCRAP, 2.0F, 100)
         .unlockedBy("has_ancient_debris", has(Blocks.ANCIENT_DEBRIS))
         .save(var0, "netherite_scrap_from_blasting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.STONE_BRICKS), Blocks.STONE_BRICK_SLAB, 2)
         ...
         .save(var0, "stone_brick_slab_from_stone_bricks_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.STONE_BRICKS), Blocks.STONE_BRICK_STAIRS)
         .unlocks("has_stone_bricks", has(Blocks.STONE_BRICKS))
         .save(var0, "stone_brick_stairs_from_stone_bricks_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.DARK_PRISMARINE), Blocks.DARK_PRISMARINE_SLAB, 2)
         ...
         .save(var0, "dark_prismarine_slab_from_dark_prismarine_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.DARK_PRISMARINE), Blocks.DARK_PRISMARINE_STAIRS)
         .unlocks("has_dark_prismarine", has(Blocks.DARK_PRISMARINE))
         .save(var0, "dark_prismarine_stairs_from_dark_prismarine_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.POLISHED_ANDESITE), Blocks.POLISHED_ANDESITE_SLAB, 2)
         ...
         .save(var0, "polished_andesite_slab_from_polished_andesite_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.POLISHED_ANDESITE), Blocks.POLISHED_ANDESITE_STAIRS)
         .unlocks("has_polished_andesite", has(Blocks.POLISHED_ANDESITE))
         .save(var0, "polished_andesite_stairs_from_polished_andesite_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.BASALT), Blocks.POLISHED_BASALT)
         ...
         .save(var0, "polished_basalt_from_basalt_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.POLISHED_GRANITE), Blocks.POLISHED_GRANITE_SLAB, 2)
         ...
         .save(var0, "polished_granite_slab_from_polished_granite_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.POLISHED_GRANITE), Blocks.POLISHED_GRANITE_STAIRS)
         .unlocks("has_polished_granite", has(Blocks.POLISHED_GRANITE))
         .save(var0, "polished_granite_stairs_from_polished_granite_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.DIORITE), Blocks.POLISHED_DIORITE_SLAB, 2)
         ...
         .save(var0, "polished_diorite_slab_from_diorite_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.DIORITE), Blocks.POLISHED_DIORITE_STAIRS)
         .unlocks("has_diorite", has(Blocks.POLISHED_DIORITE))
         .save(var0, "polished_diorite_stairs_from_diorite_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.POLISHED_DIORITE), Blocks.POLISHED_DIORITE_SLAB, 2)
         ...
         .save(var0, "polished_diorite_slab_from_polished_diorite_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.POLISHED_DIORITE), Blocks.POLISHED_DIORITE_STAIRS)
         .unlocks("has_polished_diorite", has(Blocks.POLISHED_DIORITE))
         .save(var0, "polished_diorite_stairs_from_polished_diorite_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.SMOOTH_SANDSTONE), Blocks.SMOOTH_SANDSTONE_SLAB, 2)
         ...
         .save(var0, "smooth_sandstone_slab_from_smooth_sandstone_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.SMOOTH_SANDSTONE), Blocks.SMOOTH_SANDSTONE_STAIRS)
         ...
         .save(var0, "smooth_sandstone_stairs_from_smooth_sandstone_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.SMOOTH_RED_SANDSTONE), Blocks.SMOOTH_RED_SANDSTONE_SLAB, 2)
         ...
         .save(var0, "smooth_red_sandstone_slab_from_smooth_red_sandstone_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.SMOOTH_RED_SANDSTONE), Blocks.SMOOTH_RED_SANDSTONE_STAIRS)
         .unlocks("has_smooth_red_sandstone", has(Blocks.SMOOTH_RED_SANDSTONE))
         .save(var0, "smooth_red_sandstone_stairs_from_smooth_red_sandstone_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.SMOOTH_QUARTZ), Blocks.SMOOTH_QUARTZ_SLAB, 2)
         ...
         .save(var0, "smooth_quartz_slab_from_smooth_quartz_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.SMOOTH_QUARTZ), Blocks.SMOOTH_QUARTZ_STAIRS)
         .unlocks("has_smooth_quartz", has(Blocks.SMOOTH_QUARTZ))
         .save(var0, "smooth_quartz_stairs_from_smooth_quartz_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.SMOOTH_STONE), Blocks.SMOOTH_STONE_SLAB, 2)
         ...
         .save(var0, "smooth_stone_slab_from_smooth_stone_stonecutting");
      ...
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.POLISHED_BLACKSTONE_BRICKS), Blocks.POLISHED_BLACKSTONE_BRICK_SLAB, 2)
         ...
         .save(var0, "polished_blackstone_brick_slab_from_polished_blackstone_bricks_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.POLISHED_BLACKSTONE_BRICKS), Blocks.POLISHED_BLACKSTONE_BRICK_STAIRS)
         .unlocks("has_polished_blackstone_bricks", has(Blocks.POLISHED_BLACKSTONE_BRICKS))
         .save(var0, "polished_blackstone_brick_stairs_from_polished_blackstone_bricks_stonecutting");
      SingleItemRecipeBuilder.stonecutting(Ingredient.of(Blocks.POLISHED_BLACKSTONE_BRICKS), Blocks.POLISHED_BLACKSTONE_BRICK_WALL)
         .unlocks("has_polished_blackstone_bricks", has(Blocks.POLISHED_BLACKSTONE_BRICKS))
         .save(var0, "polished_blackstone_brick_wall_from_polished_blackstone_bricks_stonecutting");
   ...
   private static void netheriteSmithing(Consumer<FinishedRecipe> var0, Item var1, Item var2) {
      UpgradeRecipeBuilder.smithing(Ingredient.of(var1), Ingredient.of(Items.NETHERITE_INGOT), var2)
         ...
         .save(var0, Registry.ITEM.getKey(var2.asItem()).getPath() + "_smithing");
   }
   ...
   private static void woodenFence(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      ShapedRecipeBuilder.shaped(var1, 3)
         .define('#', Items.STICK)
         .define('W', var2)
         .pattern("W#W")
         .pattern("W#W")
         .group("wooden_fence")
         .unlockedBy("has_planks", has(var2))
         .save(var0);
   }
   ...
   private static void woodenStairs(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      ShapedRecipeBuilder.shaped(var1, 4)
         .define('#', var2)
         .pattern("#  ")
         .pattern("## ")
         .pattern("###")
   ...
   private static void woodenSign(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      ...
      ShapedRecipeBuilder.shaped(var1, 3)
         ...
         .pattern("###")
         .pattern(" X ")
         .unlockedBy("has_" + var3, has(var2))
         .save(var0);
   }

   private static void coloredWoolFromWhiteWoolAndDye(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      ShapelessRecipeBuilder.shapeless(var1).requires(var2).requires(Blocks.WHITE_WOOL).group("wool").unlockedBy("has_white_wool", has(Blocks.WHITE_WOOL)).save(var0);
   }
   ...
   private static void coloredCarpetFromWhiteCarpetAndDye(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      ...
      ShapedRecipeBuilder.shaped(var1, 8).define('#', Blocks.WHITE_CARPET).define('$', var2).pattern("###").pattern("#$#").pattern("###").group("carpet").unlockedBy("has_white_carpet", has(Blocks.WHITE_CARPET)).unlockedBy("has_" + var4, has(var2)).save(var0, var3 + "_from_white_carpet");
   }

   private static void bedFromPlanksAndWool(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      String var3 = Registry.ITEM.getKey(var2.asItem()).getPath();
      ShapedRecipeBuilder.shaped(var1).define('#', var2).define('X', ItemTags.PLANKS).pattern("###").pattern("XXX").group("bed").unlockedBy("has_" + var3, has(var2)).save(var0);
   }

   private static void bedFromWhiteBedAndDye(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      String var3 = Registry.ITEM.getKey(var1.asItem()).getPath();
      ShapelessRecipeBuilder.shapeless(var1).requires(Items.WHITE_BED).requires(var2).group("dyed_bed").unlockedBy("has_bed", has(Items.WHITE_BED)).save(var0, var3 + "_from_white_bed");
   }

   private static void banner(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      String var3 = Registry.ITEM.getKey(var2.asItem()).getPath();
      ShapedRecipeBuilder.shaped(var1).define('#', var2).define('|', Items.STICK).pattern("###").pattern("###").pattern(" | ").group("banner").unlockedBy("has_" + var3, has(var2)).save(var0);
   }

   private static void stainedGlassFromGlassAndDye(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      ShapedRecipeBuilder.shaped(var1, 8).define('#', Blocks.GLASS).define('X', var2).pattern("###").pattern("#X#").pattern("###").group("stained_glass").unlockedBy("has_glass", has(Blocks.GLASS)).save(var0);
   }
   ...
   private static void stainedGlassPaneFromGlassPaneAndDye(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      String var3 = Registry.ITEM.getKey(var1.asItem()).getPath();
      String var4 = Registry.ITEM.getKey(var2.asItem()).getPath();
      ShapedRecipeBuilder.shaped(var1, 8).define('#', Blocks.GLASS_PANE).define('$', var2).pattern("###").pattern("#$#").pattern("###").group("stained_glass_pane").unlockedBy("has_glass_pane", has(Blocks.GLASS_PANE)).unlockedBy("has_" + var4, has(var2)).save(var0, var3 + "_from_glass_pane");
   }

   private static void coloredTerracottaFromTerracottaAndDye(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      ShapedRecipeBuilder.shaped(var1, 8).define('#', Blocks.TERRACOTTA).define('X', var2).pattern("###").pattern("#X#").pattern("###").group("stained_terracotta").unlockedBy("has_terracotta", has(Blocks.TERRACOTTA)).save(var0);
   }

   private static void concretePowder(Consumer<FinishedRecipe> var0, ItemLike var1, ItemLike var2) {
      ShapelessRecipeBuilder.shapeless(var1, 8).requires(var2).requires(Blocks.SAND, 4).requires(Blocks.GRAVEL, 4).group("concrete_powder").unlockedBy("has_sand", has(Blocks.SAND)).unlockedBy("has_gravel", has(Blocks.GRAVEL)).save(var0);
   }

   private static void cookRecipes(Consumer<FinishedRecipe> var0, String var1, SimpleCookingSerializer<?> var2, int var3) {
      SimpleCookingRecipeBuilder.cooking(Ingredient.of(new ItemLike[]{Items.BEEF}), Items.COOKED_BEEF, 0.35F, var3, var2).unlockedBy("has_beef", has(Items.BEEF)).save(var0, "cooked_beef_from_" + var1);
      SimpleCookingRecipeBuilder.cooking(Ingredient.of(new ItemLike[]{Items.CHICKEN}), Items.COOKED_CHICKEN, 0.35F, var3, var2).unlockedBy("has_chicken", has(Items.CHICKEN)).save(var0, "cooked_chicken_from_" + var1);
      SimpleCookingRecipeBuilder.cooking(Ingredient.of(new ItemLike[]{Items.COD}), Items.COOKED_COD, 0.35F, var3, var2).unlockedBy("has_cod", has(Items.COD)).save(var0, "cooked_cod_from_" + var1);
      SimpleCookingRecipeBuilder.cooking(Ingredient.of(new ItemLike[]{Blocks.KELP}), Items.DRIED_KELP, 0.1F, var3, var2).unlockedBy("has_kelp", has(Blocks.KELP)).save(var0, "dried_kelp_from_" + var1);
      SimpleCookingRecipeBuilder.cooking(Ingredient.of(new ItemLike[]{Items.SALMON}), Items.COOKED_SALMON, 0.35F, var3, var2).unlockedBy("has_salmon", has(Items.SALMON)).save(var0, "cooked_salmon_from_" + var1);
      SimpleCookingRecipeBuilder.cooking(Ingredient.of(new ItemLike[]{Items.MUTTON}), Items.COOKED_MUTTON, 0.35F, var3, var2).unlockedBy("has_mutton", has(Items.MUTTON)).save(var0, "cooked_mutton_from_" + var1);
      SimpleCookingRecipeBuilder.cooking(Ingredient.of(new ItemLike[]{Items.PORKCHOP}), Items.COOKED_PORKCHOP, 0.35F, var3, var2).unlockedBy("has_porkchop", has(Items.PORKCHOP)).save(var0, "cooked_porkchop_from_" + var1);
      SimpleCookingRecipeBuilder.cooking(Ingredient.of(new ItemLike[]{Items.POTATO}), Items.BAKED_POTATO, 0.35F, var3, var2).unlockedBy("has_potato", has(Items.POTATO)).save(var0, "baked_potato_from_" + var1);
      SimpleCookingRecipeBuilder.cooking(Ingredient.of(new ItemLike[]{Items.RABBIT}), Items.COOKED_RABBIT, 0.35F, var3, var2).unlockedBy("has_rabbit", has(Items.RABBIT)).save(var0, "cooked_rabbit_from_" + var1);
   }
   ...
   private static InventoryChangeTrigger.TriggerInstance has(ItemLike var0) {
      return inventoryTrigger(net.minecraft.advancements.critereon.ItemPredicate.Builder.item().of(var0).build());
   }
