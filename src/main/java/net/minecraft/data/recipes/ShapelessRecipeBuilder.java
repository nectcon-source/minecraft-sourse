...
public class ShapelessRecipeBuilder {
   ...
   public ShapelessRecipeBuilder requires(ItemLike var1, int var2) {
      for(int var3 = 0; var3 < var2; ++var3) {
         this.requires(Ingredient.of(new ItemLike[]{var1}));
      }
   ...
   public void save(Consumer<FinishedRecipe> var1, ResourceLocation var2) {
      ...
      var1.accept(new Result(var2, this.result, this.count, this.group == null ? "" : this.group, this.ingredients, this.advancement, new ResourceLocation(var2.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + var2.getPath())));
   }
