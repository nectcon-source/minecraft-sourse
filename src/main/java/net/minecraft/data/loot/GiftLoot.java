               ...
               LootPool.lootPool()
                  ...
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        ...
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:swiftness"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:slowness"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:strength"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:healing"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:harming"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:leaping"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:regeneration"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:fire_resistance"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:water_breathing"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:invisibility"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:night_vision"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:weakness"))))
                  )
                  .add(
                     LootItem.lootTableItem(Items.TIPPED_ARROW)
                        .apply(SetItemCountFunction.setCount(RandomValueBounds.between(0.0F, 1.0F)))
                        .apply(SetNbtFunction.setTag(Util.make(new CompoundTag(), var0 -> var0.putString("Potion", "minecraft:poison"))))
                  )
            )
      );
      var1.accept(
