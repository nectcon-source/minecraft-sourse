...
public class Main {
   ...
   public static void main(String[] var0) throws IOException {
      ...
      if (!var11.has(var2) && var11.hasOptions()) {
         Path var12 = Paths.get(var9.value(var11));
         ...
         DataGenerator var19 = createStandardGenerator(var12, var11.valuesOf(var10).stream().map((var0x) -> Paths.get(var0x)).collect(Collectors.toList()), var14, var15, var16, var17, var18);
         var19.run();
      } else {
