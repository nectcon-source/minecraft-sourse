...
public class SoundEngine {
   ...
   private void tickNonPaused() {
      ...
      Iterator<Map.Entry<SoundInstance, ChannelAccess.ChannelHandle>> var9 = this.instanceToChannel.entrySet().iterator();

      while(var9.hasNext()) {
         Map.Entry<SoundInstance, ChannelAccess.ChannelHandle> var10 = var9.next();
         ChannelAccess.ChannelHandle var12 = var10.getValue();
         SoundInstance var14 = var10.getKey();
      ...
      Iterator<Map.Entry<SoundInstance, Integer>> var11 = this.queuedSounds.entrySet().iterator();

      while(var11.hasNext()) {
         Map.Entry<SoundInstance, Integer> var13 = var11.next();
         if (this.tickCount >= var13.getValue()) {
            SoundInstance var15 = var13.getKey();
               ...
               if (var4 == SoundManager.EMPTY_SOUND) {
                  ...
                  if (var8 == 0.0F && !var1.canStartSilent()) {
                     ...
                     if (!this.listeners.isEmpty()) {
                        boolean var13 = var11 || var10 == SoundInstance.Attenuation.NONE || this.listener.getListenerPosition().distanceToSqr(var12) < (double)(var6 * var6);
                        if (var13) {
                     ...
                     if (this.listener.getGain() <= 0.0F) {
                        ...
                        CompletableFuture<ChannelAccess.ChannelHandle> var19 = this.channelAccess.createHandle(var4.shouldStream() ? Library.Pool.STREAMING : Library.Pool.STATIC);
