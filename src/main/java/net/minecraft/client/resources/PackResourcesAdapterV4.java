...
public class PackResourcesAdapterV4 implements PackResources {
   private static final Map<String, Pair<ChestType, ResourceLocation>> CHESTS = Util.make(Maps.newHashMap(), (var0) -> {
      var0.put("textures/entity/chest/normal_left.png", new Pair<ChestType, ResourceLocation>(ChestType.LEFT, new ResourceLocation("textures/entity/chest/normal_double.png")));
      var0.put("textures/entity/chest/normal_right.png", new Pair<ChestType, ResourceLocation>(ChestType.RIGHT, new ResourceLocation("textures/entity/chest/normal_double.png")));
      var0.put("textures/entity/chest/normal.png", new Pair<ChestType, ResourceLocation>(ChestType.SINGLE, new ResourceLocation("textures/entity/chest/normal.png")));
      var0.put("textures/entity/chest/trapped_left.png", new Pair<ChestType, ResourceLocation>(ChestType.LEFT, new ResourceLocation("textures/entity/chest/trapped_double.png")));
      var0.put("textures/entity/chest/trapped_right.png", new Pair<ChestType, ResourceLocation>(ChestType.RIGHT, new ResourceLocation("textures/entity/chest/trapped_double.png")));
      var0.put("textures/entity/chest/trapped.png", new Pair<ChestType, ResourceLocation>(ChestType.SINGLE, new ResourceLocation("textures/entity/chest/trapped.png")));
      var0.put("textures/entity/chest/christmas_left.png", new Pair<ChestType, ResourceLocation>(ChestType.LEFT, new ResourceLocation("textures/entity/chest/christmas_double.png")));
      var0.put("textures/entity/chest/christmas_right.png", new Pair<ChestType, ResourceLocation>(ChestType.RIGHT, new ResourceLocation("textures/entity/chest/christmas_double.png")));
      var0.put("textures/entity/chest/christmas.png", new Pair<ChestType, ResourceLocation>(ChestType.SINGLE, new ResourceLocation("textures/entity/chest/christmas.png")));
      var0.put("textures/entity/chest/ender.png", new Pair<ChestType, ResourceLocation>(ChestType.SINGLE, new ResourceLocation("textures/entity/chest/ender.png")));
   });
      ...
      if (!"minecraft".equals(var2.getNamespace())) {
         ...
         if ("textures/misc/enchanted_item_glint.png".equals(var3)) {
            ...
            if (SHIELDS.contains(var3)) {
               ...
               Pair<ChestType, ResourceLocation> var4 = (Pair)CHESTS.get(var3);
   ...
   public InputStream getResource(PackType var1, ResourceLocation var2) throws IOException {
      if (!"minecraft".equals(var2.getNamespace())) {
         ...
         if ("textures/entity/iron_golem/iron_golem.png".equals(var3)) {
            ...
            if (SHIELDS.contains(var3)) {
               InputStream var20 = fixPattern(this.pack.getResource(var1, SHIELD_BASE), this.pack.getResource(var1, var2), 64, 2, 2, 12, 22);
               if (var20 != null) {
                  return var20;
               }
            } else if (BANNERS.contains(var3)) {
               InputStream var19 = fixPattern(this.pack.getResource(var1, BANNER_BASE), this.pack.getResource(var1, var2), 64, 0, 0, 42, 41);
               if (var19 != null) {
                  return var19;
               }
            } else {
               if ("textures/entity/enderdragon/dragon.png".equals(var3) || "textures/entity/enderdragon/dragon_exploding.png".equals(var3)) {
                  ...
                  try (NativeImage var18 = NativeImage.read(this.pack.getResource(var1, var2))) {
                     int var22 = var18.getWidth() / 256;

                     for(int var7 = 88 * var22; var7 < 200 * var22; ++var7) {
                        for(int var8 = 56 * var22; var8 < 112 * var22; ++var8) {
                           var18.setPixelRGBA(var8, var7, 0);
                        }
                     }

                     var23 = new ByteArrayInputStream(var18.asByteArray());
                  }
   ...
   public static InputStream fixPattern(InputStream var0, InputStream var1, int var2, int var3, int var4, int var5, int var6) throws IOException {
      ...
      try (NativeImage var7 = NativeImage.read(var0)) {
         ...
         try {
            ...
            try {
               ...
               var71 = new ByteArrayInputStream(var13.asByteArray());
   ...
   public <T> T getMetadataSection(MetadataSectionSerializer<T> var1) throws IOException {
      return (T)this.pack.getMetadataSection(var1);
   }
   ...
   static {
      SHIELDS = PATTERNS.stream().map((var0) -> "textures/entity/shield/" + var0 + ".png").collect(Collectors.toSet());
      BANNERS = PATTERNS.stream().map((var0) -> "textures/entity/banner/" + var0 + ".png").collect(Collectors.toSet());
