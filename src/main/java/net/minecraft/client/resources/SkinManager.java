...
public class SkinManager {
   ...
   public void registerSkins(GameProfile var1, SkinManager.SkinTextureCallback var2, boolean var3) {
      Runnable var4 = () -> {
         Map<Type, MinecraftProfileTexture> var4x = Maps.newHashMap();
   ...
   public Map<MinecraftProfileTexture.Type, MinecraftProfileTexture> getInsecureSkinInformation(GameProfile var1) {
      ...
      return (Map<MinecraftProfileTexture.Type, MinecraftProfileTexture>)(var2 == null ? ImmutableMap.of() : (Map)this.insecureSkinCache.getUnchecked(var2.getValue()));
   }
