   ...
   public void tick() {
      ...
      if (var1 != this.previousBiome) {
         ...
         var1.getAmbientLoop().ifPresent((var2) -> {
            LoopSoundInstance var10000 = (LoopSoundInstance)this.loopSounds.compute(var1, (var2x, var3) -> {
               if (var3 == null) {
      ...
      this.moodSettings.ifPresent((var1x) -> {
         ...
         if (this.moodiness >= 1.0F) {
            double var6 = (double)var4.getX() + (double)0.5F;
            double var8 = (double)var4.getY() + (double)0.5F;
            double var10 = (double)var4.getZ() + (double)0.5F;
