...
public class BubbleColumnAmbientSoundHandler implements AmbientSoundHandler {
   ...
   public void tick() {
      ...
      BlockState var2 = (BlockState)var1.getBlockStatesIfLoaded(this.player.getBoundingBox().inflate((double)0.0F, (double)-0.4F, (double)0.0F).deflate(0.001)).filter((var0) -> var0.is(Blocks.BUBBLE_COLUMN)).findFirst().orElse(null);
      if (var2 != null) {
