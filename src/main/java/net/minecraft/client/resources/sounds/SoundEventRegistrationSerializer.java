...
public class SoundEventRegistrationSerializer implements JsonDeserializer<SoundEventRegistration> {
   ...
   private List<Sound> getSounds(JsonObject var1) {
      List<Sound> var2 = Lists.newArrayList();
      if (var1.has("sounds")) {
         ...
         for(int var4 = 0; var4 < var3.size(); ++var4) {
            ...
            if (GsonHelper.isStringValue(var5)) {
               ...
               var2.add(new Sound(var6, 1.0F, 1.0F, 1, net.minecraft.client.resources.sounds.Sound.Type.FILE, false, false, 16));
            } else {
   ...
   private Sound getSound(JsonObject var1) {
      ...
      Sound.Type var3 = this.getType(var1, net.minecraft.client.resources.sounds.Sound.Type.FILE);
   ...
   private Sound.Type getType(JsonObject var1, Sound.Type var2) {
      ...
      if (var1.has("type")) {
         var3 = net.minecraft.client.resources.sounds.Sound.Type.getByName(GsonHelper.getAsString(var1, "type"));
