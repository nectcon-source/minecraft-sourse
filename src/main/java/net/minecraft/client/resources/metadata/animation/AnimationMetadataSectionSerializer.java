...
public class AnimationMetadataSectionSerializer implements MetadataSectionSerializer<AnimationMetadataSection> {
   ...
   public AnimationMetadataSection fromJson(JsonObject var1) {
      ...
      if (var1.has("frames")) {
         ...
         } catch (ClassCastException var4_1) {
            throw new JsonParseException("Invalid animation->frames: expected array, was " + var1.get("frames"), var4_1);
         }
      }
      ...
      return new AnimationMetadataSection(var2, var9, var10, var3, var11);
   }
