...
public class ArmorStandModel extends ArmorStandArmorModel {
   ...
   public void prepareMobModel(ArmorStand var1, float var2, float var3, float var4) {
      ...
      this.basePlate.yRot = ((float)Math.PI / 180F) * -Mth.rotLerp(var4, var1.yRotO, var1.yRot);
   ...
   public void setupAnim(ArmorStand var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.leftLeg.setPos(1.9F, 12.0F, 0.0F);
      this.rightLeg.setPos(-1.9F, 12.0F, 0.0F);
      this.bodyStick1.xRot = ((float)Math.PI / 180F) * var1.getBodyPose().getX();
      this.bodyStick1.yRot = ((float)Math.PI / 180F) * var1.getBodyPose().getY();
      this.bodyStick1.zRot = ((float)Math.PI / 180F) * var1.getBodyPose().getZ();
      this.bodyStick2.xRot = ((float)Math.PI / 180F) * var1.getBodyPose().getX();
      this.bodyStick2.yRot = ((float)Math.PI / 180F) * var1.getBodyPose().getY();
      this.bodyStick2.zRot = ((float)Math.PI / 180F) * var1.getBodyPose().getZ();
      this.shoulderStick.xRot = ((float)Math.PI / 180F) * var1.getBodyPose().getX();
      this.shoulderStick.yRot = ((float)Math.PI / 180F) * var1.getBodyPose().getY();
      this.shoulderStick.zRot = ((float)Math.PI / 180F) * var1.getBodyPose().getZ();
   }
