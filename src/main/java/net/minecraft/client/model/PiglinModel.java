...
public class PiglinModel<T extends Mob> extends PlayerModel<T> {
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      float var7 = ((float)Math.PI / 6F);
      float var8 = var4 * 0.1F + var2 * 0.5F;
      float var9 = 0.08F + var3 * 0.4F;
      this.earRight.zRot = (-(float)Math.PI / 6F) - Mth.cos(var8 * 1.2F) * var9;
      this.earLeft.zRot = ((float)Math.PI / 6F) + Mth.cos(var8) * var9;
      if (var1 instanceof AbstractPiglin) {
         ...
         if (var11 == PiglinArmPose.DANCING) {
            ...
            this.earLeft.zRot = ((float)Math.PI / 6F) + ((float)Math.PI / 180F) * Mth.sin(var12 * 30.0F) * 10.0F;
            this.earRight.zRot = (-(float)Math.PI / 6F) - ((float)Math.PI / 180F) * Mth.cos(var12 * 30.0F) * 10.0F;
            this.head.x = Mth.sin(var12 * 10.0F);
            this.head.y = Mth.sin(var12 * 40.0F) + 0.4F;
            this.rightArm.zRot = ((float)Math.PI / 180F) * (70.0F + Mth.cos(var12 * 40.0F) * 10.0F);
