...
public class TurtleModel<T extends Turtle> extends QuadrupedModel<T> {
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.leg1.xRot = Mth.cos(var2 * 0.6662F * 0.6F + (float)Math.PI) * 0.5F * var3;
      this.leg2.zRot = Mth.cos(var2 * 0.6662F * 0.6F + (float)Math.PI) * 0.5F * var3;
      ...
      if (!var1.isInWater() && var1.isOnGround()) {
         ...
         float var9 = 5.0F;
         this.leg2.yRot = Mth.cos(var7 * var2 * 5.0F + (float)Math.PI) * 8.0F * var3 * var8;
         this.leg2.zRot = 0.0F;
         this.leg3.yRot = Mth.cos(var7 * var2 * 5.0F) * 8.0F * var3 * var8;
         this.leg3.zRot = 0.0F;
         this.leg0.yRot = Mth.cos(var2 * 5.0F + (float)Math.PI) * 3.0F * var3;
         this.leg0.xRot = 0.0F;
   ...
   public void renderToBuffer(PoseStack var1, VertexConsumer var2, int var3, int var4, float var5, float var6, float var7, float var8) {
      ...
      if (var9) {
         var1.pushPose();
         var1.translate((double)0.0F, (double)-0.08F, (double)0.0F);
      }
