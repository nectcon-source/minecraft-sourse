...
public class StriderModel<T extends Strider> extends ListModel<T> {
   ...
   public void setupAnim(Strider var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      if (var1.getPassengers().size() <= 0) {
         this.body.xRot = var6 * ((float)Math.PI / 180F);
         this.body.yRot = var5 * ((float)Math.PI / 180F);
      } else {
         this.body.xRot = 0.0F;
         this.body.yRot = 0.0F;
      }
...
//      ModelPart var10000 = this.body;
      ...
      this.rightLeg.xRot = Mth.sin(var2 * 1.5F * 0.5F + (float)Math.PI) * 2.0F * var3;
      this.leftLeg.zRot = 0.17453292F * Mth.cos(var2 * 1.5F * 0.5F) * var3;
      this.rightLeg.zRot = 0.17453292F * Mth.cos(var2 * 1.5F * 0.5F + (float)Math.PI) * var3;
      this.leftLeg.y = 8.0F + 2.0F * Mth.sin(var2 * 1.5F * 0.5F + (float)Math.PI) * 2.0F * var3;
      ...
      float var8 = Mth.cos(var2 * 1.5F + (float)Math.PI) * var3;
//      var10000 = this.bristle0;
       this.bristle0.zRot += var8 * 1.3F;
//      var10000 = this.bristle1;
       this.bristle1.zRot += var8 * 1.2F;
//      var10000 = this.bristle2;
       this.bristle2.zRot += var8 * 0.6F;
//      var10000 = this.bristle3;
       this.bristle3.zRot += var8 * 0.6F;
//      var10000 = this.bristle4;
       this.bristle4.zRot += var8 * 1.2F;
//      var10000 = this.bristle5;
       this.bristle5.zRot += var8 * 1.3F;
//      float var9 = 1.0F;
//      float var10 = 1.0F;
//      var10000 = this.bristle0;
       this.bristle0.zRot += 0.05F * Mth.sin(var4 * 1.0F * -0.4F);
//      var10000 = this.bristle1;
       this.bristle1.zRot += 0.1F * Mth.sin(var4 * 1.0F * 0.2F);
//      var10000 = this.bristle2;
       this.bristle2.zRot += 0.1F * Mth.sin(var4 * 1.0F * 0.4F);
//      var10000 = this.bristle3;
       this.bristle3.zRot += 0.1F * Mth.sin(var4 * 1.0F * 0.4F);
//      var10000 = this.bristle4;
       this.bristle4.zRot += 0.1F * Mth.sin(var4 * 1.0F * 0.2F);
//      var10000 = this.bristle5;
       this.bristle5.zRot += 0.05F * Mth.sin(var4 * 1.0F * -0.4F);
   }
