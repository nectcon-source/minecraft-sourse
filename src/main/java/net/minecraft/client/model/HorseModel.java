...
public class HorseModel<T extends AbstractHorse> extends AgeableListModel<T> {
   ...
   public void prepareMobModel(T var1, float var2, float var3, float var4) {
      ...
      this.body.xRot = 0.0F;
      this.headParts.xRot = ((float)Math.PI / 6F) + var9;
      this.headParts.yRot = var8 * ((float)Math.PI / 180F);
      float var16 = var1.isInWater() ? 0.2F : 1.0F;
      float var17 = Mth.cos(var16 * var2 * 0.6662F + (float)Math.PI);
      float var18 = var17 * 0.8F * var3;
      float var19 = (1.0F - Math.max(var11, var10)) * (((float)Math.PI / 6F) + var9 + var13 * Mth.sin(var15) * 0.05F);
      this.headParts.xRot = var11 * (0.2617994F + var9) + var10 * (2.1816616F + Mth.sin(var15) * 0.05F) + var19;
      this.headParts.yRot = var11 * var8 * ((float)Math.PI / 180F) + (1.0F - Math.max(var11, var10)) * this.headParts.yRot;
      ...
      this.body.xRot = var11 * (-(float)Math.PI / 4F) + var12 * this.body.xRot;
      float var20 = 0.2617994F * var11;
      float var21 = Mth.cos(var15 * 0.6F + (float)Math.PI);
      this.leg3.y = 2.0F * var11 + 14.0F * var12;
      this.leg3.z = -6.0F * var11 - 10.0F * var12;
      this.leg4.y = this.leg3.y;
      this.leg4.z = this.leg3.z;
      float var22 = ((-(float)Math.PI / 3F) + var21) * var11 + var18 * var12;
      float var23 = ((-(float)Math.PI / 3F) - var21) * var11 - var18 * var12;
      ...
      this.tail.xRot = ((float)Math.PI / 6F) + var3 * 0.75F;
