...
public class RabbitModel<T extends Rabbit> extends EntityModel<T> {
   ...
   public void renderToBuffer(PoseStack var1, VertexConsumer var2, int var3, int var4, float var5, float var6, float var7, float var8) {
      if (this.young) {
         ...
         var1.translate((double)0.0F, (double)1.375F, (double)0.125F);
         ImmutableList.of(this.head, this.earLeft, this.earRight, this.nose).forEach((var8x) -> var8x.render(var1, var2, var3, var4, var5, var6, var7, var8));
         var1.popPose();
         var1.pushPose();
         var1.scale(0.4F, 0.4F, 0.4F);
         var1.translate((double)0.0F, (double)2.25F, (double)0.0F);
         ImmutableList.of(this.rearFootLeft, this.rearFootRight, this.haunchLeft, this.haunchRight, this.body, this.frontLegLeft, this.frontLegRight, this.tail).forEach((var8x) -> var8x.render(var1, var2, var3, var4, var5, var6, var7, var8));
         var1.popPose();
      } else {
         var1.pushPose();
         var1.scale(0.6F, 0.6F, 0.6F);
         var1.translate((double)0.0F, (double)1.0F, (double)0.0F);
         ImmutableList.of(this.rearFootLeft, this.rearFootRight, this.haunchLeft, this.haunchRight, this.body, this.frontLegLeft, this.frontLegRight, this.head, this.earRight, this.earLeft, this.tail, this.nose, new ModelPart[0]).forEach((var8x) -> var8x.render(var1, var2, var3, var4, var5, var6, var7, var8));
         var1.popPose();
      }
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.nose.xRot = var6 * ((float)Math.PI / 180F);
      this.head.xRot = var6 * ((float)Math.PI / 180F);
      this.earRight.xRot = var6 * ((float)Math.PI / 180F);
      this.earLeft.xRot = var6 * ((float)Math.PI / 180F);
      this.nose.yRot = var5 * ((float)Math.PI / 180F);
      ...
      this.jumpRotation = Mth.sin(var1.getJumpCompletion(var7) * (float)Math.PI);
   ...
   public void prepareMobModel(T var1, float var2, float var3, float var4) {
      ...
      this.jumpRotation = Mth.sin(var1.getJumpCompletion(var4) * (float)Math.PI);
   }
}
