...
//      var10000 = this.leg1;
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      this.leg1.xRot = Mth.cos(var2 * 0.6662F + (float)Math.PI) * 1.4F * var3;
      this.leg2.xRot = Mth.cos(var2 * 0.6662F + (float)Math.PI) * 1.4F * var3;
...
//         float var11 = 1.1F;
         ...
         var1.translate(0.0F, 2.0625F, 0.0F);
         ImmutableList.of(this.leg0, this.leg1, this.leg2, this.leg3, this.chest1, this.chest2).forEach((var8x) -> var8x.render(var1, var2, var3, var4, var5, var6, var7, var8));
         var1.popPose();
      } else {
         ImmutableList.of(this.head, this.body, this.leg0, this.leg1, this.leg2, this.leg3, this.chest1, this.chest2).forEach((var8x) -> var8x.render(var1, var2, var3, var4, var5, var6, var7, var8));
      }
