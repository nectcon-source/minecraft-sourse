...
public class ModelPart {
   ...
   private void addBox(int var1, int var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, boolean var12, boolean var13) {
      this.cubes.add(new Cube(var1, var2, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12, this.xTexSize, this.yTexSize));
   }
   ...
   private void compile(PoseStack.Pose var1, VertexConsumer var2, int var3, int var4, float var5, float var6, float var7, float var8) {
      ...
      while(var11.hasNext()) {
         Cube var12 = (Cube)var11.next();

         for(Polygon var16 : var12.polygons) {
            ...
            for(int var21 = 0; var21 < 4; ++var21) {
               Vertex var22 = var16.vertices[var21];
   ...
   public Cube getRandomCube(Random var1) {
   ...
   public static class Cube {
      ...
      public Cube(int var1, int var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, float var11, boolean var12, float var13, float var14) {
         ...
         Vertex var41 = new Vertex(var3, var4, var5, 0.0F, 0.0F);
         ...
         this.polygons[2] = new Polygon(new Vertex[]{var23, var22, var41, var19}, var27, var32, var28, var33, var13, var14, var12, Direction.DOWN);
         this.polygons[3] = new Polygon(new Vertex[]{var20, var21, var25, var24}, var28, var33, var29, var32, var13, var14, var12, Direction.UP);
         this.polygons[1] = new Polygon(new Vertex[]{var41, var22, var25, var21}, var26, var33, var27, var34, var13, var14, var12, Direction.WEST);
         this.polygons[4] = new Polygon(new Vertex[]{var19, var41, var21, var20}, var27, var33, var28, var34, var13, var14, var12, Direction.NORTH);
