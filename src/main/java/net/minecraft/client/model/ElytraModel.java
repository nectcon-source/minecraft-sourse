...
public class ElytraModel<T extends LivingEntity> extends AgeableListModel<T> {
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      if (var1.isFallFlying()) {
         ...
         if (var12.y < (double)0.0F) {
            Vec3 var13 = var12.normalize();
            var11 = 1.0F - (float)Math.pow(-var13.y, (double)1.5F);
         }

         var7 = var11 * 0.34906584F + (1.0F - var11) * var7;
         var8 = var11 * (-(float)Math.PI / 2F) + (1.0F - var11) * var8;
      } else if (var1.isCrouching()) {
         var7 = 0.6981317F;
         var8 = (-(float)Math.PI / 4F);
         var9 = 3.0F;
         var10 = 0.08726646F;
      }
      ...
      if (var1 instanceof AbstractClientPlayer) {
         ...
         var14.elytraRotX = (float)((double)var14.elytraRotX + (double)(var7 - var14.elytraRotX) * 0.1);
         var14.elytraRotY = (float)((double)var14.elytraRotY + (double)(var10 - var14.elytraRotY) * 0.1);
         var14.elytraRotZ = (float)((double)var14.elytraRotZ + (double)(var8 - var14.elytraRotZ) * 0.1);
