...
public class PhantomModel<T extends Entity> extends ListModel<T> {
   ...
   public void setupAnim(T var1, float var2, float var3, float var4, float var5, float var6) {
      ...
      float var8 = 16.0F;
      this.leftWingBase.zRot = Mth.cos(var7) * 16.0F * ((float)Math.PI / 180F);
      this.leftWingTip.zRot = Mth.cos(var7) * 16.0F * ((float)Math.PI / 180F);
      this.rightWingBase.zRot = -this.leftWingBase.zRot;
      this.rightWingTip.zRot = -this.leftWingTip.zRot;
      this.tailBase.xRot = -(5.0F + Mth.cos(var7 * 2.0F) * 5.0F) * ((float)Math.PI / 180F);
      this.tailTip.xRot = -(5.0F + Mth.cos(var7 * 2.0F) * 5.0F) * ((float)Math.PI / 180F);
   }
}
