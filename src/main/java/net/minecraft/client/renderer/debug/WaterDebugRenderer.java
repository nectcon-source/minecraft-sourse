...
public class WaterDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      LevelReader var10 = this.minecraft.player.level;
      ...
      for(BlockPos var17 : BlockPos.betweenClosed(var9.offset(-10, -10, -10), var9.offset(10, 10, 10))) {
         ...
         if (var18.is(FluidTags.WATER)) {
            DebugRenderer.renderFloatingText(String.valueOf(var18.getAmount()), (double)var17.getX() + (double)0.5F, (double)((float)var17.getY() + var18.getHeight(var10, var17)), (double)var17.getZ() + (double)0.5F, -16777216);
         }
      }
