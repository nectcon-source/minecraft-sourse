...
public class DebugRenderer {
   ...
   public static Optional<Entity> getTargetedEntity(@Nullable Entity var0, int var1) {
      if (var0 == null) {
         ...
         AABB var5 = var0.getBoundingBox().expandTowards(var3).inflate((double)1.0F);
         int var6 = var1 * var1;
         Predicate<Entity> var7 = (var0x) -> !var0x.isSpectator() && var0x.isPickable();
   ...
   public static void renderFloatingText(String var0, int var1, int var2, int var3, int var4) {
      renderFloatingText(var0, (double)var1 + (double)0.5F, (double)var2 + (double)0.5F, (double)var3 + (double)0.5F, var4);
   }
