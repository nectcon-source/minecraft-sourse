...
public class HeightMapRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      LevelAccessor var9 = this.minecraft.level;
      RenderSystem.pushMatrix();
      RenderSystem.disableBlend();
      RenderSystem.disableTexture();
      RenderSystem.enableDepthTest();
      BlockPos var10 = new BlockPos(var3, 0.0F, var7);
      ...
      for(int var13 = -32; var13 <= 32; var13 += 16) {
         for(int var14 = -32; var14 <= 32; var14 += 16) {
            ...
            for(Map.Entry<Heightmap.Types, Heightmap> var17 : var15.getHeightmaps()) {
               Heightmap.Types var18 = var17.getKey();
               ...
               for(int var21 = 0; var21 < 16; ++var21) {
                  for(int var22 = 0; var22 < 16; ++var22) {
                     ...
                     LevelRenderer.addChainedFilledBoxVertices(var12, (double)((float)var23 + 0.25F) - var3, var25, (double)((float)var24 + 0.25F) - var7, (double)((float)var23 + 0.75F) - var3, (var25 + 0.09375F), (double)((float)var24 + 0.75F) - var7, var20.x(), var20.y(), var20.z(), 1.0F);
                  }
               }
            }
         }
