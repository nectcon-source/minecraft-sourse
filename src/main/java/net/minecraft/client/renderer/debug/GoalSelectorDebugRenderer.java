...
public class GoalSelectorDebugRenderer implements DebugRenderer.SimpleDebugRenderer {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, double var3, double var5, double var7) {
      ...
      BlockPos var10x = new BlockPos(var9.getPosition().x, 0.0, var9.getPosition().z);
      this.goalSelectors.forEach((var1x, var2x) -> {
         for(int var3x = 0; var3x < var2x.size(); ++var3x) {
            GoalSelectorDebugRenderer.DebugGoal var4x = var2x.get(var3x);
            if (var10x.closerThan(var4x.pos, 160.0)) {
               double var5xx = (double)var4x.pos.getX() + 0.5;
               double var7xxx = (double)var4x.pos.getY() + 2.0 + (double)var3x * 0.25;
               double var9xxxx = (double)var4x.pos.getZ() + 0.5;
               int var11xxxxx = var4x.isRunning ? -16711936 : -3355444;
               DebugRenderer.renderFloatingText(var4x.name, var5xx, var7xxx, var9xxxx, var11xxxxx);
            }
         }
      });
