...
public class BlockElement {
   ...
   private void fillUvs() {
      for(Map.Entry<Direction, BlockElementFace> var2 : this.faces.entrySet()) {
   ...
   public static class Deserializer implements JsonDeserializer<BlockElement> {
      ...
      public BlockElement deserialize(JsonElement var1, Type var2, JsonDeserializationContext var3) throws JsonParseException {
         ...
         Map<Direction, BlockElementFace> var8 = this.getFaces(var3, var4);
      ...
      private Map<Direction, BlockElementFace> getFaces(JsonDeserializationContext var1, JsonObject var2) {
         Map<Direction, BlockElementFace> var3 = this.filterNullFromFaces(var1, var2);
         if (var3.isEmpty()) {
      ...
      private Map<Direction, BlockElementFace> filterNullFromFaces(JsonDeserializationContext var1, JsonObject var2) {
         Map<Direction, BlockElementFace> var3 = Maps.newEnumMap(Direction.class);
