...
public class ModelBlockRenderer {
   ...
   public boolean tesselateBlock(
      ...
      } catch (Throwable var14_1) {
         CrashReport var15 = CrashReport.forThrowable(var14_1, "Tesselating block model");
   ...
   public boolean tesselateWithAO(
      ...
      AmbientOcclusionFace var15 = new AmbientOcclusionFace();

      for(Direction var19 : Direction.values()) {
         var8.setSeed(var9);
         List<BakedQuad> var20 = var2.getQuads(var3, var19, var8);
      ...
      var8.setSeed(var9);
      List<BakedQuad> var21 = var2.getQuads(var3, (Direction)null, var8);
      if (!var21.isEmpty()) {
   ...
   public boolean tesselateWithoutAO(
      ...
      for(Direction var17 : Direction.values()) {
         var8.setSeed(var9);
         List<BakedQuad> var18 = var2.getQuads(var3, var17, var8);
      ...
      var8.setSeed(var9);
      List<BakedQuad> var20 = var2.getQuads(var3, (Direction)null, var8);
      if (!var20.isEmpty()) {
   ...
   private void calculateShape(BlockAndTintGetter var1, BlockState var2, BlockPos var3, int[] var4, Direction var5, @Nullable float[] var6, BitSet var7) {
      ...
      if (var6 != null) {
         ...
         int var18 = Direction.values().length;
   ...
   class AmbientOcclusionFace {
      ...
      public void calculate(BlockAndTintGetter var1, BlockState var2, BlockPos var3, Direction var4, float[] var5, BitSet var6, boolean var7) {
         ...
         if (!var26 && !var24) {
            ...
            BlockState var36 = var1.getBlockState(var10);
         ...
         if (!var27 && !var24) {
            ...
            BlockState var64 = var1.getBlockState(var10);
            var29 = var11.getShadeBrightness(var64, var1, var10);
            var33 = var11.getLightColor(var64, var1, var10);
         }
         ...
         if (!var26 && !var25) {
            ...
            BlockState var65 = var1.getBlockState(var10);
            var30 = var11.getShadeBrightness(var65, var1, var10);
            var34 = var11.getLightColor(var65, var1, var10);
         }
         ...
         if (!var27 && !var25) {
            ...
            BlockState var66 = var1.getBlockState(var10);
            var31 = var11.getShadeBrightness(var66, var1, var10);
            var35 = var11.getLightColor(var66, var1, var10);
         }

         int var67 = var11.getLightColor(var2, var1, var3);
         var10.setWithOffset(var3, var4);
         BlockState var37 = var1.getBlockState(var10);
         if (var6.get(0) || !var37.isSolidRender(var1, var10)) {
            var67 = var11.getLightColor(var37, var1, var10);
         }
         ...
         AmbientVertexRemap var39 = ModelBlockRenderer.AmbientVertexRemap.fromFacing(var4);
         if (var6.get(1) && var9.doNonCubicWeight) {
            float var68 = (var23 + var14 + var29 + var38) * 0.25F;
            float var70 = (var20 + var14 + var28 + var38) * 0.25F;
            float var72 = (var20 + var17 + var30 + var38) * 0.25F;
            float var73 = (var23 + var17 + var31 + var38) * 0.25F;
            ...
            this.brightness[var39.vert0] = var68 * var44 + var70 * var45 + var72 * var46 + var73 * var47;
            this.brightness[var39.vert1] = var68 * var48 + var70 * var49 + var72 * var50 + var73 * var51;
            this.brightness[var39.vert2] = var68 * var52 + var70 * var53 + var72 * var54 + var73 * var55;
            this.brightness[var39.vert3] = var68 * var56 + var70 * var57 + var72 * var58 + var73 * var59;
            int var60 = this.blend(var22, var13, var33, var67);
            int var61 = this.blend(var19, var13, var32, var67);
            int var62 = this.blend(var19, var16, var34, var67);
            int var63 = this.blend(var22, var16, var35, var67);
            ...
            float var40 = (var23 + var14 + var29 + var38) * 0.25F;
            float var41 = (var20 + var14 + var28 + var38) * 0.25F;
            float var42 = (var20 + var17 + var30 + var38) * 0.25F;
            float var43 = (var23 + var17 + var31 + var38) * 0.25F;
            this.lightmap[var39.vert0] = this.blend(var22, var13, var33, var67);
            this.lightmap[var39.vert1] = this.blend(var19, var13, var32, var67);
            this.lightmap[var39.vert2] = this.blend(var19, var16, var34, var67);
            this.lightmap[var39.vert3] = this.blend(var22, var16, var35, var67);
         ...
         float var69 = var1.getShade(var4, var7);

         for(int var71 = 0; var71 < this.brightness.length; ++var71) {
            this.brightness[var71] *= var69;
         }
      }
