      ...
      if (var2 == null) {
         ...
         if (var5.isEmpty()) {
            ...
            if (var5.size() == 1) {
               ...
               List<Predicate<BlockState>> var7 = var5.stream().map((var3x) -> this.getBlockStatePredicate(var1, var2, var3x)).collect(Collectors.toList());
               var6 = (var1x) -> var7.stream().anyMatch((var1_) -> var1_.test(var1x));
            }
