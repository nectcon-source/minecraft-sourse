...
public class ItemModelGenerator {
   ...
   public BlockModel generateBlockModel(Function<Material, TextureAtlasSprite> var1, BlockModel var2) {
      ...
      for(int var5 = 0; var5 < LAYERS.size(); ++var5) {
         ...
         TextureAtlasSprite var8 = var1.apply(var7);
         var4.addAll(this.processFrames(var5, var6, var8));
      }

      var3.put("particle", var2.hasTexture("particle") ? Either.left(var2.getMaterial("particle")) : var3.get("layer0"));
   ...
   private List<ItemModelGenerator.Span> getSpans(TextureAtlasSprite var1) {
      ...
      List<Span> var4 = Lists.newArrayList();
