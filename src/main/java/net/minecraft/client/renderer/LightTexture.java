         ...
         if (var2 != null) {
            ...
            for(int var10 = 0; var10 < 16; ++var10) {
               for(int var11 = 0; var11 < 16; ++var11) {
                  ...
                  float var14_1 = this.getBrightness(var2, var11) * var8;
                  float var15 = var14_1 * ((var14_1 * 0.6F + 0.4F) * 0.6F + 0.4F);
                  float var16 = var14_1 * (var14_1 * var14_1 * 0.6F + 0.4F);
                  var9.set(var14_1, var15, var16);
                  if (var2.effects().forceBrightLightmap()) {
                     ...
                     if (this.renderer.getDarkenWorldAmount(var1) > 0.0F) {
                        float var18 = this.renderer.getDarkenWorldAmount(var1);
                        Vector3f var19 = var9.copy();
                  ...
                  if (var5 > 0.0F) {
                     float var23 = Math.max(var9.x(), Math.max(var9.y(), var9.z()));
                     if (var23 < 1.0F) {
                        float var25 = 1.0F / var23;
                        Vector3f var27 = var9.copy();
                        var27.mul(var25);
                        var9.lerp(var27, var5);
                     }
                  }

                  float var24 = (float)this.minecraft.options.gamma;
                  Vector3f var26 = var9.copy();
                  var26.map(this::notGamma);
                  var9.lerp(var26, var24);
                  var9.lerp(new Vector3f(0.75F, 0.75F, 0.75F), 0.04F);
                  var9.clamp(0.0F, 1.0F);
                  var9.mul(255.0F);
                  int var28 = 255;
