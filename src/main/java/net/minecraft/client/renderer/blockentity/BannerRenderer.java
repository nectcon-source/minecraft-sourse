...
public class BannerRenderer extends BlockEntityRenderer<BannerBlockEntity> {
   ...
   public void render(BannerBlockEntity var1, float var2, PoseStack var3, MultiBufferSource var4, int var5, int var6) {
      List<Pair<BannerPattern, DyeColor>> var7 = var1.getPatterns();
      if (var7 != null) {
         ...
         if (var9) {
            var10 = 0L;
            var3.translate((double)0.5F, (double)0.5F, (double)0.5F);
            ...
            if (var12.getBlock() instanceof BannerBlock) {
               ...
               float var13 = (float)(-(Integer)var12.getValue(BannerBlock.ROTATION) * 360) / 16.0F;
         ...
         this.flag.xRot = (-0.0125F + 0.01F * Mth.cos(((float)Math.PI * 2F) * var14)) * (float)Math.PI;
         this.flag.y = -32.0F;
   ...
   public static void renderPatterns(
      ...
      for(int var9 = 0; var9 < 17 && var9 < var7.size(); ++var9) {
         Pair<BannerPattern, DyeColor> var10 = (Pair)var7.get(var9);
