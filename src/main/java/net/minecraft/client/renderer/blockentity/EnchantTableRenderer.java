...
public class EnchantTableRenderer extends BlockEntityRenderer<EnchantmentTableBlockEntity> {
   ...
   public void render(EnchantmentTableBlockEntity var1, float var2, PoseStack var3, MultiBufferSource var4, int var5, int var6) {
      var3.pushPose();
      var3.translate((double)0.5F, (double)0.75F, (double)0.5F);
      float var7 = (float)var1.time + var2;
      var3.translate((double)0.0F, (double)(0.1F + Mth.sin(var7 * 0.1F) * 0.01F), (double)0.0F);

      float var8;
      for(var8 = var1.rot - var1.oRot; var8 >= (float)Math.PI; var8 -= ((float)Math.PI * 2F)) {
      }

      while(var8 < -(float)Math.PI) {
         var8 += ((float)Math.PI * 2F);
      }
