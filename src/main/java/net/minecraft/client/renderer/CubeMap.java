...
public class CubeMap {
   ...
   public void render(Minecraft var1, float var2, float var3, float var4) {
      ...
      RenderSystem.multMatrix(Matrix4f.perspective((double)85.0F, (float)var1.getWindow().getWidth() / (float)var1.getWindow().getHeight(), 0.05F, 10.0F));
      ...
      for(int var8 = 0; var8 < 4; ++var8) {
         ...
         for(int var12 = 0; var12 < 6; ++var12) {
            ...
            if (var12 == 0) {
               var6.vertex((double)-1.0F, (double)-1.0F, (double)1.0F).uv(0.0F, 0.0F).color(255, 255, 255, var13).endVertex();
               var6.vertex((double)-1.0F, (double)1.0F, (double)1.0F).uv(0.0F, 1.0F).color(255, 255, 255, var13).endVertex();
               var6.vertex((double)1.0F, (double)1.0F, (double)1.0F).uv(1.0F, 1.0F).color(255, 255, 255, var13).endVertex();
               var6.vertex((double)1.0F, (double)-1.0F, (double)1.0F).uv(1.0F, 0.0F).color(255, 255, 255, var13).endVertex();
            }
