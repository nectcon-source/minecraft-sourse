...
public abstract class RenderType extends RenderStateShard {
   ...
   public static RenderType armorCutoutNoCull(ResourceLocation var0) {
      CompositeState var1 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setTransparencyState(NO_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setCullState(NO_CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setLayeringState(VIEW_OFFSET_Z_LAYERING).createCompositeState(true);
   ...
   public static RenderType entitySolid(ResourceLocation var0) {
      CompositeState var1 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setTransparencyState(NO_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(true);
   ...
   public static RenderType entityCutout(ResourceLocation var0) {
      CompositeState var1 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setTransparencyState(NO_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(true);
   ...
   public static RenderType itemEntityTranslucentCull(ResourceLocation var0) {
      CompositeState var1 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setOutputState(ITEM_ENTITY_TARGET).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setWriteMaskState(RenderStateShard.COLOR_DEPTH_WRITE).createCompositeState(true);
   ...
   public static RenderType entityTranslucentCull(ResourceLocation var0) {
      CompositeState var1 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(true);
   ...
   public static RenderType entitySmoothCutout(ResourceLocation var0) {
      CompositeState var1 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setAlphaState(MIDWAY_ALPHA).setDiffuseLightingState(DIFFUSE_LIGHTING).setShadeModelState(SMOOTH_SHADE).setCullState(NO_CULL).setLightmapState(LIGHTMAP).createCompositeState(true);
   ...
   public static RenderType beaconBeam(ResourceLocation var0, boolean var1) {
      CompositeState var2 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setTransparencyState(var1 ? TRANSLUCENT_TRANSPARENCY : NO_TRANSPARENCY).setWriteMaskState(var1 ? COLOR_WRITE : COLOR_DEPTH_WRITE).setFogState(NO_FOG).createCompositeState(false);
   ...
   public static RenderType entityDecal(ResourceLocation var0) {
      CompositeState var1 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setDepthTestState(EQUAL_DEPTH_TEST).setCullState(NO_CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).createCompositeState(false);
   ...
   public static RenderType entityNoOutline(ResourceLocation var0) {
      CompositeState var1 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setCullState(NO_CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setWriteMaskState(COLOR_WRITE).createCompositeState(false);
   ...
   public static RenderType entityShadow(ResourceLocation var0) {
      CompositeState var1 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setTransparencyState(TRANSLUCENT_TRANSPARENCY).setDiffuseLightingState(DIFFUSE_LIGHTING).setAlphaState(DEFAULT_ALPHA).setCullState(CULL).setLightmapState(LIGHTMAP).setOverlayState(OVERLAY).setWriteMaskState(COLOR_WRITE).setDepthTestState(LEQUAL_DEPTH_TEST).setLayeringState(VIEW_OFFSET_Z_LAYERING).createCompositeState(false);
   ...
   public static RenderType dragonExplosionAlpha(ResourceLocation var0, float var1) {
      CompositeState var2 = RenderType.CompositeState.builder().setTextureState(new RenderStateShard.TextureStateShard(var0, false, false)).setAlphaState(new RenderStateShard.AlphaStateShard(var1)).setCullState(NO_CULL).createCompositeState(true);
   ...
   public static CompositeRenderType create(String var0, VertexFormat var1, int var2, int var3, CompositeState var4) {
      return create(var0, var1, var2, var3, false, false, var4);
   }

   public static CompositeRenderType create(String var0, VertexFormat var1, int var2, int var3, boolean var4, boolean var5, CompositeState var6) {
   ...
   public static final class CompositeState {
      ...
      public boolean equals(Object var1) {
         if (this == var1) {
            ...
            CompositeState var2 = (CompositeState)var1;
      ...
      public static class CompositeStateBuilder {
         ...
         public CompositeStateBuilder setTextureState(RenderStateShard.TextureStateShard var1) {
            this.textureState = var1;
            return this;
         }
         ...
         public CompositeStateBuilder setDiffuseLightingState(RenderStateShard.DiffuseLightingStateShard var1) {
            this.diffuseLightingState = var1;
            return this;
         }

         public CompositeStateBuilder setShadeModelState(RenderStateShard.ShadeModelStateShard var1) {
            this.shadeModelState = var1;
            return this;
         }

         public CompositeStateBuilder setAlphaState(RenderStateShard.AlphaStateShard var1) {
         ...
         public CompositeStateBuilder setFogState(RenderStateShard.FogStateShard var1) {
            this.fogState = var1;
            return this;
         }
   ...
   static final class CompositeRenderType extends RenderType {
      ...
      private CompositeRenderType(String var1, VertexFormat var2, int var3, int var4, boolean var5, boolean var6, CompositeState var7) {
         ...
         this.state = var7;
         this.outline = var7.outlineProperty == RenderType.OutlineProperty.AFFECTS_OUTLINE ? var7.textureState.texture().map((var1x) -> outline(var1x, var7.cullState)) : Optional.empty();
      ...
      private static CompositeRenderType memoize(String var0, VertexFormat var1, int var2, int var3, boolean var4, boolean var5, CompositeState var6) {
         return (CompositeRenderType)INSTANCES.addOrGet(new CompositeRenderType(var0, var1, var2, var3, var4, var5, var6));
      }
      ...
      static enum EqualsStrategy implements Hash.Strategy<CompositeRenderType> {
         ...
         public int hashCode(@Nullable CompositeRenderType var1) {
            return var1 == null ? 0 : var1.hashCode;
         }

         public boolean equals(@Nullable CompositeRenderType var1, @Nullable CompositeRenderType var2) {
            if (var1 == var2) {
               return true;
            } else {
