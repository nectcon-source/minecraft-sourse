...
public class PostPass implements AutoCloseable {
   ...
   public void process(float var1) {
      ...
      var5.vertex((double)0.0F, (double)0.0F, (double)500.0F).color(255, 255, 255, 255).endVertex();
      var5.vertex((double)var2, (double)0.0F, (double)500.0F).color(255, 255, 255, 255).endVertex();
      var5.vertex((double)var2, (double)var3, (double)500.0F).color(255, 255, 255, 255).endVertex();
      var5.vertex((double)0.0F, (double)var3, (double)500.0F).color(255, 255, 255, 255).endVertex();
      var5.end();
