...
public class EffectInstance implements Effect, AutoCloseable {
   ...
   public EffectInstance(ResourceManager var1, String var2) throws IOException {
      ...
      try {
         ...
         JsonObject var5 = GsonHelper.parse(new InputStreamReader(var4.getInputStream(), StandardCharsets.UTF_8));
         String var6 = GsonHelper.getAsString(var5, "vertex");
         String var27 = GsonHelper.getAsString(var5, "fragment");
         JsonArray var28 = GsonHelper.getAsJsonArray(var5, "samplers", (JsonArray)null);
         if (var28 != null) {
            int var9 = 0;

            for(JsonElement var11 : var28) {
               try {
                  this.parseSamplerNode(var11);
               } catch (Exception var12_1) {
                  ChainedJsonException var13 = ChainedJsonException.forException(var12_1);
         ...
         JsonArray var31 = GsonHelper.getAsJsonArray(var5, "uniforms", (JsonArray)null);
         if (var31 != null) {
            int var33 = 0;
            ...
            for(JsonElement var37 : var31) {
               ...
               } catch (Exception var14_4) {
                  ChainedJsonException var15 = ChainedJsonException.forException(var14_4);
                  var15.prependJsonKey("uniforms[" + var33 + "]");
                  throw var15;
               }
         ...
         this.vertexProgram = getOrCreate(var1, Type.VERTEX, var6);
         this.fragmentProgram = getOrCreate(var1, Type.FRAGMENT, var27);
         this.programId = ProgramManager.createProgram();
         ProgramManager.linkProgram(this);
         this.updateLocations();
         if (this.attributeNames != null) {
            for(String var36 : this.attributeNames) {
               int var38 = Uniform.glGetAttribLocation(this.programId, var36);
         ...
         ChainedJsonException var8 = ChainedJsonException.forException(var6_1);
      ...
      if (var7.size() != var5 && var7.size() > 1) {
         ...
         for(JsonElement var10 : var7) {
            try {
               ...
               ChainedJsonException var12 = ChainedJsonException.forException(var11_1);
