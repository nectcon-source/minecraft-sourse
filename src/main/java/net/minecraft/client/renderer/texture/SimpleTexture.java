   ...
   public static class TextureImage implements Closeable {
      ...
      public static TextureImage load(ResourceManager var0, ResourceLocation var1) {
         try (Resource var2 = var0.getResource(var1)) {
            ...
            } catch (RuntimeException var6_1) {
               SimpleTexture.LOGGER.warn("Failed reading metadata of: {}", var1, var6_1);
            }

            TextureImage var6 = new TextureImage(var5, var4);
            return var6;
         } catch (IOException var2_1) {
            return new TextureImage(var2_1);
         }
      }
