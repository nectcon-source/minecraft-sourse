...
public class Stitcher {
   ...
   public void gatherSprites(Stitcher.SpriteLoader var1) {
      for(Stitcher.Region var3 : this.storage) {
         var3.walk(var2 -> {
            ...
            TextureAtlasSprite.Info var4x = var3x.spriteInfo;
            var1.load(var4x, this.storageX, this.storageY, var2.getX(), var2.getY());
         });
      }
   }
   ...
   private boolean expand(Stitcher.Holder var1) {
      ...
      int var4x = Mth.smallestEncompassingPowerOfTwo(this.storageY);
      int var5xx = Mth.smallestEncompassingPowerOfTwo(this.storageX + var1.width);
      int var6xxx = Mth.smallestEncompassingPowerOfTwo(this.storageY + var1.height);
      boolean var7xxxx = var5xx <= this.maxWidth;
      boolean var8xxxxx = var6xxx <= this.maxHeight;
      if (!var7xxxx && !var8xxxxx) {
         return false;
      } else {
         boolean var9x = var7xxxx && var3 != var5xx;
         boolean var10xx = var8xxxxx && var4x != var6xxx;
         boolean var2;
         if (var9x ^ var10xx) {
            var2 = var9x;
         } else {
            var2 = var7xxxx && var3 <= var4x;
         }
