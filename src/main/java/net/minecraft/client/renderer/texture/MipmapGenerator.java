...
public class MipmapGenerator {
         ...
         for(int var11 = 1; var11 <= var1; ++var11) {
            ...
            for(int var9 = 0; var9 < var7; ++var9) {
               for(int var10 = 0; var10 < var8; ++var10) {
                  var6.setPixelRGBA(var9, var10, alphaBlend(var12.getPixelRGBA(var9 * 2 + 0, var10 * 2 + 0), var12.getPixelRGBA(var9 * 2 + 1, var10 * 2 + 0), var12.getPixelRGBA(var9 * 2 + 0, var10 * 2 + 1), var12.getPixelRGBA(var9 * 2 + 1, var10 * 2 + 1), var3));
               }
            }
   ...
   private static int alphaBlend(int var0, int var1, int var2, int var3, boolean var4) {
      if (var4) {
         ...
         var17 /= 4.0F;
         var19 /= 4.0F;
         int var9 = (int)(Math.pow((double)var13, 0.45454545454545453) * (double)255.0F);
         int var10 = (int)(Math.pow((double)var15, 0.45454545454545453) * (double)255.0F);
         int var11 = (int)(Math.pow((double)var17, 0.45454545454545453) * (double)255.0F);
         int var12 = (int)(Math.pow((double)var19, 0.45454545454545453) * (double)255.0F);
         if (var9 < 96) {
            var9 = 0;
         }
   ...
   private static int gammaBlend(int var0, int var1, int var2, int var3, int var4) {
      ...
      float var9 = (float)((double)((float)Math.pow((double)(var5 + var6 + var7 + var8) * (double)0.25F, 0.45454545454545453)));
      return (int)((double)var9 * (double)255.0F);
   }
