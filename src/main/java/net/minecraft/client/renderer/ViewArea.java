...
public class ViewArea {
   ...
   protected void createChunks(ChunkRenderDispatcher var1) {
      ...
      for(int var3x = 0; var3x < this.chunkGridSizeX; ++var3x) {
         for(int var4xx = 0; var4xx < this.chunkGridSizeY; ++var4xx) {
            for(int var5xxx = 0; var5xxx < this.chunkGridSizeZ; ++var5xxx) {
               int var6xxxx = this.getChunkIndex(var3x, var4xx, var5xxx);
               this.chunks[var6xxxx] = var1.new RenderChunk();
               this.chunks[var6xxxx].setOrigin(var3x * 16, var4xx * 16, var5xxx * 16);
            }
         }
      }
   }
