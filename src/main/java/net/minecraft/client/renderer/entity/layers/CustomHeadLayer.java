   ...
   public void render(PoseStack var1, MultiBufferSource var2, int var3, T var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      ...
      if (!var11.isEmpty()) {
         ...
         if (var12 instanceof BlockItem && ((BlockItem)var12).getBlock() instanceof AbstractSkullBlock) {
            ...
            if (var11.hasTag()) {
               ...
               if (var16.contains("SkullOwner", 10)) {
                  ...
                  if (!StringUtils.isBlank(var17)) {
                     var20 = SkullBlockEntity.updateGameprofile(new GameProfile((UUID)null, var17));
                     var16.put("SkullOwner", NbtUtils.writeGameProfile(new CompoundTag(), var20));
                  }
               }
            }

            var1.translate((double)-0.5F, (double)0.0F, (double)-0.5F);
            SkullBlockRenderer.renderSkull((Direction)null, 180.0F, ((AbstractSkullBlock)((BlockItem)var12).getBlock()).getType(), var20, var5, var1, var2, var3);
            ...
            Minecraft.getInstance().getItemInHandRenderer().renderItem(var4, var11, TransformType.HEAD, false, var1, var2, var3);
         }
