...
public class BeeStingerLayer<T extends LivingEntity, M extends PlayerModel<T>> extends StuckInBodyLayer<T, M> {
   ...
   protected void renderStuckItem(PoseStack var1, MultiBufferSource var2, int var3, Entity var4, float var5, float var6, float var7, float var8) {
      ...
      float var10 = (float)(Math.atan2((double)var5, (double)var7) * (double)(180F / (float)Math.PI));
      float var11 = (float)(Math.atan2((double)var6, (double)var9) * (double)(180F / (float)Math.PI));
      var1.translate((double)0.0F, (double)0.0F, (double)0.0F);
      ...
      var1.translate((double)2.5F, (double)0.0F, (double)0.0F);
