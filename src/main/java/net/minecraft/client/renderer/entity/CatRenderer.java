...
public class CatRenderer extends MobRenderer<Cat, CatModel<Cat>> {
   ...
   protected void setupRotations(Cat var1, PoseStack var2, float var3, float var4, float var5) {
      ...
      if (var6 > 0.0F) {
         ...
         for(Player var10 : var1.level.getEntitiesOfClass(Player.class, (new AABB(var7)).inflate((double)2.0F, (double)2.0F, (double)2.0F))) {
            if (var10.isSleeping()) {
               var2.translate((double)(0.15F * var6), (double)0.0F, (double)0.0F);
               break;
            }
         }
      }
