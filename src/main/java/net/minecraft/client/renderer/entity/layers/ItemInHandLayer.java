...
public class ItemInHandLayer<T extends LivingEntity, M extends EntityModel<T> & ArmedModel> extends RenderLayer<T, M> {
   ...
   public void render(PoseStack var1, MultiBufferSource var2, int var3, T var4, float var5, float var6, float var7, float var8, float var9, float var10) {
      ...
      if (!var12.isEmpty() || !var13.isEmpty()) {
         ...
         if (this.getParentModel().young) {
            float var14 = 0.5F;
            var1.translate((double)0.0F, (double)0.75F, (double)0.0F);
            var1.scale(0.5F, 0.5F, 0.5F);
         }

         this.renderArmWithItem(var4, var13, TransformType.THIRD_PERSON_RIGHT_HAND, HumanoidArm.RIGHT, var1, var2, var3);
         this.renderArmWithItem(var4, var12, TransformType.THIRD_PERSON_LEFT_HAND, HumanoidArm.LEFT, var1, var2, var3);
         var1.popPose();
      }
   }
   ...
   private void renderArmWithItem(LivingEntity var1, ItemStack var2, ItemTransforms.TransformType var3, HumanoidArm var4, PoseStack var5, MultiBufferSource var6, int var7) {
      if (!var2.isEmpty()) {
         ...
         var5.translate((double)((float)(var8 ? -1 : 1) / 16.0F), (double)0.125F, (double)-0.625F);
