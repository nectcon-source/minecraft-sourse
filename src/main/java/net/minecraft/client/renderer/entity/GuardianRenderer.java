...
public class GuardianRenderer extends MobRenderer<Guardian, GuardianModel> {
   ...
   public boolean shouldRender(Guardian var1, Frustum var2, double var3, double var5, double var7) {
      if (super.shouldRender(var1, var2, var3, var5, var7)) {
         ...
         if (var1.hasActiveAttackTarget()) {
            ...
            if (var9 != null) {
               Vec3 var10 = this.getPosition(var9, (double)var9.getBbHeight() * (double)0.5F, 1.0F);
   ...
   public void render(Guardian var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      if (var7 != null) {
         ...
         var4.pushPose();
         var4.translate((double)0.0F, (double)var11, (double)0.0F);
         Vec3 var12 = this.getPosition(var7, (double)var7.getBbHeight() * (double)0.5F, var3);
         Vec3 var13 = this.getPosition(var1, (double)var11, var3);
         Vec3 var14 = var12.subtract(var13);
         float var42_1 = (float)(var14.length() + (double)1.0F);
         var14 = var14.normalize();
         float var16 = (float)Math.acos(var14.y);
         float var17 = (float)Math.atan2(var14.z, var14.x);
         var4.mulPose(Vector3f.YP.rotationDegrees((((float)Math.PI / 2F) - var17) * (180F / (float)Math.PI)));
         var4.mulPose(Vector3f.XP.rotationDegrees(var16 * (180F / (float)Math.PI)));
         int var18 = 1;
         ...
         float var28 = Mth.cos(var19 + ((float)Math.PI / 4F)) * 0.282F;
         float var29 = Mth.sin(var19 + ((float)Math.PI / 4F)) * 0.282F;
         ...
         float var34 = Mth.cos(var19 + (float)Math.PI) * 0.2F;
         float var35 = Mth.sin(var19 + (float)Math.PI) * 0.2F;
         float var36 = Mth.cos(var19 + 0.0F) * 0.2F;
         float var37 = Mth.sin(var19 + 0.0F) * 0.2F;
         float var38 = Mth.cos(var19 + ((float)Math.PI / 2F)) * 0.2F;
         float var39 = Mth.sin(var19 + ((float)Math.PI / 2F)) * 0.2F;
         float var40 = Mth.cos(var19 + ((float)Math.PI * 1.5F)) * 0.2F;
         float var41 = Mth.sin(var19 + ((float)Math.PI * 1.5F)) * 0.2F;
         float var43 = 0.0F;
         float var44 = 0.4999F;
         float var45 = -1.0F + var10;
         float var46 = var42_1 * 2.5F + var45;
         ...
         vertex(var47, var49, var50, var34, var42_1, var35, var21, var22, var23, 0.4999F, var46);
         ...
         vertex(var47, var49, var50, var36, var42_1, var37, var21, var22, var23, 0.0F, var46);
         vertex(var47, var49, var50, var38, var42_1, var39, var21, var22, var23, 0.4999F, var46);
         ...
         vertex(var47, var49, var50, var40, var42_1, var41, var21, var22, var23, 0.0F, var46);
         float var51 = 0.0F;
         if (var1.tickCount % 2 == 0) {
            var51 = 0.5F;
         }

         vertex(var47, var49, var50, var26, var42_1, var27, var21, var22, var23, 0.5F, var51 + 0.5F);
         vertex(var47, var49, var50, var28, var42_1, var29, var21, var22, var23, 1.0F, var51 + 0.5F);
         vertex(var47, var49, var50, var32, var42_1, var33, var21, var22, var23, 1.0F, var51);
         vertex(var47, var49, var50, var30, var42_1, var31, var21, var22, var23, 0.5F, var51);
         var4.popPose();
      }
