...
public class FishingHookRenderer extends EntityRenderer<FishingHook> {
   ...
   public void render(FishingHook var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      if (var7 != null) {
         ...
         float var15 = Mth.sin(Mth.sqrt(var14) * (float)Math.PI);
         float var16 = Mth.lerp(var3, var7.yBodyRotO, var7.yBodyRot) * ((float)Math.PI / 180F);
         ...
         if ((this.entityRenderDispatcher.options == null || this.entityRenderDispatcher.options.getCameraType().isFirstPerson()) && var7 == Minecraft.getInstance().player) {
            double var32 = this.entityRenderDispatcher.options.fov;
            var32 /= (double)100.0F;
            Vec3 var34 = new Vec3((double)var12 * -0.36 * var32, -0.045 * var32, 0.4);
            var34 = var34.xRot(-Mth.lerp(var3, var7.xRotO, var7.xRot) * ((float)Math.PI / 180F));
            var34 = var34.yRot(-Mth.lerp(var3, var7.yRotO, var7.yRot) * ((float)Math.PI / 180F));
         ...
         double var46 = Mth.lerp((double)var3, var1.xo, var1.getX());
         double var51 = Mth.lerp((double)var3, var1.yo, var1.getY()) + (double)0.25F;
         double var36 = Mth.lerp((double)var3, var1.zo, var1.getZ());
         float var38 = (float)(var25 - var46);
         float var39 = (float)(var27 - var51) + var31;
