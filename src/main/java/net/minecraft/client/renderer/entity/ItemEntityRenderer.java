...
public class ItemEntityRenderer extends EntityRenderer<ItemEntity> {
   ...
   public void render(ItemEntity var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      float var14 = var9.getTransforms().getTransform(TransformType.GROUND).scale.y();
      var4.translate((double)0.0F, (double)(var13 + 0.25F * var14), (double)0.0F);
      ...
      for(int var23 = 0; var23 < var11; ++var23) {
         ...
         if (var23 > 0) {
            if (var10) {
               ...
               var4.translate((double)var25, (double)var27, (double)0.0F);
            }
         }

         this.itemRenderer.render(var7, TransformType.GROUND, false, var4, var5, var6, OverlayTexture.NO_OVERLAY, var9);
         var4.popPose();
         if (!var10) {
