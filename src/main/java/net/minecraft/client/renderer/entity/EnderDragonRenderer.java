...
public class EnderDragonRenderer extends EntityRenderer<EnderDragon> {
   ...
   public void render(EnderDragon var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      if (var1.dragonDeathTime > 0) {
         ...
         var4.pushPose();
         var4.translate((double)0.0F, (double)-1.0F, (double)-2.0F);
      ...
      if (var1.nearestCrystal != null) {
         var4.pushPose();
         float var23 = (float)(var1.nearestCrystal.getX() - Mth.lerp(var3, var1.xo, var1.getX()));
         float var25 = (float)(var1.nearestCrystal.getY() - Mth.lerp(var3, var1.yo, var1.getY()));
         float var26 = (float)(var1.nearestCrystal.getZ() - Mth.lerp(var3, var1.zo, var1.getZ()));
   ...
   public static void renderCrystalBeams(float var0, float var1, float var2, float var3, int var4, PoseStack var5, MultiBufferSource var6, int var7) {
      ...
      var5.pushPose();
      var5.translate((double)0.0F, (double)2.0F, (double)0.0F);
      var5.mulPose(Vector3f.YP.rotation((float)(-Math.atan2((double)var2, (double)var0)) - ((float)Math.PI / 2F)));
      var5.mulPose(Vector3f.XP.rotation((float)(-Math.atan2((double)var8, (double)var1)) - ((float)Math.PI / 2F)));
      ...
      for(int var20 = 1; var20 <= 8; ++var20) {
         float var21 = Mth.sin((float)var20 * ((float)Math.PI * 2F) / 8.0F) * 0.75F;
         float var22 = Mth.cos((float)var20 * ((float)Math.PI * 2F) / 8.0F) * 0.75F;
   ...
   @Override
      public void renderToBuffer(PoseStack var1, VertexConsumer var2, int var3, int var4, float var5, float var6, float var7, float var8) {
         ...
         this.jaw.xRot = (float)(Math.sin((var9 * ((float)Math.PI * 2F))) + (double)1.0F) * 0.2F;
         float var10 = (float)(Math.sin((var9 * ((float)Math.PI * 2F) - 1.0F)) + (double)1.0F);
         var10 = (var10 * var10 + var10 * 2.0F) * 0.05F;
         var1.translate(0.0F, (var10 - 2.0F), (double)-3.0F);
         ...
         float var18 = var9 * ((float)Math.PI * 2F);
         ...
         for(int var19 = 0; var19 < 5; ++var19) {
            ...
            this.neck.yRot = Mth.rotWrap(var20[0] - var15[0]) * ((float)Math.PI / 180F) * 1.5F;
            this.neck.xRot = var21 + this.entity.getHeadPartYOffset(var19, var15, var20) * ((float)Math.PI / 180F) * 1.5F * 5.0F;
            this.neck.zRot = -Mth.rotWrap(var20[0] - (double)var17) * ((float)Math.PI / 180F) * 1.5F;
            this.neck.y = var12;
            this.neck.z = var13;
            this.neck.x = var11;
            var12 = (float)((double)var12 + Math.sin((double)this.neck.xRot) * (double)10.0F);
            var13 = (float)((double)var13 - Math.cos((double)this.neck.yRot) * Math.cos((double)this.neck.xRot) * (double)10.0F);
            var11 = (float)((double)var11 - Math.sin((double)this.neck.yRot) * Math.cos((double)this.neck.xRot) * (double)10.0F);
         ...
         this.head.yRot = Mth.rotWrap(var29[0] - var15[0]) * ((float)Math.PI / 180F);
         this.head.xRot = Mth.rotWrap((double)this.entity.getHeadPartYOffset(6, var15, var29)) * ((float)Math.PI / 180F) * 1.5F * 5.0F;
         this.head.zRot = -Mth.rotWrap(var29[0] - (double)var17) * ((float)Math.PI / 180F);
         ...
         float var31 = var9 * ((float)Math.PI * 2F);
         this.leftWing.xRot = 0.125F - (float)Math.cos((double)var31) * 0.2F;
         this.leftWing.yRot = -0.25F;
         this.leftWing.zRot = -((float)(Math.sin((double)var31) + (double)0.125F)) * 0.8F;
         this.leftWingTip.zRot = (float)(Math.sin((double)(var31 + 2.0F)) + (double)0.5F) * 0.75F;
         ...
         var1.popPose();
         float var32 = -((float)Math.sin((double)(var9 * ((float)Math.PI * 2F)))) * 0.0F;
         var18 = var9 * ((float)Math.PI * 2F);
         var12 = 10.0F;
         var13 = 60.0F;
         var11 = 0.0F;
         ...
         for(int var22 = 0; var22 < 12; ++var22) {
            ...
            var32 = (float)((double)var32 + Math.sin((double)((float)var22 * 0.45F + var18)) * (double)0.05F);
            this.neck.yRot = (Mth.rotWrap(var29[0] - var15[0]) * 1.5F + 180.0F) * ((float)Math.PI / 180F);
            this.neck.xRot = var32 + (float)(var29[1] - var15[1]) * ((float)Math.PI / 180F) * 1.5F * 5.0F;
            this.neck.zRot = Mth.rotWrap(var29[0] - (double)var17) * ((float)Math.PI / 180F) * 1.5F;
            this.neck.y = var12;
            this.neck.z = var13;
            this.neck.x = var11;
            var12 = (float)((double)var12 + Math.sin((double)this.neck.xRot) * (double)10.0F);
