...
public class ItemFrameRenderer extends EntityRenderer<ItemFrame> {
   ...
   public void render(ItemFrame var1, float var2, float var3, PoseStack var4, MultiBufferSource var5, int var6) {
      ...
      double var9 = (double)0.46875F;
      var4.translate((double)var7.getStepX() * (double)0.46875F, (double)var7.getStepY() * (double)0.46875F, (double)var7.getStepZ() * (double)0.46875F);
      ...
      if (!var17.isEmpty()) {
         ...
         if (var11) {
            var4.translate((double)0.0F, (double)0.0F, (double)0.5F);
         } else {
            var4.translate((double)0.0F, (double)0.0F, (double)0.4375F);
         }
         ...
         if (var18) {
            ...
            var4.translate((double)-64.0F, (double)-64.0F, (double)0.0F);
            MapItemSavedData var16 = MapItem.getOrCreateSavedData(var17, var1.level);
            var4.translate((double)0.0F, (double)0.0F, (double)-1.0F);
            if (var16 != null) {
               this.minecraft.gameRenderer.getMapRenderer().render(var4, var5, var16, true, var6);
            }
         } else {
            var4.scale(0.5F, 0.5F, 0.5F);
            this.itemRenderer.renderStatic(var17, TransformType.FIXED, var6, OverlayTexture.NO_OVERLAY, var4, var5);
         }
      }
   ...
   public Vec3 getRenderOffset(ItemFrame var1, float var2) {
      return new Vec3((double)((float)var1.getDirection().getStepX() * 0.3F), (double)-0.25F, (double)((float)var1.getDirection().getStepZ() * 0.3F));
   }
