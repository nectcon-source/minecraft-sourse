...
public class ItemRenderer implements ResourceManagerReloadListener {
   ...
   public void render(ItemStack var1, ItemTransforms.TransformType var2, boolean var3, PoseStack var4, MultiBufferSource var5, int var6, int var7, BakedModel var8) {
      if (!var1.isEmpty()) {
         var4.pushPose();
         boolean var9 = var2 == TransformType.GUI || var2 == TransformType.GROUND || var2 == TransformType.FIXED;
         ...
         var4.translate((double)-0.5F, (double)-0.5F, (double)-0.5F);
         if (!var8.isCustomRenderer() && (var1.getItem() != Items.TRIDENT || var9)) {
            boolean var10;
            if (var2 != TransformType.GUI && !var2.firstPerson() && var1.getItem() instanceof BlockItem) {
   ...
   protected void renderGuiItem(ItemStack var1, int var2, int var3, BakedModel var4) {
      ...
      this.render(var1, TransformType.GUI, false, var5, var6, 15728880, OverlayTexture.NO_OVERLAY, var4);
      var6.endBatch();
   ...
   private void tryRenderGuiItem(@Nullable LivingEntity var1, ItemStack var2, int var3, int var4) {
      if (!var2.isEmpty()) {
         ...
         try {
            ...
            CrashReport var6 = CrashReport.forThrowable(var5_1, "Rendering item");
            CrashReportCategory var7 = var6.addCategory("Item being rendered");
            var7.setDetail("Item Type", () -> String.valueOf(var2.getItem()));
            var7.setDetail("Item Damage", () -> String.valueOf(var2.getDamageValue()));
            var7.setDetail("Item NBT", () -> String.valueOf(var2.getTag()));
            var7.setDetail("Item Foil", () -> String.valueOf(var2.hasFoil()));
   ...
   public void renderGuiItemDecorations(Font var1, ItemStack var2, int var3, int var4, @Nullable String var5) {
      if (!var2.isEmpty()) {
         ...
         if (var2.getCount() != 1 || var5 != null) {
            ...
            var6.translate((double)0.0F, (double)0.0F, (double)(this.blitOffset + 200.0F));
   ...
   private void fillRect(BufferBuilder var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      ...
      var1.vertex((double)(var2 + 0), (double)(var3 + 0), (double)0.0F).color(var6, var7, var8, var9).endVertex();
      var1.vertex((double)(var2 + 0), (double)(var3 + var5), (double)0.0F).color(var6, var7, var8, var9).endVertex();
      var1.vertex((double)(var2 + var4), (double)(var3 + var5), (double)0.0F).color(var6, var7, var8, var9).endVertex();
      var1.vertex((double)(var2 + var4), (double)(var3 + 0), (double)0.0F).color(var6, var7, var8, var9).endVertex();
