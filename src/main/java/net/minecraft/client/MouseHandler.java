...
public class MouseHandler {
      ...
      if (var1 == this.minecraft.getWindow().getWindow()) {
         ...
         if (this.minecraft.overlay == null) {
            if (this.minecraft.screen == null) {
               ...
               double var9x = this.xpos * (double)this.minecraft.getWindow().getGuiScaledWidth() / (double)this.minecraft.getWindow().getScreenWidth();
               double var11xx = this.ypos * (double)this.minecraft.getWindow().getGuiScaledHeight() / (double)this.minecraft.getWindow().getScreenHeight();
               if (var6) {
                  int finalVar = var3;
                  Screen.wrapScreenError(
                     () -> var8[0] = this.minecraft.screen.mouseClicked(var9x, var11xx, finalVar),
                  ...
                  int finalVar1 = var3;
                  Screen.wrapScreenError(
                     () -> var8[0] = this.minecraft.screen.mouseReleased(var9x, var11xx, finalVar1),
      ...
      if (var1 == Minecraft.getInstance().getWindow().getWindow()) {
         ...
         if (this.minecraft.overlay == null) {
            if (this.minecraft.screen != null) {
               ...
               if (this.accumulatedScroll != (double)0.0F && Math.signum(var7) != Math.signum(this.accumulatedScroll)) {
               ...
               if (this.minecraft.player.isSpectator()) {
                  ...
                  this.minecraft.player.inventory.swapPaint(var13);
               }
            }
         }
      }
   ...
   private void onMove(long var1, double var3, double var5) {
      if (var1 == Minecraft.getInstance().getWindow().getWindow()) {
         ...
         if (var7 != null && this.minecraft.overlay == null) {
            ...
            if (this.activeButton != -1 && this.mousePressedTime > (double)0.0F) {
               ...
               Screen.wrapScreenError(() -> var7.mouseDragged(var8, var10, this.activeButton, var12, var14), "mouseDragged event handler", var7.getClass().getCanonicalName());
            }
         }
   ...
   public void turnPlayer() {
      ...
      if (this.isMouseGrabbed() && this.minecraft.isWindowActive()) {
         double var9 = this.minecraft.options.sensitivity * (double)0.6F + (double)0.2F;
         double var11 = var9 * var9 * var9 * (double)8.0F;
         double var5;
         double var7;
         ...
         this.accumulatedDX = 0.0F;
         this.accumulatedDY = 0.0F;
         int var17 = 1;
