...
public class FontSet implements AutoCloseable {
   ...
   public void reload(List<GlyphProvider> var1) {
      ...
      IntSet var2 = new IntOpenHashSet();

      for(GlyphProvider var4 : var1) {
         var2.addAll(var4.getSupportedGlyphs());
      }

      Set<GlyphProvider> var5 = Sets.newHashSet();
      var2.forEach((IntConsumer) (var3) -> {
         for(GlyphProvider var5x : var1) {
            GlyphInfo var6 = (var3 == 32 ? SPACE_INFO : var5x.getGlyph(var3));
            if (var6 != null) {
               var5.add(var5x);
               if (var6 != MissingGlyph.INSTANCE) {
                  (this.glyphsByWidth.computeIfAbsent(Mth.ceil(var6.getAdvance(false)), var0 -> new IntArrayList())).add(var3);
               }
               break;
            }
         }
   ...
   public GlyphInfo getGlyphInfo(int var1) {
      return (GlyphInfo)this.glyphInfos.computeIfAbsent(var1, var1x -> (GlyphInfo)(var1x == 32 ? SPACE_INFO : this.getRaw(var1x)));
   }

   private RawGlyph getRaw(int var1) {
      for(GlyphProvider var3 : this.providers) {
         RawGlyph var4 = var3.getGlyph(var1);
         if (var4 != null) {
            return var4;
         }
      }
   ...
   public BakedGlyph getGlyph(int var1) {
      return (BakedGlyph)this.glyphs.computeIfAbsent(var1, (var1x) -> (BakedGlyph)(var1x == 32 ? SPACE_GLYPH : this.stitch(this.getRaw(var1x))));
   }
