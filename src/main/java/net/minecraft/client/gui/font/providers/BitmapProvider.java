...
public class BitmapProvider implements GlyphProvider {
   ...
   public static class Builder implements GlyphProviderBuilder {
      ...
      public GlyphProvider create(ResourceManager var1) {
         try (Resource var2 = var1.getResource(this.texture)) {
            ...
            Int2ObjectMap<Glyph> var10 = new Int2ObjectOpenHashMap();

            for(int var11 = 0; var11 < this.chars.size(); ++var11) {
               int var12 = 0;

               for(int var16 : (int[])this.chars.get(var11)) {
                  int var17 = var12++;
                  if (var16 != 0 && var16 != 32) {
                     int var18 = this.getActualGlyphWidth(var4, var7, var8, var17, var11);
                     Glyph var19 = (Glyph)var10.put(var16, new Glyph(var9, var4, var17 * var7, var11 * var8, var7, var8, (int)((double)0.5F + (double)((float)var18 * var9)) + 1, this.ascent));
                     if (var19 != null) {
            ...
            throw new RuntimeException(var2_1.getMessage());
         }
      }
