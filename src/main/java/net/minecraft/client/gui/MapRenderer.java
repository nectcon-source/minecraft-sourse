...
public class MapRenderer implements AutoCloseable {
   ...
   private MapInstance getMapInstance(MapItemSavedData var1) {
      MapInstance var2 = (MapInstance)this.maps.get(var1.getId());
      if (var2 == null) {
         var2 = new MapInstance(var1);
   ...
   @Nullable
   public MapInstance getMapInstanceIfExists(String var1) {
      return (MapInstance)this.maps.get(var1);
   }

   public void resetData() {
      for(MapInstance var2 : this.maps.values()) {
         var2.close();
      }
   ...
   @Nullable
   public MapItemSavedData getData(@Nullable MapInstance var1) {
   ...
   class MapInstance implements AutoCloseable {
      ...
      private void draw(PoseStack var1, MultiBufferSource var2, boolean var3, int var4) {
         ...
         for(MapDecoration var12 : this.data.decorations.values()) {
