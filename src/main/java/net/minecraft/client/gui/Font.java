   ...
   class StringRenderOutput implements FormattedCharSink {
      ...
      public boolean accept(int var1, Style var2, int var3) {
         ...
         if (var2.isStrikethrough()) {
            this.addEffect(new BakedGlyph.Effect(this.x + var18 - 1.0F, this.y + var18 + 4.5F, this.x + var18 + var17, this.y + var18 + 4.5F - 1.0F, 0.01F, var8, var9, var10, var11));
         }

         if (var2.isUnderlined()) {
            this.addEffect(new BakedGlyph.Effect(this.x + var18 - 1.0F, this.y + var18 + 9.0F, this.x + var18 + var17, this.y + var18 + 9.0F - 1.0F, 0.01F, var8, var9, var10, var11));
         }
