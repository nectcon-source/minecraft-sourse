...
public class RecipeBookComponent extends GuiComponent implements Widget, GuiEventListener, RecipeShownListener, PlaceRecipe<Ingredient> {
   ...
   public void initVisuals(boolean var1) {
      ...
      int var3x = (this.height - 166) / 2;
      this.stackedContents.clear();
      this.minecraft.player.inventory.fillStackedContents(this.stackedContents);
      this.menu.fillCraftSlotsStackedContents(this.stackedContents);
      String var4xx = this.searchBox != null ? this.searchBox.getValue() : "";
      this.searchBox = new EditBox(this.minecraft.font, var2 + 25, var3x + 14, 80, 9 + 5, new TranslatableComponent("itemGroup.search"));
      this.searchBox.setMaxLength(50);
      this.searchBox.setBordered(false);
      this.searchBox.setVisible(true);
      this.searchBox.setTextColor(16777215);
      this.searchBox.setValue(var4xx);
      this.recipeBookPage.init(this.minecraft, var2, var3x);
      this.recipeBookPage.addListener(this);
      this.filterButton = new StateSwitchingButton(var2 + 110, var3x + 12, 26, 16, this.book.isFiltering(this.menu));
   ...
   public void setupGhostRecipe(Recipe<?> var1, List<Slot> var2) {
      ...
      this.ghostRecipe.addIngredient(Ingredient.of(new ItemStack[]{var3}), ((Slot)var2.get(0)).x, ((Slot)var2.get(0)).y);
