...
public class EditGameRulesScreen extends Screen {
   ...
   public class RuleList extends ContainerObjectSelectionList<EditGameRulesScreen.RuleEntry> {
      public RuleList(final GameRules var2) {
         ...
         final Map<GameRules.Category, Map<GameRules.Key<?>, EditGameRulesScreen.RuleEntry>> var3 = Maps.newHashMap();
         GameRules.visitGameRuleTypes(new GameRules.GameRuleTypeVisitor() {
            ...
            private <T extends GameRules.Value<T>> void addEntry(GameRules.Key<T> var1, EditGameRulesScreen.EntryFactory<T> var2x) {
               Component var3x = new TranslatableComponent(var1.getDescriptionId());
               Component var4 = (new TextComponent(var1.getId())).withStyle(ChatFormatting.YELLOW);
               T var5 = var2.getRule(var1);
               String var6 = var5.serialize();
               Component var7 = (new TranslatableComponent("editGamerule.default", new Object[]{new TextComponent(var6)})).withStyle(ChatFormatting.GRAY);
               String var8 = var1.getDescriptionId() + ".description";
               List<FormattedCharSequence> var9;
               String var10;
               if (I18n.exists(var8)) {
                  ImmutableList.Builder<FormattedCharSequence> var11 = ImmutableList.<FormattedCharSequence>builder().add(var4.getVisualOrderText());
                  Component var12 = new TranslatableComponent(var8);
               ...
               var1x -> {
                  this.addEntry(
                     EditGameRulesScreen.this.new CategoryRuleEntry(
                        new TranslatableComponent(var1x.getKey().getDescriptionId())
                  ...
                  var1x.getValue()
                     ...
                     .forEach(var1xx -> this.addEntry(var1xx.getValue()));
               }
            );
      }
      ...
      public void render(PoseStack var1, int var2, int var3, float var4) {
         ...
         if (this.isMouseOver((double)var2, (double)var3)) {
            RuleEntry var5 = (RuleEntry)this.getEntryAtPosition((double)var2, (double)var3);
            if (var5 != null) {
