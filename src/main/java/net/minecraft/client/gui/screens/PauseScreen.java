...
public class PauseScreen extends Screen {
   ...
   private void createPauseMenu() {
      ...
      String var3xx = SharedConstants.getCurrentVersion().isStable() ? "https://aka.ms/javafeedback?ref=game" : "https://aka.ms/snapshotfeedback?ref=game";
      this.addButton(
         new Button(
            this.width / 2 - 102,
            this.height / 4 + 72 + -16,
            ...
            var2x_ -> this.minecraft.setScreen(new ConfirmLinkScreen(var2xx -> {
                  if (var2xx) {
                     Util.getPlatform().openUri(var3xx);
                  }
      ...
      Button var4xxx = this.addButton(
       ...
       var4xxx.active = this.minecraft.hasSingleplayerServer() && !this.minecraft.getSingleplayerServer().isPublished();
      Button var5xxxx = this.addButton(
         new Button(this.width / 2 - 102, this.height / 4 + 120 + -16, 204, 20, new TranslatableComponent("menu.returnToMenu"), var1x -> {
            boolean var2x_ = this.minecraft.isLocalServer();
            ...
            if (var2x_) {
               ...
               RealmsBridge var4x = new RealmsBridge();
               var4x.switchToRealms(new TitleScreen());
            } else {
      ...
      if (!this.minecraft.isLocalServer()) {
          var5xxxx.setMessage(new TranslatableComponent("menu.disconnect"));
      }
   }
