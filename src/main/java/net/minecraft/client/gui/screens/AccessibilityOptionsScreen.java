...
public class AccessibilityOptionsScreen extends SimpleOptionsSubScreen {
    ...
    protected void createFooter() {
        this.addButton(new Button(this.width / 2 - 155, this.height - 27, 150, 20, new TranslatableComponent("options.accessibility.link"), (var1) -> this.minecraft.setScreen(new ConfirmLinkScreen((var1x) -> {
            if (var1x) {
        ...
        this.addButton(new Button(this.width / 2 + 5, this.height - 27, 150, 20, CommonComponents.GUI_DONE, (var1) -> this.minecraft.setScreen(this.lastScreen)));
    }
