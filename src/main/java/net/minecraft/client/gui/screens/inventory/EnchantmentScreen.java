...
public class EnchantmentScreen extends AbstractContainerScreen<EnchantmentMenu> {
   ...
   public boolean mouseClicked(double var1, double var3, int var5) {
      ...
      for(int var8 = 0; var8 < 3; ++var8) {
         ...
         if (var9 >= (double)0.0F && var11 >= (double)0.0F && var9 < (double)108.0F && var11 < (double)19.0F && ((EnchantmentMenu)this.menu).clickMenuButton(this.minecraft.player, var8)) {
   ...
   protected void renderBg(PoseStack var1, float var2, int var3, int var4) {
      ...
      RenderSystem.multMatrix(Matrix4f.perspective((double)90.0F, 1.3333334F, 9.0F, 80.0F));
      RenderSystem.matrixMode(5888);
      var1.pushPose();
      PoseStack.Pose var8 = var1.last();
      var8.pose().setIdentity();
      var8.normal().setIdentity();
      var1.translate((double)0.0F, (double)3.3F, (double)1984.0F);
      float var9 = 5.0F;
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      for(int var7 = 0; var7 < 3; ++var7) {
         ...
         if (this.isHovering(60, 14 + 19 * var7, 108, 17, (double)var2, (double)var3) && var8 > 0 && var10 >= 0 && var9 != null) {
            List<Component> var12 = Lists.newArrayList();
