...
public class ChatScreen extends Screen {
   ...
   public boolean mouseClicked(double var1, double var3, int var5) {
      if (this.commandSuggestions.mouseClicked((int)var1, (int)var3, var5)) {
         return true;
      } else {
         if (var5 == 0) {
         ...
         return this.input.mouseClicked(var1, var3, var5) || super.mouseClicked(var1, var3, var5);
      }
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      Style var5 = this.minecraft.gui.getChat().getClickedComponentStyleAt(var2, var3);
