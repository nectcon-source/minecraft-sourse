...
public class WinScreen extends Screen {
   ...
   protected void init() {
      if (this.lines == null) {
         ...
         try {
            ...
            InputStream var15 = this.minecraft.getResourceManager().getResource(new ResourceLocation("texts/credits.txt")).getInputStream();
            BufferedReader var16 = new BufferedReader(new InputStreamReader(var15, StandardCharsets.UTF_8));

            String var17;
            while((var17 = var16.readLine()) != null) {
               var17 = var17.replaceAll("PLAYERNAME", this.minecraft.getUser().getName());
               var17 = var17.replaceAll("\t", "    ");
               boolean var21;
               if (var17.startsWith("[C]")) {
                  var17 = var17.substring(3);
                  var21 = true;
               } else {
                  var21 = false;
               }

               for(FormattedCharSequence var25 : this.minecraft.font.split(new TextComponent(var17), 274)) {
                  if (var21) {
                     this.centeredLines.add(this.lines.size());
                  }

                  this.lines.add(var25);
               }
            ...
            LOGGER.error("Couldn't load credits", var2_1);
         } finally {
   ...
   private void renderBg(int var1, int var2, float var3) {
      ...
      var12.vertex(0.0F, this.height, this.getBlitOffset()).uv(0.0F, var5 * 0.015625F).color(var8, var8, var8, 1.0F).endVertex();
      var12.vertex(var4, this.height, this.getBlitOffset()).uv((float)var4 * 0.015625F, var5 * 0.015625F).color(var8, var8, var8, 1.0F).endVertex();
      var12.vertex(var4, 0.0F, this.getBlitOffset()).uv((float)var4 * 0.015625F, var6 * 0.015625F).color(var8, var8, var8, 1.0F).endVertex();
      var12.vertex(0.0F, 0.0F, this.getBlitOffset()).uv(0.0F, var6 * 0.015625F).color(var8, var8, var8, 1.0F).endVertex();
      var11.end();
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      for(int var10 = 0; var10 < this.lines.size(); ++var10) {
         ...
         if ((float)var9 + var8 + 12.0F + 8.0F > 0.0F && (float)var9 + var8 < (float)this.height) {
            FormattedCharSequence var15 = (FormattedCharSequence)this.lines.get(var10);
            if (this.centeredLines.contains(var10)) {
               this.font.drawShadow(var1, var15, (float)(var6 + (274 - this.font.width(var15)) / 2), (float)var9, 16777215);
            } else {
               this.font.random.setSeed((long)((float)((long)var10 * 4238972211L) + this.time / 4.0F));
               this.font.drawShadow(var1, var15, (float)var6, (float)var9, 16777215);
            }
         }
      ...
      var13.vertex(0.0F, var16, this.getBlitOffset()).uv(0.0F, 1.0F).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      var13.vertex(var14, var16, this.getBlitOffset()).uv(1.0F, 1.0F).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      var13.vertex(var14, 0.0F, this.getBlitOffset()).uv(1.0F, 0.0F).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      var13.vertex(0.0F, 0.0F, this.getBlitOffset()).uv(0.0F, 0.0F).color(1.0F, 1.0F, 1.0F, 1.0F).endVertex();
      var12.end();
      RenderSystem.disableBlend();
