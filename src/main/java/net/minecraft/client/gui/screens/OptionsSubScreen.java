...
public class OptionsSubScreen extends Screen {
   ...
   public static List<FormattedCharSequence> tooltipAt(OptionsList var0, int var1, int var2) {
      Optional<AbstractWidget> var3 = var0.getMouseOver((double)var1, (double)var2);
      if (var3.isPresent() && var3.get() instanceof TooltipAccessor) {
         Optional<List<FormattedCharSequence>> var4 = ((TooltipAccessor)var3.get()).getTooltip();
         return var4.orElse(null);
      } else {
         return null;
      }
   }
