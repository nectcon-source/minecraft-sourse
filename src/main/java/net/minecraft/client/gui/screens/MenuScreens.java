...
public class MenuScreens {
   ...
   public static <T extends AbstractContainerMenu> void create(@Nullable MenuType<T> var0, Minecraft var1, int var2, Component var3) {
      if (var0 == null) {
         ...
         ScreenConstructor<T, ?> var4 = getConstructor(var0);
         if (var4 == null) {
   ...
   private static <M extends AbstractContainerMenu, U extends Screen & MenuAccess<M>> void register(MenuType<? extends M> var0, ScreenConstructor<M, U> var1) {
      ScreenConstructor<?, ?> var2 = SCREENS.put(var0, var1);
      if (var2 != null) {
   ...
   interface ScreenConstructor<T extends AbstractContainerMenu, U extends Screen & MenuAccess<T>> {
      default void fromPacket(Component var1, MenuType<T> var2, Minecraft var3, int var4) {
         U var5 = this.create(var2.create(var4, var3.player.inventory), var3.player.inventory, var1);
