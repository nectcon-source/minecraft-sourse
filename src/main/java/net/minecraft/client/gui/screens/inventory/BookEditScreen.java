...
public class BookEditScreen extends Screen {
   ...
   private final TextFieldHelper pageEdit = new TextFieldHelper(this::getCurrentPageText, this::setCurrentPageText, this::getClipboard, this::setClipboard, (var1x) -> var1x.length() < 1024 && this.font.wordWrapHeight(var1x, 114) <= 128);
   ...
   protected void init() {
      ...
      this.doneButton = this.addButton(new Button(this.width / 2 + 2, 196, 98, 20, CommonComponents.GUI_DONE, (var1x) -> {
         this.minecraft.setScreen(null);
         this.saveChanges(false);
      }));
      this.finalizeButton = this.addButton(new Button(this.width / 2 - 100, 196, 98, 20, new TranslatableComponent("book.finalizeButton"), (var1x) -> {
         if (this.isSigning) {
      ...
      this.cancelButton = this.addButton(new Button(this.width / 2 + 2, 196, 98, 20, CommonComponents.GUI_CANCEL, (var1x) -> {
         if (this.isSigning) {
      ...
      int var2 = 2;
      this.forwardButton = (PageButton)this.addButton(new PageButton(var1 + 116, 159, true, (var1x) -> this.pageForward(), true));
      this.backButton = (PageButton)this.addButton(new PageButton(var1 + 43, 159, false, (var1x) -> this.pageBack(), true));
      this.updateButtonVisibility();
   }
   ...
   private void saveChanges(boolean var1) {
      if (this.isModified) {
         ...
         this.minecraft.getConnection().send(new ServerboundEditBookPacket(this.book, var1, var3));
      }
   }
   ...
   private void renderHighlight(Rect2i[] var1) {
      ...
      for(Rect2i var7 : var1) {
         ...
         var3.vertex((double)var8, (double)var11, (double)0.0F).endVertex();
         var3.vertex((double)var10, (double)var11, (double)0.0F).endVertex();
         var3.vertex((double)var10, (double)var9, (double)0.0F).endVertex();
         var3.vertex((double)var8, (double)var9, (double)0.0F).endVertex();
      }
   ...
   private DisplayCache rebuildDisplayCache() {
      ...
      if (var1.isEmpty()) {
         ...
         List<LineInfo> var5 = Lists.newArrayList();
         ...
         List<Rect2i> var22 = Lists.newArrayList();
         if (var2 != var3) {
