   ...
   protected void init() {
      ...
      if (this.initedOnce) {
         ...
         try {
            ...
            LOGGER.warn("Unable to start LAN server detection: {}", var1_1.getMessage());
         }
      ...
      this.selectButton = (Button)this.addButton(new Button(this.width / 2 - 154, this.height - 52, 100, 20, new TranslatableComponent("selectServer.select"), (var1) -> this.joinSelectedServer()));
      ...
      this.deleteButton = (Button)this.addButton(new Button(this.width / 2 - 74, this.height - 28, 70, 20, new TranslatableComponent("selectServer.delete"), (var1) -> {
         ...
         if (var2 instanceof ServerSelectionList.OnlineServerEntry) {
            ...
            if (var3 != null) {
               Component var4 = new TranslatableComponent("selectServer.deleteQuestion");
               Component var5 = new TranslatableComponent("selectServer.deleteWarning", new Object[]{var3});
               Component var6 = new TranslatableComponent("selectServer.deleteButton");
      ...
      this.addButton(new Button(this.width / 2 + 4, this.height - 28, 70, 20, new TranslatableComponent("selectServer.refresh"), (var1) -> this.refreshServerList()));
      this.addButton(new Button(this.width / 2 + 4 + 76, this.height - 28, 75, 20, CommonComponents.GUI_CANCEL, (var1) -> this.minecraft.setScreen(this.lastScreen)));
