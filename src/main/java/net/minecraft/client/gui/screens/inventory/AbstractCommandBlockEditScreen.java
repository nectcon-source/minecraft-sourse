...
public abstract class AbstractCommandBlockEditScreen extends Screen {
   ...
   protected void init() {
      ...
      this.doneButton = (Button)this.addButton(new Button(this.width / 2 - 4 - 150, this.height / 4 + 120 + 12, 150, 20, CommonComponents.GUI_DONE, (var1) -> this.onDone()));
      this.cancelButton = (Button)this.addButton(new Button(this.width / 2 + 4, this.height / 4 + 120 + 12, 150, 20, CommonComponents.GUI_CANCEL, (var1) -> this.onClose()));
