...
public abstract class Screen extends AbstractContainerEventHandler implements TickableWidget, Widget {
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      for(int var5 = 0; var5 < this.buttons.size(); ++var5) {
         this.buttons.get(var5).render(var1, var2, var3, var4);
      }
   ...
   public List<Component> getTooltipFromItem(ItemStack var1)  {
      return var1.getTooltipLines(this.minecraft.player, this.minecraft.options.advancedItemTooltips ? Default.ADVANCED : Default.NORMAL);
   }
   ...
   public void renderTooltip(PoseStack var1, List<? extends FormattedCharSequence> var2, int var3, int var4) {
      if (!var2.isEmpty()) {
         ...
         for(FormattedCharSequence var7 : var2) {
         ...
         fillGradient(var16, var15, var20 - 3, var21 - 4, var20 + var8_4 + 3, var21 - 3, 400, -267386864, -267386864);
         fillGradient(var16, var15, var20 - 3, var21 + var9 + 3, var20 + var8_4 + 3, var21 + var9 + 4, 400, -267386864, -267386864);
         fillGradient(var16, var15, var20 - 3, var21 - 3, var20 + var8_4 + 3, var21 + var9 + 3, 400, -267386864, -267386864);
         fillGradient(var16, var15, var20 - 4, var21 - 3, var20 - 3, var21 + var9 + 3, 400, -267386864, -267386864);
         fillGradient(var16, var15, var20 + var8_4 + 3, var21 - 3, var20 + var8_4 + 4, var21 + var9 + 3, 400, -267386864, -267386864);
         fillGradient(var16, var15, var20 - 3, var21 - 3 + 1, var20 - 3 + 1, var21 + var9 + 3 - 1, 400, 1347420415, 1344798847);
         fillGradient(var16, var15, var20 + var8_4 + 2, var21 - 3 + 1, var20 + var8_4 + 3, var21 + var9 + 3 - 1, 400, 1347420415, 1344798847);
         fillGradient(var16, var15, var20 - 3, var21 - 3, var20 + var8_4 + 3, var21 - 3 + 1, 400, 1347420415, 1347420415);
         fillGradient(var16, var15, var20 - 3, var21 + var9 + 2, var20 + var8_4 + 3, var21 + var9 + 3, 400, 1344798847, 1344798847);
         ...
         for(int var18 = 0; var18 < var2.size(); ++var18) {
            FormattedCharSequence var19 = var2.get(var18);
            if (var19 != null) {
               this.font.drawInBatch(var19, (float)var20, (float)var21, -1, true, var16, var17, false, 0, 15728880);
            }
   ...
   protected void renderComponentHoverEffect(PoseStack var1, @Nullable Style var2, int var3, int var4) {
      if (var2 != null && var2.getHoverEvent() != null) {
         ...
         HoverEvent.ItemStackInfo var6 = var5.getValue(Action.SHOW_ITEM);
         if (var6 != null) {
            this.renderTooltip(var1, var6.getItemStack(), var3, var4);
         } else {
            HoverEvent.EntityTooltipInfo var7 = var5.getValue(Action.SHOW_ENTITY);
            if (var7 != null) {
               if (this.minecraft.options.advancedItemTooltips) {
                  this.renderComponentTooltip(var1, var7.getTooltipLines(), var3, var4);
               }
            } else {
               Component var8 = var5.getValue(Action.SHOW_TEXT);
               if (var8 != null) {
   ...
   public boolean handleComponentClicked(@Nullable Style var1) {
      if (var1 == null) {
         ...
         if (hasShiftDown()) {
            ...
            if (var2.getAction() == net.minecraft.network.chat.ClickEvent.Action.OPEN_URL) {
               ...
               } catch (URISyntaxException var3_1) {
                  LOGGER.error("Can't open url for {}", var2, var3_1);
               }
            } else if (var2.getAction() == net.minecraft.network.chat.ClickEvent.Action.OPEN_FILE) {
               URI var6 = (new File(var2.getValue())).toURI();
               this.openLink(var6);
            } else if (var2.getAction() == net.minecraft.network.chat.ClickEvent.Action.SUGGEST_COMMAND) {
               this.insertText(var2.getValue(), true);
            } else if (var2.getAction() == net.minecraft.network.chat.ClickEvent.Action.RUN_COMMAND) {
               this.sendMessage(var2.getValue(), false);
            } else if (var2.getAction() == net.minecraft.network.chat.ClickEvent.Action.COPY_TO_CLIPBOARD) {
   ...
   public void renderDirtBackground(int var1) {
      ...
      var3.vertex(0.0F, this.height, 0.0F).uv(0.0F, (float)this.height / 32.0F + (float)var1).color(64, 64, 64, 255).endVertex();
      var3.vertex(this.width, this.height, 0.0F).uv((float)this.width / 32.0F, (float)this.height / 32.0F + (float)var1).color(64, 64, 64, 255).endVertex();
      var3.vertex(this.width, 0.0F, 0.0F).uv((float)this.width / 32.0F, (float)var1).color(64, 64, 64, 255).endVertex();
      var3.vertex(0.0F, 0.0F, 0.0F).uv(0.0F, (float)var1).color(64, 64, 64, 255).endVertex();
      var2.end();
   }
   ...
   public static void wrapScreenError(Runnable var0, String var1, String var2) {
      try {
         ...
         CrashReport var4 = CrashReport.forThrowable(var3_1, var1);
