...
public class MerchantScreen extends AbstractContainerScreen<MerchantMenu> {
   ...
   protected void init() {
      ...
      for(int var4 = 0; var4 < 7; ++var4) {
         this.tradeOfferButtons[var4] = (TradeOfferButton)this.addButton(new TradeOfferButton(var1 + 5, var3, var4, (var1x) -> {
   ...
   protected void renderLabels(PoseStack var1, int var2, int var3) {
      ...
      if (var4 > 0 && var4 <= 5 && ((MerchantMenu)this.menu).showProgressBar()) {
         Component var5 = this.title.copy().append(LEVEL_SEPARATOR).append(new TranslatableComponent("merchant.level." + var4));
