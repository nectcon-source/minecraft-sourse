   ...
   class DetailsList extends ObjectSelectionList<CreateFlatWorldScreen.DetailsList.Entry> {
      ...
      class Entry extends ObjectSelectionList.Entry<CreateFlatWorldScreen.DetailsList.Entry> {
         ...
         public void render(PoseStack var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10) {
            ...
            String var15;
            if (var2 == 0) {
               var15 = I18n.get("createWorld.customize.flat.layer.top", new Object[]{var11.getHeight()});
            } else if (var2 == CreateFlatWorldScreen.this.generator.getLayersInfo().size() - 1) {
               var15 = I18n.get("createWorld.customize.flat.layer.bottom", new Object[]{var11.getHeight()});
            } else {
               var15 = I18n.get("createWorld.customize.flat.layer", new Object[]{var11.getHeight()});
            }
