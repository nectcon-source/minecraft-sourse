...
public class TransferableSelectionList extends ObjectSelectionList<TransferableSelectionList.PackEntry> {
   ...
   protected void renderHeader(PoseStack var1, int var2, int var3, Tesselator var4) {
      Component var5 = (new TextComponent("")).append(this.title).withStyle(new ChatFormatting[]{ChatFormatting.UNDERLINE, ChatFormatting.BOLD});
   ...
   public static class PackEntry extends ObjectSelectionList.Entry<TransferableSelectionList.PackEntry> {
      ...
      private static FormattedCharSequence cacheName(Minecraft var0, Component var1) {
         ...
         if (var2 > 157) {
            FormattedText var3 = FormattedText.composite(new FormattedText[]{var0.font.substrByWidth(var1, 157 - var0.font.width("...")), FormattedText.of("...")});
      ...
      public boolean mouseClicked(double var1, double var3, int var5) {
         ...
         if (this.showHoverOverlay() && var6 <= (double)32.0F) {
            if (this.pack.canSelect()) {
            ...
            if (var6 < (double)16.0F && this.pack.canUnselect()) {
               this.pack.unselect();
               return true;
            }

            if (var6 > (double)16.0F && var8 < (double)16.0F && this.pack.canMoveUp()) {
               this.pack.moveUp();
               return true;
            }

            if (var6 > (double)16.0F && var8 > (double)16.0F && this.pack.canMoveDown()) {
               this.pack.moveDown();
               return true;
            }
         }
