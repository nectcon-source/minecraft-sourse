...
public class AdvancementWidget extends GuiComponent {
   ...
   private List<FormattedText> findOptimalLines(Component var1, int var2) {
      ...
      List<FormattedText> var4 = null;
      float var5 = Float.MAX_VALUE;

      for(int var9 : TEST_SPLIT_OFFSETS) {
         List<FormattedText> var10 = var3.splitLines(var1, var2 - var9, Style.EMPTY);
   ...
   public void drawHover(PoseStack var1, int var2, int var3, float var4, int var5, int var6) {
      ...
      if (var10) {
         for(int var20 = 0; var20 < this.description.size(); ++var20) {
            ...
            FormattedCharSequence var24 = (FormattedCharSequence)this.description.get(var20);
            float var10003 = (float)(var18 + 5);
            int var10004 = var17 + 26 - var19 + 7;
            this.minecraft.font.getClass();
            var22.draw(var1, var24, var10003, (float)(var10004 + var20 * 9), -5592406);
         }
      } else {
         for(int var21 = 0; var21 < this.description.size(); ++var21) {
            Font var23 = this.minecraft.font;
            FormattedCharSequence var25 = (FormattedCharSequence)this.description.get(var21);
            float var26 = (float)(var18 + 5);
            int var27 = var3 + this.y + 9 + 17;
            this.minecraft.font.getClass();
            var23.draw(var1, var25, var26, (float)(var27 + var21 * 9), -5592406);
         }
      }
