...
public class GameModeSwitcherScreen extends Screen {
   ...
   protected void init() {
      ...
      for(int var1 = 0; var1 < GameModeSwitcherScreen.GameModeIcon.VALUES.length; ++var1) {
         ...
         this.slots.add(new GameModeSlot(var2, this.width / 2 - ALL_SLOTS_WIDTH / 2 + var1 * 30, this.height / 2 - 30));
      }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      if (!this.checkToClose()) {
         ...
         this.currentlyHovered.ifPresent((var2x) -> drawCenteredString(var1, this.font, var2x.getName(), this.width / 2, this.height / 2 - 30 - 20, -1));
   ...
   private static void switchToHoveredGameMode(Minecraft var0, Optional<GameModeIcon> var1) {
      if (var0.gameMode != null && var0.player != null && var1.isPresent()) {
         Optional<GameModeIcon> var2 = GameModeSwitcherScreen.GameModeIcon.getFromGameType(var0.gameMode.getPlayerMode());
   ...
   static enum GameModeIcon {
      ...
      private static Optional<GameModeIcon> getFromGameType(GameType var0) {
         switch (var0) {
            case SPECTATOR:
               return Optional.of(SPECTATOR);
            case SURVIVAL:
   ...
   public class GameModeSlot extends AbstractWidget {
      ...
      private void drawSlot(PoseStack var1, TextureManager var2) {
         ...
         var1.pushPose();
         var1.translate((double)this.x, (double)this.y, (double)0.0F);
