...
public class SafetyScreen extends Screen {
   ...
   protected void init() {
      ...
      int var1 = this.message.getLineCount() + 1 * 9 * 2;
      ...
      this.addButton(new Button(this.width / 2 - 155 + 160, 100 + var1, 150, 20, CommonComponents.GUI_BACK, (var1x) -> this.minecraft.setScreen(this.previous)));
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      drawString(var1, this.font, TITLE, 25, 30, 16777215);
       this.message.renderLeftAligned(var1, 25, 70, 9 * 2, 16777215);
