...
public class PackSelectionScreen extends Screen {
   ...
   protected void init() {
      this.doneButton = (Button)this.addButton(new Button(this.width / 2 + 4, this.height - 48, 150, 20, CommonComponents.GUI_DONE, (var1) -> this.onClose()));
      this.addButton(new Button(this.width / 2 - 154, this.height - 48, 150, 20, new TranslatableComponent("pack.openFolder"), (var1) -> Util.getPlatform().openFile(this.packDir), (var1, var2, var3, var4) -> this.renderTooltip(var2, DIRECTORY_BUTTON_TOOLTIP, var3, var4)));
   ...
   protected static void copyPacks(Minecraft var0, List<Path> var1, Path var2) {
      ...
      var1.forEach((var2x) -> {
         try (Stream<Path> var3x = Files.walk(var2x)) {
            var3x.forEach((var3xx) -> {
               try {
                  Util.copyBetweenDirs(var2x.getParent(), var2, var3xx);
               } catch (IOException var4_1) {
                  LOGGER.warn("Failed to copy datapack file  from {} to {}", var3xx, var2, var4_1);
                  var3.setTrue();
               }
   ...
   private ResourceLocation loadPackIcon(TextureManager var1, Pack var2) {
      try (PackResources var3 = var2.open()) {
         ...
         try {
            ...
            var1.register(var8, new DynamicTexture(var9));
            var10 = var8;
         ...
         LOGGER.warn("Failed to load icon from pack {}", var2.getId(), var3_1);
      }
   ...
   static class Watcher implements AutoCloseable {
      ...
      public Watcher(File var1) throws IOException {
         ...
         try {
            ...
            try (DirectoryStream<Path> var2 = Files.newDirectoryStream(this.packPath)) {
               for(Path var5 : var2) {
      ...
      public static Watcher create(File var0) {
         try {
            ...
            PackSelectionScreen.LOGGER.warn("Failed to initialize pack directory {} monitoring", var0, var1_1);
            return null;
         }
      }
