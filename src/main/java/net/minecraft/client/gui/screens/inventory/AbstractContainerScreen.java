...
public abstract class AbstractContainerScreen<T extends AbstractContainerMenu> extends Screen implements MenuAccess<T> {
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (!var17.isEmpty()) {
         int var18 = 8;
         int var20 = this.draggingItem.isEmpty() ? 8 : 16;
         String var13 = null;
         ...
         this.renderFloatingItem(var17, var2 - var5 - 8, var3 - var6 - var20, var13);
      }
      ...
      if (!this.snapbackItem.isEmpty()) {
         ...
         int var21 = this.snapbackEnd.x - this.snapbackStartX;
         int var22 = this.snapbackEnd.y - this.snapbackStartY;
         int var14 = this.snapbackStartX + (int)((float)var21 * var19);
         int var15 = this.snapbackStartY + (int)((float)var22 * var19);
   ...
   private void renderSlot(PoseStack var1, Slot var2) {
      ...
      if (var5.isEmpty() && var2.isActive()) {
         Pair<ResourceLocation, ResourceLocation> var12 = var2.getNoItemIcon();
         if (var12 != null) {
