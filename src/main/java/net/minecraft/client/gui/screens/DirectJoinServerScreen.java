...
public class DirectJoinServerScreen extends Screen {
   ...
   protected void init() {
      ...
      this.selectButton = (Button)this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 96 + 12, 200, 20, new TranslatableComponent("selectServer.select"), (var1) -> this.onSelect()));
      this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120 + 12, 200, 20, CommonComponents.GUI_CANCEL, (var1) -> this.callback.accept(false)));
