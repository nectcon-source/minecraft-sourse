...
public abstract class SimpleOptionsSubScreen extends OptionsSubScreen {
   ...
   protected void createFooter() {
      this.addButton(new Button(this.width / 2 - 100, this.height - 27, 200, 20, CommonComponents.GUI_DONE, (var1) -> this.minecraft.setScreen(this.lastScreen)));
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      List<FormattedCharSequence> var5 = tooltipAt(this.list, var2, var3);
      if (var5 != null) {
