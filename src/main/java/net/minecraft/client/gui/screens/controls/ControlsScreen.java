...
public class ControlsScreen extends OptionsSubScreen {
   ...
   protected void init() {
      this.addButton(new Button(this.width / 2 - 155, 18, 150, 20, new TranslatableComponent("options.mouse_settings"), (var1) -> this.minecraft.setScreen(new MouseSettingsScreen(this, this.options))));
      ...
      this.addButton(new Button(this.width / 2 - 155 + 160, this.height - 29, 150, 20, CommonComponents.GUI_DONE, (var1) -> this.minecraft.setScreen(this.lastScreen)));
   }

   public boolean mouseClicked(double var1, double var3, int var5) {
      if (this.selectedKey != null) {
         this.options.setKey(this.selectedKey, Type.MOUSE.getOrCreate(var5));
