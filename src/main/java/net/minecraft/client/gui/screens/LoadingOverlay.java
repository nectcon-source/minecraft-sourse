...
public class LoadingOverlay extends Overlay {
   ...
   private static final int BRAND_BACKGROUND = ARGB32.color(255, 239, 50, 61);
   ...
   public static void registerTextures(Minecraft var0) {
      var0.getTextureManager().register(MOJANG_STUDIOS_LOGO_LOCATION, new LogoTexture());
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (var9 >= 1.0F) {
         ...
         int var24 = Mth.ceil(Mth.clamp((double)var10, 0.15, (double)1.0F) * (double)255.0F);
         fill(var1, 0, 0, var5, var6, BRAND_BACKGROUND_NO_ALPHA | var24 << 24);
      ...
      int var25 = (int)((double)this.minecraft.getWindow().getGuiScaledWidth() * (double)0.5F);
      int var13 = (int)((double)this.minecraft.getWindow().getGuiScaledHeight() * (double)0.5F);
      double var14 = Math.min((double)this.minecraft.getWindow().getGuiScaledWidth() * (double)0.75F, (double)this.minecraft.getWindow().getGuiScaledHeight()) * (double)0.25F;
      int var16 = (int)(var14 * (double)0.5F);
      double var17 = var14 * (double)4.0F;
      int var19 = (int)(var17 * (double)0.5F);
      ...
      blit(var1, var25 - var19, var13 - var16, var19, (int)var14, -0.0625F, 0.0F, 120, 60, 120, 120);
      blit(var1, var25, var13 - var16, var19, (int)var14, 0.0625F, 60.0F, 120, 60, 120, 120);
      ...
      if (this.fadeOutStart == -1L && this.reload.isDone() && (!this.fadeIn || var10 >= 2.0F)) {
         try {
            ...
            this.onFinish.accept(Optional.of(var22_1));
         }
   ...
   private void drawProgressBar(PoseStack var1, int var2, int var3, int var4, int var5, float var6) {
      ...
      int var9 = ARGB32.color(var8, 255, 255, 255);
   ...
   static class LogoTexture extends SimpleTexture {
      ...
      protected SimpleTexture.TextureImage getTextureImage(ResourceManager var1) {
         ...
         try (InputStream var4 = var3.getResource(PackType.CLIENT_RESOURCES, LoadingOverlay.MOJANG_STUDIOS_LOGO_LOCATION)) {
            SimpleTexture.TextureImage var6 = new SimpleTexture.TextureImage(new TextureMetadataSection(true, true), NativeImage.read(var4));
            return var6;
         } catch (IOException var4_1) {
            return new SimpleTexture.TextureImage(var4_1);
         }
      }
   }
}
