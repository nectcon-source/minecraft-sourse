...
public class PresetFlatWorldScreen extends Screen {
   ...
   private static FlatLayerInfo getLayerInfoFromString(String var0, int var1) {
      ...
      if (var2.length == 2) {
         ...
         } catch (NumberFormatException var4_1) {
            LOGGER.error("Error while parsing flat world string => {}", var4_1.getMessage());
            return null;
         }
      } else {
         var3 = 1;
      ...
      try {
         ...
         LOGGER.error("Error while parsing flat world string => {}", var8_1.getMessage());
         return null;
      }
   ...
   private static List<FlatLayerInfo> getLayersInfoFromString(String var0) {
      List<FlatLayerInfo> var1 = Lists.newArrayList();
   ...
   public static FlatLevelGeneratorSettings fromString(Registry<Biome> var0, String var1, FlatLevelGeneratorSettings var2) {
      ...
      if (!var3.hasNext()) {
         ...
         List<FlatLayerInfo> var4 = getLayersInfoFromString(var3.next());
         if (var4.isEmpty()) {
            return FlatLevelGeneratorSettings.getDefault(var0);
         } else {
            FlatLevelGeneratorSettings var5 = var2.withLayers(var4, var2.structureSettings());
            ResourceKey<Biome> var7_6 = Biomes.PLAINS;
            if (var3.hasNext()) {
               try {
                  ResourceLocation var7 = new ResourceLocation(var3.next());
                  var7_6 = ResourceKey.create(Registry.BIOME_REGISTRY, var7);
                  var0.getOptional(var7_6).orElseThrow(() -> new IllegalArgumentException("Invalid Biome: " + var7));
               } catch (Exception var7_1) {
                  LOGGER.error("Error while parsing flat world string => {}", var7_1.getMessage());
               }
            }

            ResourceKey<Biome> finalVar7_ = var7_6;
            var5.setBiome(() -> var0.getOrThrow(finalVar7_));
            return var5;
         }
      }
   }
   ...
   protected void init() {
      ...
      Registry<Biome> var1 = this.parent.parent.worldGenSettingsComponent.registryHolder().registryOrThrow(Registry.BIOME_REGISTRY);
      ...
      this.addButton(new Button(this.width / 2 + 5, this.height - 28, 150, 20, CommonComponents.GUI_CANCEL, var1x -> this.minecraft.setScreen(this.parent)));
   ...
   private static void preset(
      ...
      PRESETS.add(new PresetInfo(var1.asItem(), var0, (var6x) -> {
         Map<StructureFeature<?>, StructureFeatureConfiguration> var7x = Maps.newHashMap();

         for(StructureFeature<?> var9 : var3) {
         ...
         var12.setBiome(() -> var6x.getOrThrow(var2));
         var12.updateLayers();
   ...
   class PresetsList extends ObjectSelectionList<PresetFlatWorldScreen.PresetsList.Entry> {
      ...
      public void setSelected(@Nullable PresetFlatWorldScreen.PresetsList.Entry var1) {
         ...
         if (var1 != null) {
            NarratorChatListener.INSTANCE.sayNow((new TranslatableComponent("narrator.select", new Object[]{((PresetInfo)PresetFlatWorldScreen.PRESETS.get(this.children().indexOf(var1))).getName()})).getString());
         }
      ...
      public class Entry extends ObjectSelectionList.Entry<PresetFlatWorldScreen.PresetsList.Entry> {
         ...
         public void render(PoseStack var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10) {
            PresetInfo var11 = PresetFlatWorldScreen.PRESETS.get(var2);
         ...
         private void select() {
            ...
            PresetInfo var1 = PresetFlatWorldScreen.PRESETS.get(PresetsList.this.children().indexOf(this));
            Registry<Biome> var2 = PresetFlatWorldScreen.this.parent.parent.worldGenSettingsComponent.registryHolder().registryOrThrow(Registry.BIOME_REGISTRY);
            PresetFlatWorldScreen.this.settings = var1.settings.apply(var2);
