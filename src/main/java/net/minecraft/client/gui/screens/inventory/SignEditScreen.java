...
public class SignEditScreen extends Screen {
   ...
   public SignEditScreen(SignBlockEntity var1) {
      ...
      var1.getClass();
      this.messages = (String[])var10001.mapToObj(var1::getMessage).map(Component::getString).toArray((var0) -> new String[var0]);
      this.sign = var1;
   }

   protected void init() {
      this.minecraft.keyboardHandler.setSendRepeatsToGui(true);
      this.addButton(new Button(this.width / 2 - 100, this.height / 4 + 120, 200, 20, CommonComponents.GUI_DONE, (var1) -> this.onDone()));
      this.sign.setEditable(false);
      this.signField = new TextFieldHelper(() -> this.messages[this.line], (var1) -> {
         this.messages[this.line] = var1;
         this.sign.setMessage(this.line, new TextComponent(var1));
      }, TextFieldHelper.createClipboardGetter(this.minecraft), TextFieldHelper.createClipboardSetter(this.minecraft), (var1) -> this.minecraft.font.width(var1) <= 90);
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      var1.pushPose();
      var1.translate((double)(this.width / 2), (double)0.0F, (double)50.0F);
      float var5 = 93.75F;
      var1.scale(93.75F, -93.75F, 93.75F);
      var1.translate((double)0.0F, (double)-1.3125F, (double)0.0F);
      BlockState var6 = this.sign.getBlockState();
      boolean var7 = var6.getBlock() instanceof StandingSignBlock;
      if (!var7) {
         var1.translate((double)0.0F, (double)-0.3125F, (double)0.0F);
      }
      ...
      var1.translate((double)0.0F, (double)0.33333334F, (double)0.046666667F);
      ...
      for(int var31 = 0; var31 < this.messages.length; ++var31) {
         ...
         if (var32 != null && var31 == this.line && var15 >= 0) {
            ...
            if (var8 && var15 < var32.length()) {
               int var36 = var17 - 1;
               int var10003 = var34 + 1;
               this.minecraft.font.getClass();
               fill(var1, var34, var36, var10003, var17 + 9, -16777216 | var14);
            }
            ...
            if (var16 != var15) {
               ...
               float var37 = (float)var27;
               this.minecraft.font.getClass();
               var30.vertex(var18, var37, (float)(var17 + 9), 0.0F).color(0, 0, 255, 255).endVertex();
               var37 = (float)var28;
               this.minecraft.font.getClass();
               var30.vertex(var18, var37, (float)(var17 + 9), 0.0F).color(0, 0, 255, 255).endVertex();
