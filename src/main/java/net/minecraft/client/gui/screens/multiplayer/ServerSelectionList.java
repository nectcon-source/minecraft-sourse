...
public class ServerSelectionList extends ObjectSelectionList<ServerSelectionList.Entry> {
   ...
   public boolean keyPressed(int var1, int var2, int var3) {
      ServerSelectionList.Entry var4 = (Entry)this.getSelected();
   ...
   public static class LANHeader extends ServerSelectionList.Entry {
      ...
      public void render(PoseStack var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10) {
         ...
         this.minecraft.font.draw(var1, var12, (float)(this.minecraft.screen.width / 2 - this.minecraft.font.width(var12) / 2), (float)(var11x + 9), 8421504);
      }
   }
   ...
   public class OnlineServerEntry extends ServerSelectionList.Entry {
      ...
      public void render(PoseStack var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, float var10) {
         ...
         List<FormattedCharSequence> var12x = this.minecraft.font.split(this.serverData.motd, var5 - 32 - 2);

         for(int var13xx = 0; var13xx < Math.min(var12x.size(), 2); ++var13xx) {
            this.minecraft.font.draw(var1, var12x.get(var13xx), (float)(var4 + 32 + 3), (float)(var3 + 12 + 9 * var13xx), 8421504);
         }

         Component var24 = (Component)(var11 ? this.serverData.version.copy().withStyle(ChatFormatting.RED) : this.serverData.status);
         int var14 = this.minecraft.font.width(var24);
         this.minecraft.font.draw(var1, var24, (float)(var4 + var5 - var14 - 15 - 2), (float)(var3 + 1), 8421504);
         int var15 = 0;
         int var16;
         List<Component> var17;
         Component var18;
         if (var11) {
            var16 = 5;
      ...
      private boolean uploadServerIcon(@Nullable String var1) {
         if (var1 == null) {
            ...
            try {
               ...
               ServerSelectionList.LOGGER.error("Invalid icon for server {} ({})", this.serverData.name, this.serverData.ip, var2_1);
               return false;
            }
         }
      ...
      public boolean mouseClicked(double var1, double var3, int var5) {
         ...
         if (var6 <= (double)32.0F) {
            if (var6 < (double)32.0F && var6 > (double)16.0F && this.canJoin()) {
               this.screen.setSelected(this);
               this.screen.joinSelectedServer();
               return true;
            }
            ...
            if (var6 < (double)16.0F && var8 < (double)16.0F && var10 > 0) {
               this.swap(var10, var10 - 1);
               return true;
            }

            if (var6 < (double)16.0F && var8 > (double)16.0F && var10 < this.screen.getServers().size() - 1) {
               this.swap(var10, var10 + 1);
               return true;
            }
         }
