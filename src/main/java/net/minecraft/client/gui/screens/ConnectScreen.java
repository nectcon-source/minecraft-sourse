      ...
      Thread var3 = new Thread("Server Connector #" + UNIQUE_THREAD_ID.incrementAndGet()) {
         public void run() {
            ...
            try {
               ...
               ConnectScreen.this.connection.setListener(new ClientHandshakePacketListenerImpl(ConnectScreen.this.connection, ConnectScreen.this.minecraft, ConnectScreen.this.parent, (var1xx) -> ConnectScreen.this.updateStatus(var1xx)));
            ...
            } catch (UnknownHostException var2_5) {
               if (ConnectScreen.this.aborted) {
                  return;
               }

               ConnectScreen.LOGGER.error("Couldn't connect to server", var2_5);
               ...
               ConnectScreen.LOGGER.error("Couldn't connect to server", var2_1);
               String var3 = var1x == null ? var2_1.toString() : var2_1.toString().replaceAll(var1x + ":" + var2, "");
               ConnectScreen.this.minecraft.execute(() -> ConnectScreen.this.minecraft.setScreen(new DisconnectedScreen(ConnectScreen.this.parent, CommonComponents.CONNECT_FAILED, new TranslatableComponent("disconnect.genericReason", new Object[]{var3}))));
            }
