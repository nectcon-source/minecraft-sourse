...
public class OptimizeWorldScreen extends Screen {
   ...
   public static OptimizeWorldScreen create(Minecraft var0, BooleanConsumer var1, DataFixer var2, LevelStorageSource.LevelStorageAccess var3, boolean var4) {
      ...
      try (Minecraft.ServerStem var6 = var0.makeServerStem(var5, Minecraft::loadDataPacks, Minecraft::loadWorldData, false, var3)) {
         WorldData var8 = var6.worldData();
         var3.saveDataTag(var5, var8);
         ImmutableSet<ResourceKey<Level>> var9 = var8.worldGenSettings().levels();
         OptimizeWorldScreen var10 = new OptimizeWorldScreen(var1, var2, var3, var8.getLevelSettings(), var4, var9);
         return var10;
      } catch (Exception var6_1) {
         LOGGER.warn("Failed to load datapacks, can't optimize world", var6_1);
         return null;
      }
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (this.upgrader.getTotalChunks() > 0) {
         ...
         var10001 = this.font;
         TranslatableComponent var18 = new TranslatableComponent("optimizeWorld.info.skipped", new Object[]{this.upgrader.getSkipped()});
         this.font.getClass();
         drawString(var1, var10001, var18, var5, 40 + 9 + 3, 10526880);
         var10001 = this.font;
         var18 = new TranslatableComponent("optimizeWorld.info.total", new Object[]{this.upgrader.getTotalChunks()});
         this.font.getClass();
         drawString(var1, var10001, var18, var5, 40 + (9 + 3) * 2, 10526880);
         int var9 = 0;
         ...
         var10001 = this.font;
         String var20 = var13 + " / " + this.upgrader.getTotalChunks();
         var10003 = this.width / 2;
         this.font.getClass();
         drawCenteredString(var1, var10001, var20, var10003, var7 + 2 * 9 + 2, 10526880);
         var10001 = this.font;
         var20 = Mth.floor(this.upgrader.getProgress() * 100.0F) + "%";
         var10003 = this.width / 2;
         int var10004 = var7 + (var8 - var7) / 2;
         this.font.getClass();
         drawCenteredString(var1, var10001, var20, var10003, var10004 - 9 / 2, 10526880);
      }
