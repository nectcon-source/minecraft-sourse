...
public class SocialInteractionsScreen extends Screen {
   ...
   protected void init() {
      ...
      this.allButton = (Button)this.addButton(new Button(var2, 45, var1, 20, TAB_ALL, (var1x) -> this.showPage(SocialInteractionsScreen.Page.ALL)));
      this.hiddenButton = (Button)this.addButton(new Button((var2 + var3 - var1) / 2 + 1, 45, var1, 20, TAB_HIDDEN, (var1x) -> this.showPage(SocialInteractionsScreen.Page.HIDDEN)));
      this.blockedButton = (Button)this.addButton(new Button(var3 - var1 + 1, 45, var1, 20, TAB_BLOCKED, (var1x) -> this.showPage(SocialInteractionsScreen.Page.BLOCKED)));
      this.blockingHintButton = (Button)this.addButton(new Button(var6, var5, var4, 20, BLOCKING_HINT, (var1x) -> this.minecraft.setScreen(new ConfirmLinkScreen((var1_) -> {
         if (var1_) {
   ...
   private void showPage(SocialInteractionsScreen.Page var1) {
      ...
      switch(var1) {
         ...
         case BLOCKED:
            ...
            PlayerSocialManager var3x = this.minecraft.getPlayerSocialManager();
            var2 = this.minecraft.player.connection.getOnlinePlayerIds().stream().filter(var3x::isBlocked).collect(Collectors.toSet());
            break;
         default:
