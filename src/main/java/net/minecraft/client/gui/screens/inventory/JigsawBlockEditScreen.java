...
public class JigsawBlockEditScreen extends Screen {
   ...
   protected void init() {
      ...
      this.jointButton = (Button)this.addButton(new Button(this.width / 2 - 152 + var1, 150, 300 - var1, 20, this.getJointText(), (var1x) -> {
         JigsawBlockEntity.JointType[] var2 = JointType.values();
      ...
      this.addButton(new AbstractSliderButton(this.width / 2 - 154, 180, 100, 20, TextComponent.EMPTY, (double)0.0F) {
         {
            this.updateMessage();
         }
         ...
         protected void applyValue() {
            JigsawBlockEditScreen.this.levels = Mth.floor(Mth.clampedLerp((double)0.0F, (double)7.0F, this.value));
         }
      });
      ...
      this.doneButton = (Button)this.addButton(new Button(this.width / 2 - 4 - 150, 210, 150, 20, CommonComponents.GUI_DONE, (var1x) -> this.onDone()));
      this.addButton(new Button(this.width / 2 + 4, 210, 150, 20, CommonComponents.GUI_CANCEL, (var1x) -> this.onCancel()));
