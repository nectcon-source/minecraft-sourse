   ...
   public void handle(ChatType var1, Component var2, UUID var3) {
      ...
      if (var4 != NarratorStatus.OFF && this.narrator.active()) {
         if (var4 == NarratorStatus.ALL || var4 == NarratorStatus.CHAT && var1 == ChatType.CHAT || var4 == NarratorStatus.SYSTEM && var1 == ChatType.SYSTEM) {
            ...
            this.doSay(var1.shouldInterrupt(), var5.getString());
         }
   ...
   public void updateNarratorStatus(NarratorStatus var1) {
      ...
      if (this.narrator.active()) {
         if (var1 == NarratorStatus.OFF) {
            SystemToast.addOrUpdate(var2, SystemToastIds.NARRATOR_TOGGLE, new TranslatableComponent("narrator.toast.disabled"), (Component)null);
         } else {
            SystemToast.addOrUpdate(var2, SystemToastIds.NARRATOR_TOGGLE, new TranslatableComponent("narrator.toast.enabled"), var1.getName());
         }
      } else {
         SystemToast.addOrUpdate(var2, SystemToastIds.NARRATOR_TOGGLE, new TranslatableComponent("narrator.toast.disabled"), new TranslatableComponent("options.narrator.notavailable"));
      }
