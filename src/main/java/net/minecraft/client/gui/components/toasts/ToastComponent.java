...
public class ToastComponent extends GuiComponent {
   ...
   public <T extends Toast> T getToast(Class<? extends T> var1, Object var2) {
      for(ToastInstance<?> var6 : this.visible) {
   ...
   class ToastInstance<T extends Toast> {
      ...
      private float getVisibility(long var1) {
         ...
         var3 *= var3;
         return this.visibility == Visibility.HIDE ? 1.0F - var3 : var3;
      }
      ...
      public boolean render(int var1, int var2, PoseStack var3) {
         ...
         if (this.visibility == Visibility.SHOW && var4 - this.animationTime <= 600L) {
         ...
         return this.visibility == Visibility.HIDE && var4 - this.animationTime > 600L;
      }
   }
}
