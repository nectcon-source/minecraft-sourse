...
public class SystemToast implements Toast {
   ...
   public static SystemToast multiline(Minecraft var0, SystemToast.SystemToastIds var1, Component var2, Component var3) {
      Font var4 = var0.font;
      List<FormattedCharSequence> var5x = var4.split(var3, 200);
      int var6xx = Math.max(200, var5x.stream().mapToInt(var4::width).max().orElse(200));
      return new SystemToast(var1, var2, var5x, var6xx + 30);
   }
   ...
   public Toast.Visibility render(PoseStack var1, ToastComponent var2, long var3) {
      ...
      if (this.messageLines == null) {
         ...
         for(int var11 = 0; var11 < this.messageLines.size(); ++var11) {
            var2.getMinecraft().font.draw(var1, (FormattedCharSequence)this.messageLines.get(var11), 18.0F, (float)(18 + var11 * 12), -1);
         }
      }

      return var3 - this.lastChanged < 5000L ? Visibility.SHOW : Visibility.HIDE;
   }
