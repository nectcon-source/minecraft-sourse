...
public class VolumeSlider extends AbstractOptionSliderButton {
   ...
   protected void updateMessage() {
      Component var1 = (Component)((float)this.value == (float)this.getYImage(false) ? CommonComponents.OPTION_OFF : new TextComponent((int)(this.value * (double)100.0F) + "%"));
      this.setMessage((new TranslatableComponent("soundCategory." + this.source.getName())).append(": ").append(var1));
   }
