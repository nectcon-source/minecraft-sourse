...
public class EditBox extends AbstractWidget implements Widget, GuiEventListener {
   ...
   public void renderButton(PoseStack var1, int var2, int var3, float var4) {
      if (this.isVisible()) {
         ...
         if (!var8.isEmpty()) {
            ...
            var13 = this.font.drawShadow(var1, (FormattedCharSequence)this.formatter.apply(var14, this.displayPos), (float)var11, (float)var12, var17);
         }
         ...
         if (!var8.isEmpty() && var9 && var6 < var8.length()) {
            this.font.drawShadow(var1, (FormattedCharSequence)this.formatter.apply(var8.substring(var6), this.cursorPos), (float)var13, (float)var12, var17);
         }
         ...
         if (var7 != var6) {
            ...
            int var21 = var12 + 1;
            this.font.getClass();
            this.renderHighlight(var15, var19, var20, var21 + 9);
         }
   ...
   private void renderHighlight(int var1, int var2, int var3, int var4) {
      ...
      var6.vertex((double)var1, (double)var4, (double)0.0F).endVertex();
      var6.vertex((double)var3, (double)var4, (double)0.0F).endVertex();
      var6.vertex((double)var3, (double)var2, (double)0.0F).endVertex();
      var6.vertex((double)var1, (double)var2, (double)0.0F).endVertex();
      var8.end();
