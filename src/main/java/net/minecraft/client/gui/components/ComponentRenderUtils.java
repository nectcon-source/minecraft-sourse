...
public class ComponentRenderUtils {
   ...
   public static List<FormattedCharSequence> wrapComponents(FormattedText var0, int var1, Font var2) {
      ...
      var2.getSplitter().splitLines(var3.getResultOrEmpty(), var1, Style.EMPTY, (var1x, var2x) -> {
         FormattedCharSequence var3_ = Language.getInstance().getVisualOrder(var1x);
         var4.add(var2x ? FormattedCharSequence.composite(INDENT, var3_) : var3_);
      });
      return (List<FormattedCharSequence>)(var4.isEmpty() ? Lists.newArrayList(new FormattedCharSequence[]{FormattedCharSequence.EMPTY}) : var4);
   }
}
