...
public abstract class AbstractSelectionList<E extends AbstractSelectionList.Entry<E>> extends AbstractContainerEventHandler implements Widget {
   ...
   protected final E getEntryAtPosition(double var1, double var3) {
      ...
      return (E)(var1 < (double)this.getScrollbarPosition() && var1 >= (double)var7 && var1 <= (double)var8 && var10 >= 0 && var9 >= 0 && var10 < this.getItemCount() ? (Entry)this.children().get(var10) : null);
   }
   ...
   public void render(PoseStack var1, int var2, int var3, float var4) {
      ...
      if (this.renderBackground) {
         ...
         var8.vertex((double)this.x0, (double)this.y1, (double)0.0F).uv((float)this.x0 / 32.0F, (float)(this.y1 + (int)this.getScrollAmount()) / 32.0F).color(32, 32, 32, 255).endVertex();
         var8.vertex((double)this.x1, (double)this.y1, (double)0.0F).uv((float)this.x1 / 32.0F, (float)(this.y1 + (int)this.getScrollAmount()) / 32.0F).color(32, 32, 32, 255).endVertex();
         var8.vertex((double)this.x1, (double)this.y0, (double)0.0F).uv((float)this.x1 / 32.0F, (float)(this.y0 + (int)this.getScrollAmount()) / 32.0F).color(32, 32, 32, 255).endVertex();
         var8.vertex((double)this.x0, (double)this.y0, (double)0.0F).uv((float)this.x0 / 32.0F, (float)(this.y0 + (int)this.getScrollAmount()) / 32.0F).color(32, 32, 32, 255).endVertex();
         var7.end();
      }
      ...
      if (this.renderTopAndBottom) {
         ...
         int var12 = -100;
         var8.begin(7, DefaultVertexFormat.POSITION_TEX_COLOR);
         var8.vertex((double)this.x0, (double)this.y0, (double)-100.0F).uv(0.0F, (float)this.y0 / 32.0F).color(64, 64, 64, 255).endVertex();
         var8.vertex((double)(this.x0 + this.width), (double)this.y0, (double)-100.0F).uv((float)this.width / 32.0F, (float)this.y0 / 32.0F).color(64, 64, 64, 255).endVertex();
         var8.vertex((double)(this.x0 + this.width), (double)0.0F, (double)-100.0F).uv((float)this.width / 32.0F, 0.0F).color(64, 64, 64, 255).endVertex();
         var8.vertex((double)this.x0, (double)0.0F, (double)-100.0F).uv(0.0F, 0.0F).color(64, 64, 64, 255).endVertex();
         var8.vertex((double)this.x0, (double)this.height, (double)-100.0F).uv(0.0F, (float)this.height / 32.0F).color(64, 64, 64, 255).endVertex();
         var8.vertex((double)(this.x0 + this.width), (double)this.height, (double)-100.0F).uv((float)this.width / 32.0F, (float)this.height / 32.0F).color(64, 64, 64, 255).endVertex();
         var8.vertex((double)(this.x0 + this.width), (double)this.y1, (double)-100.0F).uv((float)this.width / 32.0F, (float)this.y1 / 32.0F).color(64, 64, 64, 255).endVertex();
         var8.vertex((double)this.x0, (double)this.y1, (double)-100.0F).uv(0.0F, (float)this.y1 / 32.0F).color(64, 64, 64, 255).endVertex();
         var7.end();
         ...
         int var13 = 4;
         var8.begin(7, DefaultVertexFormat.POSITION_TEX_COLOR);
         var8.vertex((double)this.x0, (double)(this.y0 + 4), (double)0.0F).uv(0.0F, 1.0F).color(0, 0, 0, 0).endVertex();
         var8.vertex((double)this.x1, (double)(this.y0 + 4), (double)0.0F).uv(1.0F, 1.0F).color(0, 0, 0, 0).endVertex();
         var8.vertex((double)this.x1, (double)this.y0, (double)0.0F).uv(1.0F, 0.0F).color(0, 0, 0, 255).endVertex();
         var8.vertex((double)this.x0, (double)this.y0, (double)0.0F).uv(0.0F, 0.0F).color(0, 0, 0, 255).endVertex();
         var8.vertex((double)this.x0, (double)this.y1, (double)0.0F).uv(0.0F, 1.0F).color(0, 0, 0, 255).endVertex();
         var8.vertex((double)this.x1, (double)this.y1, (double)0.0F).uv(1.0F, 1.0F).color(0, 0, 0, 255).endVertex();
         var8.vertex((double)this.x1, (double)(this.y1 - 4), (double)0.0F).uv(1.0F, 0.0F).color(0, 0, 0, 0).endVertex();
         var8.vertex((double)this.x0, (double)(this.y1 - 4), (double)0.0F).uv(0.0F, 0.0F).color(0, 0, 0, 0).endVertex();
         var7.end();
      }
      ...
      if (var15 > 0) {
         ...
         var8.begin(7, DefaultVertexFormat.POSITION_TEX_COLOR);
         var8.vertex((double)var5, (double)this.y1, (double)0.0F).uv(0.0F, 1.0F).color(0, 0, 0, 255).endVertex();
         var8.vertex((double)var6, (double)this.y1, (double)0.0F).uv(1.0F, 1.0F).color(0, 0, 0, 255).endVertex();
         var8.vertex((double)var6, (double)this.y0, (double)0.0F).uv(1.0F, 0.0F).color(0, 0, 0, 255).endVertex();
         var8.vertex((double)var5, (double)this.y0, (double)0.0F).uv(0.0F, 0.0F).color(0, 0, 0, 255).endVertex();
         var8.vertex((double)var5, (double)(var18 + var16), (double)0.0F).uv(0.0F, 1.0F).color(128, 128, 128, 255).endVertex();
         var8.vertex((double)var6, (double)(var18 + var16), (double)0.0F).uv(1.0F, 1.0F).color(128, 128, 128, 255).endVertex();
         var8.vertex((double)var6, (double)var18, (double)0.0F).uv(1.0F, 0.0F).color(128, 128, 128, 255).endVertex();
         var8.vertex((double)var5, (double)var18, (double)0.0F).uv(0.0F, 0.0F).color(128, 128, 128, 255).endVertex();
         var8.vertex((double)var5, (double)(var18 + var16 - 1), (double)0.0F).uv(0.0F, 1.0F).color(192, 192, 192, 255).endVertex();
         var8.vertex((double)(var6 - 1), (double)(var18 + var16 - 1), (double)0.0F).uv(1.0F, 1.0F).color(192, 192, 192, 255).endVertex();
         var8.vertex((double)(var6 - 1), (double)var18, (double)0.0F).uv(1.0F, 0.0F).color(192, 192, 192, 255).endVertex();
         var8.vertex((double)var5, (double)var18, (double)0.0F).uv(0.0F, 0.0F).color(192, 192, 192, 255).endVertex();
         var7.end();
      }
   ...
   public void setScrollAmount(double var1) {
      this.scrollAmount = Mth.clamp(var1, (double)0.0F, (double)this.getMaxScroll());
   }
   ...
   public boolean mouseDragged(double var1, double var3, int var5, double var6, double var8) {
      if (super.mouseDragged(var1, var3, var5, var6, var8)) {
         ...
         if (var3 < (double)this.y0) {
            ...
            double var14 = Math.max((double)1.0F, var10 / (double)(var12 - var13));
   ...
   public boolean mouseScrolled(double var1, double var3, double var5) {
      this.setScrollAmount(this.getScrollAmount() - var5 * (double)this.itemHeight / (double)2.0F);
      return true;
   }
   ...
   protected void moveSelection(SelectionDirection var1, Predicate<E> var2) {
      ...
      if (!this.children().isEmpty()) {
         ...
         while(true) {
            ...
            E var6 = (E)(this.children().get(var5));
            if (var2.test(var6)) {
      ...
      for(int var10 = 0; var10 < var7; ++var10) {
         ...
         if (var12 >= this.y0 && var11 <= this.y1) {
            ...
            if (this.renderSelection && this.isSelectedItem(var10)) {
               ...
               var9.vertex((double)var17, (double)(var13 + var14 + 2), (double)0.0F).endVertex();
               var9.vertex((double)var18, (double)(var13 + var14 + 2), (double)0.0F).endVertex();
               var9.vertex((double)var18, (double)(var13 - 2), (double)0.0F).endVertex();
               var9.vertex((double)var17, (double)(var13 - 2), (double)0.0F).endVertex();
               var8.end();
               RenderSystem.color4f(0.0F, 0.0F, 0.0F, 1.0F);
               var9.begin(7, DefaultVertexFormat.POSITION);
               var9.vertex((double)(var17 + 1), (double)(var13 + var14 + 1), (double)0.0F).endVertex();
               var9.vertex((double)(var18 - 1), (double)(var13 + var14 + 1), (double)0.0F).endVertex();
               var9.vertex((double)(var18 - 1), (double)(var13 - 1), (double)0.0F).endVertex();
               var9.vertex((double)(var17 + 1), (double)(var13 - 1), (double)0.0F).endVertex();
               var8.end();
               RenderSystem.enableTexture();
            }

            int var20 = this.getRowLeft();
            var15.render(var1, var10, var11, var20, var16, var14, var4, var5, this.isMouseOver((double)var4, (double)var5) && Objects.equals(this.getEntryAtPosition((double)var4, (double)var5), var15), var6);
         }
      }
   ...
   protected E remove(int var1) {
      E var2 = (E)(this.children.get(var1));
   ...
   private void bindEntryToSelf(Entry<E> var1) {
      var1.list = this;
   }
   ...
   class TrackedList extends AbstractList<E> {
      ...
      public E set(int var1, E var2) {
         E var3 = (E)((Entry)this.delegate.set(var1, var2));
