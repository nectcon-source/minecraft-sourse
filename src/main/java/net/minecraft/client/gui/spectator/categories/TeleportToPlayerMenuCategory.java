...
public class TeleportToPlayerMenuCategory implements SpectatorMenuCategory, SpectatorMenuItem {
   private static final Ordering<PlayerInfo> PROFILE_ORDER = Ordering.from((var0, var1) -> ComparisonChain.start().compare(var0.getProfile().getId(), var1.getProfile().getId()).result());
