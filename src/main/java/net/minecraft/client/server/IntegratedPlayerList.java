...
public class IntegratedPlayerList extends PlayerList {
   ...
   public Component canPlayerLogin(SocketAddress var1, GameProfile var2) {
      return (var2.getName().equalsIgnoreCase(this.getServer().getSingleplayerName()) && this.getPlayerByName(var2.getName()) != null ? new TranslatableComponent("multiplayer.disconnect.name_taken") : super.canPlayerLogin(var1, var2));
   }
