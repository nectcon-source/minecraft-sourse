...
public class IntegratedServer extends MinecraftServer {
   ...
   public CrashReport fillReport(CrashReport var1) {
      ...
      var1.getSystemDetails().setDetail("Type", "Integrated Server (map_client.txt)");
      var1.getSystemDetails().setDetail("Is Modded", () -> this.getModdedStatus().orElse("Probably not. Jar signature remains and both client + server brands are untouched."));
      return var1;
   }
