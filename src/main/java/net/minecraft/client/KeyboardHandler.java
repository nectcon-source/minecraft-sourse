...
public class KeyboardHandler {
   ...
   private void debugFeedbackTranslated(String var1, Object... var2) {
      this.minecraft.gui.getChat().addMessage((new TextComponent("")).append((new TranslatableComponent("debug.prefix")).withStyle(new ChatFormatting[]{ChatFormatting.YELLOW, ChatFormatting.BOLD})).append(" ").append(new TranslatableComponent(var1, var2)));
   }

   private void debugWarningTranslated(String var1, Object... var2) {
      this.minecraft.gui.getChat().addMessage((new TextComponent("")).append((new TranslatableComponent("debug.prefix")).withStyle(new ChatFormatting[]{ChatFormatting.RED, ChatFormatting.BOLD})).append(" ").append(new TranslatableComponent(var1, var2)));
   }
      ...
      if (var1 == this.minecraft.getWindow().getWindow()) {
         ...
         if (var5 == 1 && (!(this.minecraft.screen instanceof ControlsScreen) || ((ControlsScreen)var7).lastKeySelection <= Util.getMillis() - 20L)) {
            ...
            if (this.minecraft.options.keyScreenshot.matches(var3, var4)) {
               ...
               Screenshot.grab(this.minecraft.gameDirectory, this.minecraft.getWindow().getWidth(), this.minecraft.getWindow().getHeight(), this.minecraft.getMainRenderTarget(), (var1x) -> this.minecraft.execute(() -> this.minecraft.gui.getChat().addMessage(var1x)));
               return;
            }
         }
