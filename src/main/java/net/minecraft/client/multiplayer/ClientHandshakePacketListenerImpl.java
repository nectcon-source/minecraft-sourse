...
public class ClientHandshakePacketListenerImpl implements ClientLoginPacketListener {
   ...
   public void handleHello(ClientboundHelloPacket var1) {
      ...
      } catch (CryptException var6_1) {
         throw new IllegalStateException("Protocol error", var6_1);
      }
      ...
      HttpUtil.DOWNLOAD_EXECUTOR.submit(() -> {
         ...
         this.connection.send(var5, (var3x) -> this.connection.setEncryptionKey(var2, var3));
      });
   }
   ...
   private Component authenticateServer(String var1) {
      ...
      } catch (AuthenticationException var2_1) {
         return new TranslatableComponent("disconnect.loginFailedInfo", new Object[]{var2_1.getMessage()});
      }
   }
