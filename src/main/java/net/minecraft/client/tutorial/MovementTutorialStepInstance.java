   ...
   public void tick() {
      ...
      if (this.timeWaiting >= 100) {
         if (this.moveCompleted == -1 && this.moveToast == null) {
            this.moveToast = new TutorialToast(Icons.MOVEMENT_KEYS, MOVE_TITLE, MOVE_DESCRIPTION, true);
            ...
            this.lookToast = new TutorialToast(Icons.MOUSE, LOOK_TITLE, LOOK_DESCRIPTION, true);
