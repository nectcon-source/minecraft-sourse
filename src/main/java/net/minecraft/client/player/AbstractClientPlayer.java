...
public abstract class AbstractClientPlayer extends Player {
   ...
   public static HttpTexture registerSkinTexture(ResourceLocation var0, String var1) {
      ...
      AbstractTexture var3 = var2.getTexture(var0);
      if (var3 == null) {
   ...
   public float getFieldOfViewModifier() {
      ...
      var1 = (float)((double)var1 * ((this.getAttributeValue(Attributes.MOVEMENT_SPEED) / (double)this.abilities.getWalkingSpeed() + (double)1.0F) / (double)2.0F));
