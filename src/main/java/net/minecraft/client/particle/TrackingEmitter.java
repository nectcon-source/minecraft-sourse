...
public class TrackingEmitter extends NoRenderParticle {
   ...
   private TrackingEmitter(ClientLevel var1, Entity var2, ParticleOptions var3, int var4, Vec3 var5) {
      super(var1, var2.getX(), var2.getY((double)0.5F), var2.getZ(), var5.x, var5.y, var5.z);
      this.entity = var2;
      this.lifeTime = var4;
   ...
   public void tick() {
      for(int var1 = 0; var1 < 16; ++var1) {
         ...
         if (!(var2 * var2 + var4 * var4 + var6 * var6 > (double)1.0F)) {
            double var8 = this.entity.getX(var2 / (double)4.0F);
            double var10 = this.entity.getY((double)0.5F + var4 / (double)4.0F);
            double var12 = this.entity.getZ(var6 / (double)4.0F);
