...
public class BubbleColumnUpParticle extends TextureSheetParticle {
   private BubbleColumnUpParticle(ClientLevel var1, double var2, double var4, double var6, double var8, double var10, double var12) {
      ...
      this.xd = var8 * (double)0.2F + (Math.random() * (double)2.0F - (double)1.0F) * (double)0.02F;
      this.yd = var10 * (double)0.2F + (Math.random() * (double)2.0F - (double)1.0F) * (double)0.02F;
      this.zd = var12 * (double)0.2F + (Math.random() * (double)2.0F - (double)1.0F) * (double)0.02F;
      this.lifetime = (int)((double)40.0F / (Math.random() * 0.8 + 0.2));
   }
