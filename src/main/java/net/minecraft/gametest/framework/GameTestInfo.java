   ...
   public void tick() {
      if (!this.isDone()) {
         ...
         if (this.tickCount >= 0L) {
            ...
            ObjectIterator<Entry<Runnable>> var1 = this.runAtTickTimeMap.object2LongEntrySet().iterator();

            while(var1.hasNext()) {
               Object2LongMap.Entry<Runnable> var2 = (Object2LongMap.Entry)var1.next();
