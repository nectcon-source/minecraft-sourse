...
public class TestCommand {
      ...
      if (var2 <= 48 && var3 <= 48 && var4 <= 48) {
         ...
         for(int var8 = 0; var8 < var2; ++var8) {
            for(int var9 = 0; var9 < var4; ++var9) {
               ...
               BlockInput var12 = new BlockInput(var11.defaultBlockState(), Collections.EMPTY_SET, null);
   ...
   private static int showPos(CommandSourceStack var0, String var1) throws CommandSyntaxException {
      BlockHitResult var2 = (BlockHitResult)var0.getPlayerOrException().pick((double)10.0F, 1.0F, false);
      BlockPos var3 = var2.getBlockPos();
      ServerLevel var4 = var0.getLevel();
      Optional<BlockPos> var5 = StructureUtils.findStructureBlockContainingPos(var3, 15, var4);
      if (!var5.isPresent()) {
      ...
      if (!var5.isPresent()) {
         ...
         BlockPos var7 = var3.subtract(var5.get());
         String var8 = var7.getX() + ", " + var7.getY() + ", " + var7.getZ();
         String var9 = var6.getStructurePath();
         Component var10 = (new TextComponent(var8)).setStyle(Style.EMPTY.withBold(true).withColor(ChatFormatting.GREEN).withHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new TextComponent("Click to copy to clipboard"))).withClickEvent(new ClickEvent(net.minecraft.network.chat.ClickEvent.Action.COPY_TO_CLIPBOARD, "final BlockPos " + var1 + " = new BlockPos(" + var8 + ");")));
   ...
   private static int runAllNearbyTests(CommandSourceStack var0) {
      BlockPos var1 = new BlockPos(var0.getPosition());
      ServerLevel var2 = var0.getLevel();
      Collection<BlockPos> var3 = StructureUtils.findStructureBlocks(var1, 200, var2);
      if (var3.isEmpty()) {
   ...
   private static void runTestPreparation(TestFunction var0, ServerLevel var1) {
      Consumer<ServerLevel> var2 = GameTestRegistry.getBeforeBatchFunction(var0.getBatchName());
      if (var2 != null) {
         var2.accept(var1);
      }
   }
   ...
   private static int runAllTests(CommandSourceStack var0, int var1, int var2) {
      ...
      Collection<TestFunction> var3 = GameTestRegistry.getAllTestFunctions();
   ...
   private static int runAllTestsInClass(CommandSourceStack var0, String var1, int var2, int var3) {
      Collection<TestFunction> var4 = GameTestRegistry.getTestFunctionsForClassName(var1);
      GameTestRunner.clearMarkers(var0.getLevel());
   ...
   private static void runTests(CommandSourceStack var0, Collection<TestFunction> var1, int var2, int var3) {
      ...
      Rotation var7 = StructureUtils.getRotationForRotationSteps(var2);
      Collection<GameTestInfo> var8 = GameTestRunner.runTests(var1, var5, var7, var6, GameTestTicker.singleton, var3);
   ...
   private static int importTestStructure(CommandSourceStack var0, String var1) {
      ...
      try {
         ...
         return 0;
      } catch (CommandSyntaxException | IOException var5_1) {
         System.err.println("Failed to load structure " + var1);
         ((Exception)var5_1).printStackTrace();
         return 1;
      }
   }

   private static void say(ServerLevel var0, String var1, ChatFormatting var2) {
      var0.getPlayers(var0x -> true).forEach(var2x -> var2x.sendMessage(new TextComponent(var2 + var1), Util.NIL_UUID));
   }
