...
public class GameTestRegistry {
   ...
   public static Collection<TestFunction> getTestFunctionsForClassName(String var0) {
      return testFunctions.stream().filter(var1 -> isTestFunctionPartOfClass(var1, var0)).collect(Collectors.toList());
   }
   ...
   public static Consumer<ServerLevel> getBeforeBatchFunction(String var0) {
      return beforeBatchFunctions.get(var0);
   }
   ...
   public static TestFunction getTestFunction(String var0) {
      Optional<TestFunction> var1 = findTestFunction(var0);
      if (!var1.isPresent()) {
