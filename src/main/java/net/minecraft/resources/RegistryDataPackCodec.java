...
public final class RegistryDataPackCodec<E> implements Codec<MappedRegistry<E>> {
   ...
   public static <E> RegistryDataPackCodec<E> create(ResourceKey<? extends Registry<E>> var0, Lifecycle var1, Codec<E> var2) {
      return new RegistryDataPackCodec<E>(var0, var1, var2);
   }
   ...
   public <T> DataResult<Pair<MappedRegistry<E>, T>> decode(DynamicOps<T> var1, T var2) {
      DataResult<Pair<MappedRegistry<E>, T>> var3 = this.directCodec.decode(var1, var2);
      return var1 instanceof RegistryReadOps ? var3.flatMap((var2x) -> ((RegistryReadOps)var1).decodeElements(var2x.getFirst(), this.registryKey, this.elementCodec).map((var1x) -> Pair.of(var1x, var2x.getSecond()))) : var3;
   }
