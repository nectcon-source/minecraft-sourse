...
public class RegistryWriteOps<T> extends DelegatingOps<T> {
   ...
   public static <T> RegistryWriteOps<T> create(DynamicOps<T> var0, RegistryAccess var1) {
      return new RegistryWriteOps<T>(var0, var1);
   }
   ...
   protected <E> DataResult<T> encode(E var1, T var2, ResourceKey<? extends Registry<E>> var3, Codec<E> var4) {
      Optional<WritableRegistry<E>> var5 = this.registryHolder.registry(var3);
      if (var5.isPresent()) {
         WritableRegistry<E> var6 = var5.get();
         Optional<ResourceKey<E>> var7 = var6.getResourceKey(var1);
         if (var7.isPresent()) {
            ResourceKey<E> var8 = var7.get();
