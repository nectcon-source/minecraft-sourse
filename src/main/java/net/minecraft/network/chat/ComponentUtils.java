...
public class ComponentUtils {
   ...
   private static Style resolveStyle(@Nullable CommandSourceStack var0, Style var1, @Nullable Entity var2, int var3) throws CommandSyntaxException {
      ...
      if (var4 != null) {
         Component var5 = (Component)var4.getValue(Action.SHOW_TEXT);
         if (var5 != null) {
            HoverEvent var6 = new HoverEvent(Action.SHOW_TEXT, updateForEntity(var0, var5, var2, var3 + 1));
   ...
   public static Component formatList(Collection<String> var0) {
      return formatAndSortList(var0, (var0x) -> (new TextComponent(var0x)).withStyle(ChatFormatting.GREEN));
   }
   ...
   public static Component fromMessage(Message var0) {
      return (var0 instanceof Component ? (Component)var0 : new TextComponent(var0.getString()));
   }
}
