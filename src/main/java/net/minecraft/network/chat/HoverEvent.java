...
public class HoverEvent {
      ...
      if (var1 == null) {
         ...
         if (var2 == null) {
            ...
            if (var3 != null) {
               ...
               Component var4 = Serializer.fromJson(var0.get("value"));
   ...
   public static class EntityTooltipInfo {
      ...
      public static EntityTooltipInfo create(JsonElement var0) {
         if (!var0.isJsonObject()) {
            ...
            Component var4 = Serializer.fromJson(var1.get("name"));
      ...
      public static EntityTooltipInfo create(Component var0) {
         try {
            ...
            Component var2 = Serializer.fromJson(var1.getString("name"));
      ...
      public JsonElement serialize() {
         ...
         if (this.name != null) {
            var1.add("name", Serializer.toJsonTree(this.name));
         }
   ...
   public static class ItemStackInfo {
      ...
      private static ItemStackInfo create(JsonElement var0) {
         if (var0.isJsonPrimitive()) {
            ...
            if (var1.has("tag")) {
               ...
               } catch (CommandSyntaxException var5_1) {
                  HoverEvent.LOGGER.warn("Failed to parse tag: {}", var4, var5_1);
               }
            }
      ...
      private static ItemStackInfo create(Component var0) {
         try {
            ...
            HoverEvent.LOGGER.warn("Failed to parse item tag: {}", var0, var1_1);
            return null;
         }
      }
   ...
   public static class Action<T> {
      ...
      public static final Action<ItemStackInfo> SHOW_ITEM = new Action<ItemStackInfo>("show_item", true, (var0) -> HoverEvent.ItemStackInfo.create(var0), (var0) -> ((ItemStackInfo)var0).serialize(), (var0) -> HoverEvent.ItemStackInfo.create(var0));
      ...
      private static final Map<String, Action> LOOKUP = Stream.of(SHOW_TEXT, SHOW_ITEM, SHOW_ENTITY).collect(ImmutableMap.toImmutableMap(Action::getName, (var0) -> var0));;
