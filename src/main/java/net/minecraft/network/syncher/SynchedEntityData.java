...
public class SynchedEntityData {
   ...
   public static <T> EntityDataAccessor<T> defineId(Class<? extends Entity> var0, EntityDataSerializer<T> var1) {
      ...
      if (ENTITY_ID_POOL.containsKey(var0)) {
         var6 = ENTITY_ID_POOL.get(var0) + 1;
      } else {
         int var3 = 0;
         Class<?> var4x = var0;

         while(var4x != Entity.class) {
            var4x = var4x.getSuperclass();
            if (ENTITY_ID_POOL.containsKey(var4x)) {
               var3 = ENTITY_ID_POOL.get(var4x) + 1;
               break;
            }
         }
   ...
   private <T> void createDataItem(EntityDataAccessor<T> var1, T var2) {
      DataItem<T> var3 = new DataItem<T>(var1, var2);
   ...
   private <T> DataItem<T> getItem(EntityDataAccessor<T> var1) {
      ...
      try {
         ...
         CrashReport var4 = CrashReport.forThrowable(var3_1, "Getting synched entity data");
   ...
   public <T> void set(EntityDataAccessor<T> var1, T var2) {
      DataItem<T> var3 = this.<T>getItem(var1);
   ...
   public static void pack(List<DataItem<?>> var0, FriendlyByteBuf var1) throws IOException {
      if (var0 != null) {
         int var2 = 0;

         for(int var3 = var0.size(); var2 < var3; ++var2) {
            writeDataItem(var1, (DataItem)var0.get(var2));
         }
      }
   ...
   private static <T> void writeDataItem(FriendlyByteBuf var0, DataItem<T> var1) throws IOException {
      EntityDataAccessor<T> var2 = var1.getAccessor();
   ...
   @Nullable
   public static List<DataItem<?>> unpack(FriendlyByteBuf var0) throws IOException {
      List<DataItem<?>> var1 = null;
   ...
   private static <T> DataItem<T> genericHelper(FriendlyByteBuf var0, int var1, EntityDataSerializer<T> var2) {
      return new DataItem<T>(var2.createAccessor(var1), var2.read(var0));
   }
