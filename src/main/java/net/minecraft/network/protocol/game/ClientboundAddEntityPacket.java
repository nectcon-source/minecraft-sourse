...
public class ClientboundAddEntityPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundAddEntityPacket(int var1, UUID var2, double var3, double var5, double var7, float var9, float var10, EntityType<?> var11, int var12, Vec3 var13) {
      ...
      this.type = var11;
      this.data = var12;
      this.xa = (int)(Mth.clamp(var13.x, -3.9, 3.9) * (double)8000.0F);
      this.ya = (int)(Mth.clamp(var13.y, -3.9, 3.9) * (double)8000.0F);
      this.za = (int)(Mth.clamp(var13.z, -3.9, 3.9) * (double)8000.0F);
   }
   ...
   public double getXa() {
      return (double)this.xa / (double)8000.0F;
   }

   public double getYa() {
      return (double)this.ya / (double)8000.0F;
   }

   public double getZa() {
      return (double)this.za / (double)8000.0F;
   }
