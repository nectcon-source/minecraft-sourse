...
public class ClientboundLoginPacket implements Packet<ClientGamePacketListener> {
   ...
   public void read(FriendlyByteBuf var1) throws IOException {
      ...
      this.registryHolder = (RegistryAccess.RegistryHolder)var1.readWithCodec(RegistryHolder.NETWORK_CODEC);
   ...
   public void write(FriendlyByteBuf var1) throws IOException {
      ...
      for(ResourceKey<Level> var3 : this.levels) {
         var1.writeResourceLocation(var3.location());
      }

      var1.writeWithCodec(RegistryHolder.NETWORK_CODEC, this.registryHolder);
      var1.writeWithCodec(DimensionType.CODEC, (Supplier)() -> this.dimensionType);
