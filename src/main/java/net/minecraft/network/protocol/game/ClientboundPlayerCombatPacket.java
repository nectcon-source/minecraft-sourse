...
public class ClientboundPlayerCombatPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundPlayerCombatPacket(CombatTracker var1, Event var2) {
      this(var1, var2, TextComponent.EMPTY);
   }

   public ClientboundPlayerCombatPacket(CombatTracker var1, Event var2, Component var3) {
      this.event = var2;
   ...
   public void read(FriendlyByteBuf var1) throws IOException {
      this.event = (Event)var1.readEnum(Event.class);
