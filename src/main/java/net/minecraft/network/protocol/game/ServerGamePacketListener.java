...
public interface ServerGamePacketListener extends PacketListener {
   ...
   void handlePlayerAction(ServerboundPlayerActionPacket var1) throws CommandSyntaxException;
   ...
   void handleUseItemOn(ServerboundUseItemOnPacket var1) throws CommandSyntaxException;

   void handleUseItem(ServerboundUseItemPacket var1) throws CommandSyntaxException;
