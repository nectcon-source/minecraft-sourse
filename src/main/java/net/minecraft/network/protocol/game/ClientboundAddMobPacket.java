...
public class ClientboundAddMobPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundAddMobPacket(LivingEntity var1) {
      ...
      double var5 = Mth.clamp(var4.x, -3.9, 3.9);
      double var7 = Mth.clamp(var4.y, -3.9, 3.9);
      double var9 = Mth.clamp(var4.z, -3.9, 3.9);
      this.xd = (int)(var5 * (double)8000.0F);
      this.yd = (int)(var7 * (double)8000.0F);
      this.zd = (int)(var9 * (double)8000.0F);
   }
