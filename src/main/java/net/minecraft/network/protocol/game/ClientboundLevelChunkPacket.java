...
public class ClientboundLevelChunkPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundLevelChunkPacket(LevelChunk var1, int var2) {
      ...
      for(Map.Entry<Heightmap.Types, Heightmap> var5 : var1.getHeightmaps()) {
      ...
      for(Map.Entry<BlockPos, BlockEntity> var11 : var1.getBlockEntities().entrySet()) {
         BlockPos var6 = (BlockPos)var11.getKey();
         BlockEntity var7 = (BlockEntity)var11.getValue();
