...
public class ClientboundSetTitlesPacket implements Packet<ClientGamePacketListener> {
   ...
   public ClientboundSetTitlesPacket(Type var1, Component var2) {
   ...
   public ClientboundSetTitlesPacket(Type var1, @Nullable Component var2, int var3, int var4, int var5) {
      this.type = var1;
      this.text = var2;
   ...
   public void read(FriendlyByteBuf var1) throws IOException {
      this.type = (Type)var1.readEnum(Type.class);
