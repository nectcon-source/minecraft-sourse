...
public final class RecipeBookSettings {
   ...
   public RecipeBookSettings() {
      this(Util.make(Maps.newEnumMap(RecipeBookType.class), var0 -> {
         for(RecipeBookType var1 : RecipeBookType.values()) {
            var0.put(var1, new RecipeBookSettings.TypeSettings(false, false));
         }
      }));
   }
   ...
   public static RecipeBookSettings read(FriendlyByteBuf var0) {
      Map<RecipeBookType, TypeSettings> var1 = Maps.newEnumMap(RecipeBookType.class);
   ...
   public void write(FriendlyByteBuf var1) {
      for(RecipeBookType var5 : RecipeBookType.values()) {
         TypeSettings var6 = this.states.get(var5);
         if (var6 == null) {
   ...
   public static RecipeBookSettings read(CompoundTag var0) {
      ...
      TAG_FIELDS.forEach((var2, var3) -> {
         boolean var4 = var0.getBoolean(var3.getFirst());
         boolean var5 = var0.getBoolean(var3.getSecond());
   ...
   public void write(CompoundTag var1) {
      TAG_FIELDS.forEach((var2, var3) -> {
         TypeSettings var4 = this.states.get(var2);
         var1.putBoolean(var3.getFirst(), var4.open);
         var1.putBoolean(var3.getSecond(), var4.filtering);
      });
   }
   ...
   public void replaceFrom(RecipeBookSettings var1) {
      ...
      for(RecipeBookType var5 : RecipeBookType.values()) {
         TypeSettings var6 = var1.states.get(var5);
