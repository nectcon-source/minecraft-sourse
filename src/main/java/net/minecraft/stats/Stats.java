...
//   private static <T> StatType makeRegistryStatType(String var0, Registry<T> var1) {
...
private static <T> StatType<T> makeRegistryStatType(String var0, Registry<T> var1) {
   return Registry.register(Registry.STAT_TYPE, new ResourceLocation(var0), new StatType<>(var1));
}
}
