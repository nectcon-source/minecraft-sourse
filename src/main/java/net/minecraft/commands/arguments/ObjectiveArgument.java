...
public class ObjectiveArgument implements ArgumentType<String> {
   ...
   public static Objective getObjective(CommandContext<CommandSourceStack> var0, String var1) throws CommandSyntaxException {
      String var2 = var0.getArgument(var1, String.class);
      Scoreboard var3 = (var0.getSource()).getServer().getScoreboard();
   ...
   public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> var1, SuggestionsBuilder var2) {
      if (var1.getSource() instanceof CommandSourceStack) {
         return SharedSuggestionProvider.suggest(((CommandSourceStack)var1.getSource()).getServer().getScoreboard().getObjectiveNames(), var2);
         ...
         return var3.customSuggestion((CommandContext<SharedSuggestionProvider>) var1, var2);
      } else {
