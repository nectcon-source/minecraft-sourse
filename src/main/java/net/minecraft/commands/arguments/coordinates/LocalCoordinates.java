...
public class LocalCoordinates implements Coordinates {
   ...
   public Vec3 getPosition(CommandSourceStack var1) {
      ...
      float var4 = Mth.cos((var2.y + 90.0F) * ((float)Math.PI / 180F));
      float var5 = Mth.sin((var2.y + 90.0F) * ((float)Math.PI / 180F));
      float var6 = Mth.cos(-var2.x * ((float)Math.PI / 180F));
      float var7 = Mth.sin(-var2.x * ((float)Math.PI / 180F));
      float var8 = Mth.cos((-var2.x + 90.0F) * ((float)Math.PI / 180F));
      float var9 = Mth.sin((-var2.x + 90.0F) * ((float)Math.PI / 180F));
      ...
      Vec3 var12 = var10.cross(var11).scale((double)-1.0F);
   ...
   private static double readDouble(StringReader var0, int var1) throws CommandSyntaxException {
      if (!var0.canRead()) {
         ...
         var0.skip();
         return var0.canRead() && var0.peek() != ' ' ? var0.readDouble() : (double)0.0F;
      }
   }
