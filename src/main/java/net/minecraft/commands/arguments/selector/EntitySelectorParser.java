...
import net.minecraft.advancements.critereon.MinMaxBounds.Floats;
...
public class EntitySelectorParser {
   ...
   public static final DynamicCommandExceptionType ERROR_UNKNOWN_SELECTOR_TYPE = new DynamicCommandExceptionType((var0) -> new TranslatableComponent("argument.entity.selector.unknown", new Object[]{var0}));
   ...
   public static final DynamicCommandExceptionType ERROR_EXPECTED_OPTION_VALUE = new DynamicCommandExceptionType((var0) -> new TranslatableComponent("argument.entity.options.valueless", new Object[]{var0}));
   ...
   public EntitySelectorParser(StringReader var1, boolean var2) {
      this.distance = Floats.ANY;
      this.level = Ints.ANY;
      this.rotX = WrappedMinMaxBounds.ANY;
      this.rotY = WrappedMinMaxBounds.ANY;
      this.predicate = (var0) -> true;
   ...
   public EntitySelector getSelector() {
      ...
      if (this.deltaX == null && this.deltaY == null && this.deltaZ == null) {
         ...
         var1 = this.createAabb(this.deltaX == null ? (double)0.0F : this.deltaX, this.deltaY == null ? (double)0.0F : this.deltaY, this.deltaZ == null ? (double)0.0F : this.deltaZ);
      }

      Function<Vec3, Vec3> var3;
      if (this.x == null && this.y == null && this.z == null) {
         var3 = (var0) -> var0;
      } else {
         var3 = (var1x) -> new Vec3(this.x == null ? var1x.x : this.x, this.y == null ? var1x.y : this.y, this.z == null ? var1x.z : this.z);
      }
   ...
   private AABB createAabb(double var1, double var3, double var5) {
      boolean var7 = var1 < (double)0.0F;
      boolean var8 = var3 < (double)0.0F;
      boolean var9 = var5 < (double)0.0F;
      double var10 = var7 ? var1 : (double)0.0F;
      double var12 = var8 ? var3 : (double)0.0F;
      double var14 = var9 ? var5 : (double)0.0F;
      double var16 = (var7 ? (double)0.0F : var1) + (double)1.0F;
      double var18 = (var8 ? (double)0.0F : var3) + (double)1.0F;
      double var20 = (var9 ? (double)0.0F : var5) + (double)1.0F;
      return new AABB(var10, var12, var14, var16, var18, var20);
   }

   private void finalizePredicates() {
      if (this.rotX != WrappedMinMaxBounds.ANY) {
         this.predicate = this.predicate.and(this.createRotationPredicate(this.rotX, (var0) -> (double)var0.xRot));
      }

      if (this.rotY != WrappedMinMaxBounds.ANY) {
         this.predicate = this.predicate.and(this.createRotationPredicate(this.rotY, (var0) -> (double)var0.yRot));
      }
