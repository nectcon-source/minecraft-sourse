...
public class NbtPathArgument implements ArgumentType<NbtPathArgument.NbtPath> {
   ...
   public static NbtPathArgument.NbtPath getPath(CommandContext<CommandSourceStack> var0, String var1) {
      return var0.getArgument(var1, NbtPath.class);
   }

   public NbtPathArgument.NbtPath parse(StringReader var1) throws CommandSyntaxException {
      List<Node> var2 = Lists.newArrayList();
      int var3 = var1.getCursor();
      Object2IntMap<Node> var4 = new Object2IntOpenHashMap();
      boolean var5 = true;
      ...
      switch (var0.peek()) {
         ...
         case '[':
            ...
            if (var4 == 123) {
               ...
               var0.expect(']');
               return new MatchElementNode(var7);
            } else {
               if (var4 == 93) {
                  var0.skip();
   ...
   public static class NbtPath {
      ...
      public List<Tag> get(Tag var1) throws CommandSyntaxException {
         List<Tag> var2 = Collections.singletonList(var1);
      ...
      private List<Tag> getOrCreateParents(Tag var1) throws CommandSyntaxException {
         ...
         for(int var3x = 0; var3x < this.nodes.length - 1; ++var3x) {
            NbtPathArgument.Node var4xx = this.nodes[var3x];
            int var5xxx = var3x + 1;
            var2 = var4xx.getOrCreate(var2, this.nodes[var5xxx]::createPreferredParentTag);
            if (var2.isEmpty()) {
               throw this.createNotFoundException(var4xx);
            }
         }
      ...
      public List<Tag> getOrCreate(Tag var1, Supplier<Tag> var2) throws CommandSyntaxException {
         List<Tag> var3 = this.getOrCreateParents(var1);
