...
public class ItemParser {
   ...
   public static final DynamicCommandExceptionType ERROR_UNKNOWN_ITEM = new DynamicCommandExceptionType((var0) -> new TranslatableComponent("argument.item.id.invalid", new Object[]{var0}));
   private static final BiFunction<SuggestionsBuilder, TagCollection<Item>, CompletableFuture<Suggestions>> SUGGEST_NOTHING = (var0, var1) -> var0.buildFuture();
   ...
   private CompletableFuture<Suggestions> suggestTag(SuggestionsBuilder var1, TagCollection<Item> var2) {
      return SharedSuggestionProvider.suggestResource(var2.getAvailableTags(), var1.createOffset(this.tagCursor));
   }
   ...
   private CompletableFuture<Suggestions> suggestItemIdOrTag(SuggestionsBuilder var1, TagCollection<Item> var2) {
      ...
      return SharedSuggestionProvider.suggestResource(Registry.ITEM.keySet(), var1);
   }
