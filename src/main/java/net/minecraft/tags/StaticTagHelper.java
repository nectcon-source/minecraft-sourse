...
public class StaticTagHelper<T> {
   ...
   public Tag.Named<T> bind(String var1) {
      StaticTagHelper.Wrapper<T> var2 = new StaticTagHelper.Wrapper<>(new ResourceLocation(var1));
   ...
   public void resetToEmpty() {
      ...
      Tag<T> var1 = SetTag.empty();
      this.wrappers.forEach(var1x -> var1x.rebind(var1xx -> var1));
   }

   public void reset(TagContainer var1) {
      TagCollection<T> var2 = this.collectionGetter.apply(var1);
      this.source = var2;
      this.wrappers.forEach(var1x -> var1x.rebind(var2::getTag));
   }
   ...
   public Set<ResourceLocation> getMissingTags(TagContainer var1) {
      TagCollection<T> var2 = (TagCollection)this.collectionGetter.apply(var1);
      Set<ResourceLocation> var3 = (Set)this.wrappers.stream().map(Wrapper::getName).collect(Collectors.toSet());
      ImmutableSet<ResourceLocation> var4 = ImmutableSet.copyOf(var2.getAvailableTags());
