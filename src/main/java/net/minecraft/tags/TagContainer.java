...
public interface TagContainer {
   ...
   static TagContainer deserializeFromNetwork(FriendlyByteBuf var0) {
      TagCollection<Block> var1 = TagCollection.loadFromNetwork(var0, Registry.BLOCK);
      TagCollection<Item> var2 = TagCollection.loadFromNetwork(var0, Registry.ITEM);
      TagCollection<Fluid> var3 = TagCollection.loadFromNetwork(var0, Registry.FLUID);
      TagCollection<EntityType<?>> var4 = TagCollection.loadFromNetwork(var0, Registry.ENTITY_TYPE);
      return of(var1, var2, var3, var4);
   }

   static TagContainer of(
      final TagCollection<Block> var0, final TagCollection<Item> var1, final TagCollection<Fluid> var2, final TagCollection<EntityType<?>> var3
   ) {
