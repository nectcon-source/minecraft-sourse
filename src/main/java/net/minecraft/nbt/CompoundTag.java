...
public class CompoundTag implements Tag {
   ...
   public byte[] getByteArray(String var1) {
      ...
      } catch (ClassCastException var2_1) {
         throw new ReportedException(this.createReport(var1, ByteArrayTag.TYPE, var2_1));
      }
   ...
   public int[] getIntArray(String var1) {
      try {
         ...
         throw new ReportedException(this.createReport(var1, IntArrayTag.TYPE, var2_1));
      }
   ...
   public long[] getLongArray(String var1) {
      try {
         ...
         throw new ReportedException(this.createReport(var1, LongArrayTag.TYPE, var2_1));
      }
   ...
   public CompoundTag getCompound(String var1) {
      try {
         ...
         throw new ReportedException(this.createReport(var1, TYPE, var2_1));
      }
   ...
   public ListTag getList(String var1, int var2) {
      ...
      } catch (ClassCastException var3_1) {
         throw new ReportedException(this.createReport(var1, ListTag.TYPE, var3_1));
      }
   ...
   private CrashReport createReport(String var1, TagType<?> var2, ClassCastException var3) {
      ...
      var5.setDetail("Tag type found", () -> ((Tag)this.tags.get(var1)).getType().getName());
   ...
   public CompoundTag copy() {
      Map<String, Tag> var1 = Maps.newHashMap(Maps.transformValues(this.tags, Tag::copy));
   ...
   private static Tag readNamedTagData(TagType<?> var0, String var1, DataInput var2, int var3, NbtAccounter var4) {
      try {
         ...
         CrashReport var6 = CrashReport.forThrowable(var5_1, "Loading NBT data");
   ...
   public Component getPrettyDisplay(String var1, int var2) {
      if (this.tags.isEmpty()) {
         ...
         for(Iterator<String> var8 = var4.iterator(); var8.hasNext(); var3.append(var7)) {
      ...
      TYPE = new TagType<CompoundTag>() {
         public CompoundTag load(DataInput var1, int var2, NbtAccounter var3) throws IOException {
            ...
            if (var2 > 512) {
               ...
               Map<String, Tag> var4 = Maps.newHashMap();
