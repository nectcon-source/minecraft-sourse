...
public class Advancement {
   ...
   public Advancement(ResourceLocation var1, @Nullable Advancement var2, @Nullable DisplayInfo var3, AdvancementRewards var4, Map<String, Criterion> var5, String[][] var6) {
      ...
      if (var3 == null) {
         ...
         Component var9 = ComponentUtils.mergeStyles(var7.copy(), Style.EMPTY.withColor(var8)).append("\n").append(var3.getDescription());
         Component var10 = var7.copy().withStyle((var1x) -> var1x.withHoverEvent(new HoverEvent(Action.SHOW_TEXT, var9)));
   ...
   public static class Builder {
      ...
      public JsonObject serializeToJson() {
         ...
         for(Map.Entry<String, Criterion> var4 : this.criteria.entrySet()) {
      ...
      public static Builder fromJson(JsonObject var0, DeserializationContext var1) {
         ...
         Map<String, Criterion> var5 = Criterion.criteriaFromJson(GsonHelper.getAsJsonObject(var0, "criteria"), var1);
         if (var5.isEmpty()) {
