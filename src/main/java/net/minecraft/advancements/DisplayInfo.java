...
public class DisplayInfo {
   ...
   public static DisplayInfo fromJson(JsonObject var0) {
      Component var1 = Serializer.fromJson(var0.get("title"));
      Component var2 = Serializer.fromJson(var0.get("description"));
         ...
         if (var0.has("data")) {
            ...
            if (var0.has("nbt")) {
               try {
                  ...
                  var2.setTag(var3);
               } catch (CommandSyntaxException var3_1) {
                  throw new JsonSyntaxException("Invalid nbt tag: " + var3_1.getMessage());
               }
            }
   ...
   public JsonElement serializeToJson() {
      ...
      var1.add("title", Serializer.toJsonTree(this.title));
      var1.add("description", Serializer.toJsonTree(this.description));
