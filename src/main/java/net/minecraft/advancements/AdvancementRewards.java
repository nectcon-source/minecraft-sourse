...
public class AdvancementRewards {
   ...
   public void grant(ServerPlayer var1) {
      ...
      for(ResourceLocation var7 : this.loot) {
         for(ItemStack var9 : var1.server.getLootTables().get(var7).getRandomItems(var2)) {
      ...
      this.function.get(var11.getFunctions()).ifPresent((var2x) -> var11.getFunctions().execute(var2x, var1.createCommandSourceStack().withSuppressedOutput().withPermission(2)));
   }
