...
public class BredAnimalsTrigger extends SimpleCriterionTrigger<BredAnimalsTrigger.TriggerInstance> {
   ...
   public BredAnimalsTrigger.TriggerInstance createInstance(JsonObject var1, EntityPredicate.Composite var2, DeserializationContext var3) {
      ...
      EntityPredicate.Composite var5x = EntityPredicate.Composite.fromJson(var1, "partner", var3);
      EntityPredicate.Composite var6xx = EntityPredicate.Composite.fromJson(var1, "child", var3);
      return new BredAnimalsTrigger.TriggerInstance(var2, var4, var5x, var6xx);
   }
   ...
   public void trigger(ServerPlayer var1, Animal var2, Animal var3, @Nullable AgableMob var4) {
      ...
      LootContext var6x = EntityPredicate.createContext(var1, var3);
      LootContext var7xx = var4 != null ? EntityPredicate.createContext(var1, var4) : null;
      this.trigger(var1, var3x -> var3x.matches(var5, var6x, var7xx));
   }
