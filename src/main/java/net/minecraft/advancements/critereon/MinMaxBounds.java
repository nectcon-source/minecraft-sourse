...
public abstract class MinMaxBounds<T extends Number> {
   ...
   protected static <T extends Number, R extends MinMaxBounds<T>> R fromJson(
      ...
      if (var0 != null && !var0.isJsonNull()) {
         if (GsonHelper.isNumberValue(var0)) {
            T var7 = (T)(var2.apply(var0, "value"));
            return var3.create(var7, var7);
         } else {
            JsonObject var4 = GsonHelper.convertToJsonObject(var0, "value");
            T var5 = var4.has("min") ? var2.apply(var4.get("min"), "min") : null;
            T var6 = var4.has("max") ? var2.apply(var4.get("max"), "max") : null;
   ...
   protected static <T extends Number, R extends MinMaxBounds<T>> R fromReader(
      ...
      if (!var0.canRead()) {
         ...
         try {
            T var6 = (T)(optionallyFormat(readNumber(var0, var2, var3), var4));
            T var7;
            if (var0.canRead(2) && var0.peek() == '.' && var0.peek(1) == '.') {
               var0.skip();
               var0.skip();
               var7 = (T)(optionallyFormat(readNumber(var0, var2, var3), var4));
         ...
         } catch (CommandSyntaxException var6_1) {
            var0.setCursor(var5);
            throw new CommandSyntaxException(var6_1.getType(), var6_1.getRawMessage(), var6_1.getInput(), var5);
         }
      }
   }
   ...
   public static class Floats extends MinMaxBounds<Float> {
      ...
      public static MinMaxBounds.Floats atLeast(float var0) {
         return new MinMaxBounds.Floats(var0, null);
      }
      ...
      public static MinMaxBounds.Floats fromJson(@Nullable JsonElement var0) {
         return fromJson(var0, ANY, GsonHelper::convertToFloat, MinMaxBounds.Floats::new);
      }
      ...
      public static MinMaxBounds.Floats fromReader(StringReader var0, Function<Float, Float> var1) throws CommandSyntaxException {
         return fromReader(var0, MinMaxBounds.Floats::create, Float::parseFloat, CommandSyntaxException.BUILT_IN_EXCEPTIONS::readerInvalidFloat, var1);
      }
   }
