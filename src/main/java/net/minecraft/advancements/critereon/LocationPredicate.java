...
public class LocationPredicate {
   ...
   public LocationPredicate(
      MinMaxBounds.Floats var1,
      MinMaxBounds.Floats var2,
      MinMaxBounds.Floats var3,
   ...
   public boolean matches(ServerLevel var1, float var2, float var3, float var4) {
      if (!this.x.matches(var2)) {
         ...
         Optional<ResourceKey<Biome>> var7 = var1.registryAccess().registryOrThrow(Registry.BIOME_REGISTRY).getResourceKey(var1.getBiome(var5));
         if (!var7.isPresent()) {
            return false;
         } else if (this.biome == null || var6 && this.biome == var7.get()) {
            if (this.feature == null || var6 && var1.structureFeatureManager().getStructureAt(var5, true, this.feature).isValid()) {
   ...
   public JsonElement serializeToJson() {
      if (this == ANY) {
         ...
         if (this.dimension != null) {
            ...
            var10001.getClass();
            var10000.resultOrPartial(var10001::error).ifPresent((var1x) -> var1.add("dimension", (JsonElement) var1x));
         }
   ...
   public static LocationPredicate fromJson(@Nullable JsonElement var0) {
      if (var0 != null && !var0.isJsonNull()) {
         ...
         if (var1.has("dimension")) {
            ...
            Logger var10001 = LOGGER;
            var10001.getClass();
            var14 = (ResourceKey)var10000.resultOrPartial(var10001::error).map((var0x) -> ResourceKey.create(Registry.DIMENSION_REGISTRY, (ResourceLocation) var0x)).orElse(null);
         } else {
            var14 = null;
         }

         ResourceKey<Level> var6 = var14;
