   ...
   public static class TriggerInstance extends AbstractCriterionTriggerInstance {
      ...
      public static InventoryChangeTrigger.TriggerInstance hasItems(ItemLike... var0) {
         ...
         for(int var2 = 0; var2 < var0.length; ++var2) {
            var1[var2] = new ItemPredicate(null, var0[var2].asItem(), MinMaxBounds.Ints.ANY, MinMaxBounds.Ints.ANY, EnchantmentPredicate.NONE, EnchantmentPredicate.NONE, null, NbtPredicate.ANY);
         }
      ...
      public boolean matches(Inventory var1, ItemStack var2, int var3, int var4, int var5) {
         if (!this.slotsFull.matches(var3)) {
            ...
            if (var6 == 0) {
               ...
               List<ItemPredicate> var7 = new ObjectArrayList(this.predicates);
