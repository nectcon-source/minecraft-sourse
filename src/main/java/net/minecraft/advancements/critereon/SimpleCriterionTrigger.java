...
public abstract class SimpleCriterionTrigger<T extends AbstractCriterionTriggerInstance> implements CriterionTrigger<T> {
   ...
   public final void removePlayerListener(PlayerAdvancements var1, CriterionTrigger.Listener<T> var2) {
      Set<CriterionTrigger.Listener<T>> var3 = (Set)this.players.get(var1);
      if (var3 != null) {
         var3.remove(var2);
         if (var3.isEmpty()) {
   ...
   protected void trigger(ServerPlayer var1, Predicate<T> var2) {
      ...
      Set<CriterionTrigger.Listener<T>> var4 = (Set)this.players.get(var3);
      if (var4 != null && !var4.isEmpty()) {
         LootContext var5 = EntityPredicate.createContext(var1, var1);
         List<CriterionTrigger.Listener<T>> var6 = null;

         for(CriterionTrigger.Listener<T> var8 : var4) {
            T var9 = (T)(var8.getTriggerInstance());
         ...
         if (var6 != null) {
            for(CriterionTrigger.Listener<T> var11 : var6) {
               var11.run(var3);
            }
         }
