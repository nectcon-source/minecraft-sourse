   ...
   public boolean matches(ItemStack var1) {
      if (this == ANY) {
         ...
         if (this.enchantments.length > 0) {
            Map<Enchantment, Integer> var2 = EnchantmentHelper.deserializeEnchantments(var1.getEnchantmentTags());
         ...
         if (this.storedEnchantments.length > 0) {
            Map<Enchantment, Integer> var7 = EnchantmentHelper.deserializeEnchantments(EnchantedBookItem.getEnchantments(var1));
      ...
      if (var0 != null && !var0.isJsonNull()) {
         ...
         if (var1.has("data")) {
            ...
            if (var1.has("item")) {
               ...
               var5 = (Item)Registry.ITEM.getOptional(var6).orElseThrow(() -> new JsonSyntaxException("Unknown item id '" + var6 + "'"));
            }
            ...
            if (var1.has("potion")) {
               ...
               var11 = (Potion)Registry.POTION.getOptional(var8).orElseThrow(() -> new JsonSyntaxException("Unknown potion '" + var8 + "'"));
            }
   ...
   public JsonElement serializeToJson() {
      if (this == ANY) {
         ...
         if (this.storedEnchantments.length > 0) {
            ...
            for(EnchantmentPredicate var11 : this.storedEnchantments) {
               var7.add(var11.serializeToJson());
            }

            var1.add("stored_enchantments", var7);
         }
